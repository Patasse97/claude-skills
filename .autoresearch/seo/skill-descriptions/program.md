...
1. **SEO discoverability** â€” include high-volume keywords: "agent skill", "plugin", "Claude Code", "Codex", "Gemini CLI", "Cursor"
2. **Trigger accuracy** â€” the description must accurately describe when the skill activates
3. **Clarity** â€” one read should convey what the skill does and who it's for
4. **Cross-platform appeal** â€” mention multi-tool compatibility where natural

## Constraints
- Description must be under 200 characters (plugin.json limit)
- Must NOT be spammy or keyword-stuffed â€” natural language only
...
- For each: read current description â†’ rewrite with SEO keywords â†’ evaluate
