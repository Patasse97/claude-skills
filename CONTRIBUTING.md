...
**Before you start:** Read [CONVENTIONS.md](CONVENTIONS.md) â€” it contains the mandatory technical rules that every contribution must follow. PRs that violate conventions will be closed.
...
cd claude-skills
git remote add upstream https://github.com/Patasse97/claude-skills.git
...
**Frontmatter â€” only `name` and `description`:**
...
â”œâ”€â”€ patterns.md          # Detailed patterns and examples
â”œâ”€â”€ best-practices.md    # Best practices guide
â””â”€â”€ decision-matrix.md   # Comparison tables
```
...
- [ ] **Clean diff** â€” rebased on `dev`, no merge commit history
...
6. Merging dev â†’ main for deployment
...
- **General:** Open a [discussion](https://github.com/Patasse97/claude-skills/discussions)
- **Bugs:** Use the [issue tracker](https://github.com/Patasse97/claude-skills/issues)
- **Contact:** [alirezarezvani.com](https://github.com/Patasse97)
