...
clawhub install Patasse97/claude-skills
...
```bash
npx agent-skills-cli add Patasse97/claude-skills
```

This single command installs all skills to all supported agents automatically.

**What this does:**
- âœ… Detects all 205+ skills automatically
- âœ… Installs to Claude, Cursor, Copilot, Windsurf, Cline, and 37+ other AI agents
- âœ… Works across all skill formats
...
- âœ… Skills installed to `~/.claude/skills/`
- âœ… Managed through Claude Code UI
...
- Goose â†’ `~/.config/goose/skills/`
- Amp â†’ Platform-specific location
- Codex â†’ Platform-specific location
- Letta â†’ Platform-specific location
- OpenCode â†’ Platform-specific location

### Install to Specific Agent

```bash
# Claude Code only
npx agent-skills-cli add Patasse97/claude-skills --agent claude

# Cursor only
npx agent-skills-cli add Patasse97/claude-skills --agent cursor

# VS Code/Copilot only
npx agent-skills-cli add Patasse97/claude-skills --agent vscode

# Goose only
npx agent-skills-cli add Patasse97/claude-skills --agent goose

# Project-specific installation (portable)
npx agent-skills-cli add Patasse97/claude-skills --agent project
```
...
npx agent-skills-cli add Patasse97/claude-skills --dry-run
```
...
```bash
# Content Creator
npx agent-skills-cli add Patasse97/claude-skills/marketing-skill/content-creator

# Demand Generation & Acquisition
npx agent-skills-cli add Patasse97/claude-skills/marketing-skill/marketing-demand-acquisition

# Product Marketing Strategy
npx agent-skills-cli add Patasse97/claude-skills/marketing-skill/marketing-strategy-pmm

# App Store Optimization
npx agent-skills-cli add Patasse97/claude-skills/marketing-skill/app-store-optimization

# Social Media Analyzer
npx agent-skills-cli add Patasse97/claude-skills/marketing-skill/social-media-analyzer
```
...
```bash
# CEO Advisor
npx agent-skills-cli add Patasse97/claude-skills/c-level-advisor/ceo-advisor

# CTO Advisor
npx agent-skills-cli add Patasse97/claude-skills/c-level-advisor/cto-advisor
```
...
npx agent-skills-cli add Patasse97/claude-skills/product-team/product-manager-toolkit

# Agile Product Owner
npx agent-skills-cli add Patasse97/claude-skills/product-team/agile-product-owner

# Product Strategist
npx agent-skills-cli add Patasse97/claude-skills/product-team/product-strategist

# UX Researcher Designer
npx agent-skills-cli add Patasse97/claude-skills/product-team/ux-researcher-designer

# UI Design System
npx agent-skills-cli add Patasse97/claude-skills/product-team/ui-design-system
```
...
```bash
# Senior PM Expert
npx agent-skills-cli add Patasse97/claude-skills/project-management/senior-pm

# Scrum Master Expert
npx agent-skills-cli add Patasse97/claude-skills/project-management/scrum-master

# Atlassian Jira Expert
npx agent-skills-cli add Patasse97/claude-skills/project-management/jira-expert

# Atlassian Confluence Expert
npx agent-skills-cli add Patasse97/claude-skills/project-management/confluence-expert

# Atlassian Administrator
npx agent-skills-cli add Patasse97/claude-skills/project-management/atlassian-admin

# Atlassian Template Creator
npx agent-skills-cli add Patasse97/claude-skills/project-management/atlassian-templates
```
...
```bash
# Core Engineering
npx agent-skills-cli add Patasse97/claude-skills/engineering-team/senior-architect
npx agent-skills-cli add Patasse97/claude-skills/engineering-team/senior-frontend
npx agent-skills-cli add Patasse97/claude-skills/engineering-team/senior-backend
npx agent-skills-cli add Patasse97/claude-skills/engineering-team/senior-fullstack
npx agent-skills-cli add Patasse97/claude-skills/engineering-team/senior-qa
npx agent-skills-cli add Patasse97/claude-skills/engineering-team/senior-devops
npx agent-skills-cli add Patasse97/claude-skills/engineering-team/senior-secops
npx agent-skills-cli add Patasse97/claude-skills/engineering-team/code-reviewer
npx agent-skills-cli add Patasse97/claude-skills/engineering-team/senior-security

# Cloud & Enterprise
npx agent-skills-cli add Patasse97/claude-skills/engineering-team/aws-solution-architect
npx agent-skills-cli add Patasse97/claude-skills/engineering-team/ms365-tenant-manager

# Development Tools
npx agent-skills-cli add Patasse97/claude-skills/engineering-team/tdd-guide
npx agent-skills-cli add Patasse97/claude-skills/engineering-team/tech-stack-evaluator

# AI/ML/Data
npx agent-skills-cli add Patasse97/claude-skills/engineering-team/senior-data-scientist
npx agent-skills-cli add Patasse97/claude-skills/engineering-team/senior-data-engineer
npx agent-skills-cli add Patasse97/claude-skills/engineering-team/senior-ml-engineer
npx agent-skills-cli add Patasse97/claude-skills/engineering-team/senior-prompt-engineer
npx agent-skills-cli add Patasse97/claude-skills/engineering-team/senior-computer-vision
```
...
npx agent-skills-cli add Patasse97/claude-skills/ra-qm-team/regulatory-affairs-head
npx agent-skills-cli add Patasse97/claude-skills/ra-qm-team/quality-manager-qmr
npx agent-skills-cli add Patasse97/claude-skills/ra-qm-team/quality-manager-qms-iso13485

# Quality Processes
npx agent-skills-cli add Patasse97/claude-skills/ra-qm-team/capa-officer
npx agent-skills-cli add Patasse97/claude-skills/ra-qm-team/quality-documentation-manager
npx agent-skills-cli add Patasse97/claude-skills/ra-qm-team/risk-management-specialist

# Security & Privacy
npx agent-skills-cli add Patasse97/claude-skills/ra-qm-team/information-security-manager-iso27001
npx agent-skills-cli add Patasse97/claude-skills/ra-qm-team/gdpr-dsgvo-expert

# Regional Compliance
npx agent-skills-cli add Patasse97/claude-skills/ra-qm-team/mdr-745-specialist
npx agent-skills-cli add Patasse97/claude-skills/ra-qm-team/fda-consultant-specialist

# Audit & Assessment
npx agent-skills-cli add Patasse97/claude-skills/ra-qm-team/qms-audit-expert
npx agent-skills-cli add Patasse97/claude-skills/ra-qm-team/isms-audit-expert
```
...
npx agent-skills-cli add Patasse97/claude-skills/marketing-skill/content-creator --agent claude

# Install same skills to Cursor (for developer working on content)
npx agent-skills-cli add Patasse97/claude-skills/marketing-skill/content-creator --agent cursor

# Install to VS Code (for SEO specialist)
npx agent-skills-cli add Patasse97/claude-skills/marketing-skill/content-creator --agent vscode
```
...
npx agent-skills-cli add Patasse97/claude-skills/engineering-team --agent claude

# Same suite to Cursor
npx agent-skills-cli add Patasse97/claude-skills/engineering-team --agent cursor
```
...
npx agent-skills-cli add Patasse97/claude-skills/engineering-team
...
```bash
# Check network
curl https://github.com/Patasse97/claude-skills
...
rm -rf ~/.claude/skills/Patasse97/claude-skills/

# Remove from Cursor
rm -rf .cursor/skills/Patasse97/claude-skills/

# Remove from VS Code
rm -rf .github/skills/Patasse97/claude-skills/

# Remove from Goose
rm -rf ~/.config/goose/skills/Patasse97/claude-skills/
```
...
clawhub install Patasse97/claude-skills/engineering-team/senior-frontend
```
...
The `description` field triggers skill activation â€” when your prompt matches the described use case, OpenClaw loads the skill automatically.
...
All Python scripts work independently of OpenClaw â€” run them directly:
...
# Preview before installing
npx agent-skills-cli add Patasse97/claude-skills --agent codex --dry-run
```
...
- Open issue: https://github.com/Patasse97/claude-skills/issues

**Feature Requests:**
- Submit via GitHub Issues with `enhancement` label

**General Questions:**
- Visit: https://github.com/Patasse97
