...
**Primary Contact:**
- **Website:** [alirezarezvani.com](https://github.com/Patasse97) (use contact form)
...
- âœ… Use parameterized queries (if using databases)
- âœ… Handle errors gracefully
- âœ… Limit file system access to necessary directories
- âœ… Use type hints for safety
- âœ… Sanitize user input

**DON'T:**
- âŒ Use eval() or exec() with user input
- âŒ Execute shell commands with unsanitized input
- âŒ Store credentials in code
- âŒ Make unchecked network requests
- âŒ Access sensitive system files
- âŒ Use deprecated libraries with known vulnerabilities
...
- **Website:** [alirezarezvani.com](https://github.com/Patasse97)
