...
Level 1: Activity Metrics (Leading)
  â”œâ”€â”€ Pipeline created ($, #)
  â”œâ”€â”€ Meetings booked
  â”œâ”€â”€ Proposals sent
  â””â”€â”€ Demo completion rate

Level 2: Pipeline Metrics (Mid-funnel)
  â”œâ”€â”€ Pipeline coverage ratio
  â”œâ”€â”€ Stage conversion rates
  â”œâ”€â”€ Sales velocity
  â”œâ”€â”€ Deal aging
  â””â”€â”€ Pipeline hygiene score

Level 3: Revenue Metrics (Outcomes)
  â”œâ”€â”€ Bookings (new, expansion, renewal)
  â”œâ”€â”€ Revenue (ARR, MRR, TCV)
  â”œâ”€â”€ Win rate
...
Level 4: Efficiency Metrics (Unit Economics)
  ...
  â”œâ”€â”€ CAC Payback Period
  â”œâ”€â”€ Burn Multiple
  â”œâ”€â”€ Rule of 40
  â””â”€â”€ Net Dollar Retention

Level 5: Strategic Metrics (Board-Level)
  â”œâ”€â”€ Revenue per employee
  â”œâ”€â”€ Gross margin trend
  â”œâ”€â”€ NRR cohort analysis
  â””â”€â”€ Customer health score
```
