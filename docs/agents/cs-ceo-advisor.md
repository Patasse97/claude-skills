---
title: "CEO Advisor Agent â€” AI Coding Agent & Codex Skill"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/agents/c-level/cs-ceo-advisor.md">Source</a></span>
</div>
...
**Skill Location:** [`c-level-advisor/ceo-advisor`](https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/ceo-advisor)
...
1. **Strategy Analyzer**
   ...
   - **Path:** [`scripts/strategy_analyzer.py`](https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/ceo-advisor/scripts/strategy_analyzer.py)
...
2. **Financial Scenario Analyzer**
   ...
   - **Path:** [`scripts/financial_scenario_analyzer.py`](https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/ceo-advisor/scripts/financial_scenario_analyzer.py)
...
1. **Executive Decision Framework**
   - **Location:** [`references/executive_decision_framework.md`](https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/ceo-advisor/references/executive_decision_framework.md)
...
2. **Board Governance & Investor Relations**
   - **Location:** [`references/board_governance_investor_relations.md`](https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/ceo-advisor/references/board_governance_investor_relations.md)
...
3. **Leadership & Organizational Culture**
   - **Location:** [`references/leadership_organizational_culture.md`](https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/ceo-advisor/references/leadership_organizational_culture.md)
...
- [cs-product-manager](https://github.com/Patasse97/claude-skills/tree/main/agents/product/cs-product-manager.md) - Product strategy and roadmap execution (planned)
- [cs-growth-strategist](https://github.com/Patasse97/claude-skills/tree/main/agents/business-growth/cs-growth-strategist.md) - Growth strategy and market expansion (planned)

## References

- **Skill Documentation:** [../../c-level-advisor/ceo-advisor/SKILL.md](https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/ceo-advisor/SKILL.md)
- **C-Level Domain Guide:** [../../c-level-advisor/CLAUDE.md](https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/CLAUDE.md)
