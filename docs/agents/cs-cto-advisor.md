---
title: "CTO Advisor Agent â€” AI Coding Agent & Codex Skill"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/agents/c-level/cs-cto-advisor.md">Source</a></span>
</div>
...
**Skill Location:** [`c-level-advisor/cto-advisor`](https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/cto-advisor)
...
1. **Tech Debt Analyzer**
   ...
   - **Path:** [`scripts/tech_debt_analyzer.py`](https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/cto-advisor/scripts/tech_debt_analyzer.py)
...
2. **Team Scaling Calculator**
   ...
   - **Path:** [`scripts/team_scaling_calculator.py`](https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/cto-advisor/scripts/team_scaling_calculator.py)
...
1. **Architecture Decision Records (ADR)**
   - **Location:** [`references/architecture_decision_records.md`](https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/cto-advisor/references/architecture_decision_records.md)
...
2. **Engineering Metrics**
   - **Location:** [`references/engineering_metrics.md`](https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/cto-advisor/references/engineering_metrics.md)
...
3. **Technology Evaluation Framework**
   - **Location:** [`references/technology_evaluation_framework.md`](https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/cto-advisor/references/technology_evaluation_framework.md)
...
- [cs-fullstack-engineer](https://github.com/Patasse97/claude-skills/tree/main/agents/engineering/cs-fullstack-engineer.md) - Fullstack development coordination (planned)
- [cs-devops-specialist](https://github.com/Patasse97/claude-skills/tree/main/agents/engineering/cs-devops-specialist.md) - DevOps and infrastructure automation (planned)

## References

- **Skill Documentation:** [../../c-level-advisor/cto-advisor/SKILL.md](https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/cto-advisor/SKILL.md)
