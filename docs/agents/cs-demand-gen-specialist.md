---
title: "Demand Generation Specialist Agent â€” AI Coding Agent & Codex Skill"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/agents/marketing/cs-demand-gen-specialist.md">Source</a></span>
</div>
...
**Skill Location:** [`marketing-skill/marketing-demand-acquisition`](https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/marketing-demand-acquisition)

### Python Tools

1. **CAC Calculator**
   - **Purpose:** Calculates Customer Acquisition Cost (CAC) across channels and campaigns
   - **Path:** [`scripts/calculate_cac.py`](https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/marketing-demand-acquisition/scripts/calculate_cac.py)
...
1. **Attribution Guide**
   - **Location:** [`references/attribution-guide.md`](https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/marketing-demand-acquisition/references/attribution-guide.md)
...
2. **Campaign Templates**
   - **Location:** [`references/campaign-templates.md`](https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/marketing-demand-acquisition/references/campaign-templates.md)
...
3. **HubSpot Workflows**
   - **Location:** [`references/hubspot-workflows.md`](https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/marketing-demand-acquisition/references/hubspot-workflows.md)
...
4. **International Playbooks**
   - **Location:** [`references/international-playbooks.md`](https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/marketing-demand-acquisition/references/international-playbooks.md)
...
- **Skill Documentation:** [../../marketing-skill/marketing-demand-acquisition/SKILL.md](https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/marketing-demand-acquisition/SKILL.md)
- **Marketing Domain Guide:** [../../marketing-skill/CLAUDE.md](https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/CLAUDE.md)
- **Agent Development Guide:** [../CLAUDE.md](https://github.com/Patasse97/claude-skills/tree/main/agents/CLAUDE.md)
- **Marketing Roadmap:** [../../marketing-skill/marketing_skills_roadmap.md](https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/marketing_skills_roadmap.md)
