---
title: "Product Manager Agent â€” AI Coding Agent & Codex Skill"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/agents/product/cs-product-manager.md">Source</a></span>
</div>
...
**Primary Skill:** [`product-team/product-manager-toolkit`](https://github.com/Patasse97/claude-skills/tree/main/product-team/product-manager-toolkit)

### All Orchestrated Skills

| # | Skill | Location | Primary Tool |
|---|-------|----------|-------------|
| 1 | Product Manager Toolkit | [`product-team/product-manager-toolkit`](https://github.com/Patasse97/claude-skills/tree/main/product-team/product-manager-toolkit) | rice_prioritizer.py, customer_interview_analyzer.py |
| 2 | Agile Product Owner | [`product-team/agile-product-owner`](https://github.com/Patasse97/claude-skills/tree/main/product-team/agile-product-owner) | user_story_generator.py |
| 3 | Product Strategist | [`product-team/product-strategist`](https://github.com/Patasse97/claude-skills/tree/main/product-team/product-strategist) | okr_cascade_generator.py |
| 4 | UX Researcher & Designer | [`product-team/ux-researcher-designer`](https://github.com/Patasse97/claude-skills/tree/main/product-team/ux-researcher-designer) | persona_generator.py |
| 5 | UI Design System | [`product-team/ui-design-system`](https://github.com/Patasse97/claude-skills/tree/main/product-team/ui-design-system) | design_token_generator.py |
| 6 | Competitive Teardown | [`product-team/competitive-teardown`](https://github.com/Patasse97/claude-skills/tree/main/product-team/competitive-teardown) | competitive_matrix_builder.py |
| 7 | Landing Page Generator | [`product-team/landing-page-generator`](https://github.com/Patasse97/claude-skills/tree/main/product-team/landing-page-generator) | landing_page_scaffolder.py |
| 8 | SaaS Scaffolder | [`product-team/saas-scaffolder`](https://github.com/Patasse97/claude-skills/tree/main/product-team/saas-scaffolder) | project_bootstrapper.py |

### Python Tools

1. **RICE Prioritizer**
   - **Purpose:** RICE framework implementation for feature prioritization with portfolio analysis and capacity planning
   - **Path:** [`scripts/rice_prioritizer.py`](https://github.com/Patasse97/claude-skills/tree/main/product-team/product-manager-toolkit/scripts/rice_prioritizer.py)
...
2. **Customer Interview Analyzer**
   ...
   - **Path:** [`scripts/customer_interview_analyzer.py`](https://github.com/Patasse97/claude-skills/tree/main/product-team/product-manager-toolkit/scripts/customer_interview_analyzer.py)
...
3. **User Story Generator**
   ...
   - **Path:** [`scripts/user_story_generator.py`](https://github.com/Patasse97/claude-skills/tree/main/product-team/agile-product-owner/scripts/user_story_generator.py)
...
4. **OKR Cascade Generator**
   ...
   - **Path:** [`scripts/okr_cascade_generator.py`](https://github.com/Patasse97/claude-skills/tree/main/product-team/product-strategist/scripts/okr_cascade_generator.py)
...
5. **Persona Generator**
   ...
   - **Path:** [`scripts/persona_generator.py`](https://github.com/Patasse97/claude-skills/tree/main/product-team/ux-researcher-designer/scripts/persona_generator.py)
...
6. **Design Token Generator**
   ...
   - **Path:** [`scripts/design_token_generator.py`](https://github.com/Patasse97/claude-skills/tree/main/product-team/ui-design-system/scripts/design_token_generator.py)
...
7. **Competitive Matrix Builder**
   ...
   - **Path:** [`scripts/competitive_matrix_builder.py`](https://github.com/Patasse97/claude-skills/tree/main/product-team/competitive-teardown/scripts/competitive_matrix_builder.py)
...
8. **Landing Page Scaffolder**
   ...
   - **Path:** [`scripts/landing_page_scaffolder.py`](https://github.com/Patasse97/claude-skills/tree/main/product-team/landing-page-generator/scripts/landing_page_scaffolder.py)
...
9. **Project Bootstrapper**
   ...
   - **Path:** [`scripts/project_bootstrapper.py`](https://github.com/Patasse97/claude-skills/tree/main/product-team/saas-scaffolder/scripts/project_bootstrapper.py)
...
1. **PRD Templates**
   - **Location:** [`references/prd_templates.md`](https://github.com/Patasse97/claude-skills/tree/main/product-team/product-manager-toolkit/references/prd_templates.md)
...
2. **Sprint Planning Guide**
   - **Location:** [`references/sprint-planning-guide.md`](https://github.com/Patasse97/claude-skills/tree/main/product-team/agile-product-owner/references/sprint-planning-guide.md)
...
3. **User Story Templates**
   - **Location:** [`references/user-story-templates.md`](https://github.com/Patasse97/claude-skills/tree/main/product-team/agile-product-owner/references/user-story-templates.md)
...
4. **OKR Framework**
   - **Location:** [`references/okr_framework.md`](https://github.com/Patasse97/claude-skills/tree/main/product-team/product-strategist/references/okr_framework.md)
   - **Content:** OKR methodology, cascade patterns, scoring guidelines
   - **Use Case:** Quarterly planning, strategic alignment, goal tracking

5. **Strategy Types**
   - **Location:** [`references/strategy_types.md`](https://github.com/Patasse97/claude-skills/tree/main/product-team/product-strategist/references/strategy_types.md)
...
6. **Persona Methodology**
   - **Location:** [`references/persona-methodology.md`](https://github.com/Patasse97/claude-skills/tree/main/product-team/ux-researcher-designer/references/persona-methodology.md)
...
7. **Example Personas**
   - **Location:** [`references/example-personas.md`](https://github.com/Patasse97/claude-skills/tree/main/product-team/ux-researcher-designer/references/example-personas.md)
...
8. **Journey Mapping Guide**
   - **Location:** [`references/journey-mapping-guide.md`](https://github.com/Patasse97/claude-skills/tree/main/product-team/ux-researcher-designer/references/journey-mapping-guide.md)
...
9. **Usability Testing Frameworks**
   - **Location:** [`references/usability-testing-frameworks.md`](https://github.com/Patasse97/claude-skills/tree/main/product-team/ux-researcher-designer/references/usability-testing-frameworks.md)
...
10. **Component Architecture**
    - **Location:** [`references/component-architecture.md`](https://github.com/Patasse97/claude-skills/tree/main/product-team/ui-design-system/references/component-architecture.md)
...
11. **Developer Handoff**
    - **Location:** [`references/developer-handoff.md`](https://github.com/Patasse97/claude-skills/tree/main/product-team/ui-design-system/references/developer-handoff.md)
...
12. **Responsive Calculations**
    - **Location:** [`references/responsive-calculations.md`](https://github.com/Patasse97/claude-skills/tree/main/product-team/ui-design-system/references/responsive-calculations.md)
...
13. **Token Generation**
    - **Location:** [`references/token-generation.md`](https://github.com/Patasse97/claude-skills/tree/main/product-team/ui-design-system/references/token-generation.md)
...
- **Skill Documentation:** [../../product-team/product-manager-toolkit/SKILL.md](https://github.com/Patasse97/claude-skills/tree/main/product-team/product-manager-toolkit/SKILL.md)
- **Product Domain Guide:** [../../product-team/CLAUDE.md](https://github.com/Patasse97/claude-skills/tree/main/product-team/CLAUDE.md)
