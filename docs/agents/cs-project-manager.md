---
title: "Project Manager Agent â€” AI Coding Agent & Codex Skill"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/agents/project-management/cs-project-manager.md">Source</a></span>
</div>
...
**Skill Location:** [`project-management/senior-pm`](https://github.com/Patasse97/claude-skills/tree/main/project-management/senior-pm)

**Python Tools:**

1. **Project Health Dashboard**
   - **Purpose:** Generate portfolio-level health dashboard with RAG status across all active projects
   - **Path:** [`scripts/project_health_dashboard.py`](https://github.com/Patasse97/claude-skills/tree/main/project-management/senior-pm/scripts/project_health_dashboard.py)
...
2. **Risk Matrix Analyzer**
   ...
   - **Path:** [`scripts/risk_matrix_analyzer.py`](https://github.com/Patasse97/claude-skills/tree/main/project-management/senior-pm/scripts/risk_matrix_analyzer.py)
...
3. **Resource Capacity Planner**
   ...
   - **Path:** [`scripts/resource_capacity_planner.py`](https://github.com/Patasse97/claude-skills/tree/main/project-management/senior-pm/scripts/resource_capacity_planner.py)
...
- [`references/portfolio-prioritization-models.md`](https://github.com/Patasse97/claude-skills/tree/main/project-management/senior-pm/references/portfolio-prioritization-models.md) -- WSJF, MoSCoW, Cost of Delay, portfolio scoring frameworks
- [`references/risk-management-framework.md`](https://github.com/Patasse97/claude-skills/tree/main/project-management/senior-pm/references/risk-management-framework.md) -- Risk identification, qualitative/quantitative analysis, response strategies
- [`references/portfolio-kpis.md`](https://github.com/Patasse97/claude-skills/tree/main/project-management/senior-pm/references/portfolio-kpis.md) -- KPI definitions, tracking cadences, executive reporting metrics

**Templates:**

- [`assets/executive_report_template.md`](https://github.com/Patasse97/claude-skills/tree/main/project-management/senior-pm/assets/executive_report_template.md) -- Executive status report with RAG, risks, decisions needed
- [`assets/project_charter_template.md`](https://github.com/Patasse97/claude-skills/tree/main/project-management/senior-pm/assets/project_charter_template.md) -- Project charter with scope, objectives, constraints, stakeholders
- [`assets/raci_matrix_template.md`](https://github.com/Patasse97/claude-skills/tree/main/project-management/senior-pm/assets/raci_matrix_template.md) -- Responsibility assignment matrix for cross-functional teams

### Scrum Master

**Skill Location:** [`project-management/scrum-master`](https://github.com/Patasse97/claude-skills/tree/main/project-management/scrum-master)

**Python Tools:**

1. **Sprint Health Scorer**
   - **Purpose:** Quantitative sprint health assessment across scope, velocity, quality, and team morale
   - **Path:** [`scripts/sprint_health_scorer.py`](https://github.com/Patasse97/claude-skills/tree/main/project-management/scrum-master/scripts/sprint_health_scorer.py)
...
2. **Velocity Analyzer**
   ...
   - **Path:** [`scripts/velocity_analyzer.py`](https://github.com/Patasse97/claude-skills/tree/main/project-management/scrum-master/scripts/velocity_analyzer.py)
...
3. **Retrospective Analyzer**
   ...
   - **Path:** [`scripts/retrospective_analyzer.py`](https://github.com/Patasse97/claude-skills/tree/main/project-management/scrum-master/scripts/retrospective_analyzer.py)
...
- [`references/retro-formats.md`](https://github.com/Patasse97/claude-skills/tree/main/project-management/scrum-master/references/retro-formats.md) -- Start/Stop/Continue, 4Ls, Sailboat, Mad/Sad/Glad, Starfish formats
- [`references/team-dynamics-framework.md`](https://github.com/Patasse97/claude-skills/tree/main/project-management/scrum-master/references/team-dynamics-framework.md) -- Tuckman stages, psychological safety, conflict resolution
- [`references/velocity-forecasting-guide.md`](https://github.com/Patasse97/claude-skills/tree/main/project-management/scrum-master/references/velocity-forecasting-guide.md) -- Monte Carlo simulation, confidence ranges, capacity planning

**Templates:**

- [`assets/sprint_report_template.md`](https://github.com/Patasse97/claude-skills/tree/main/project-management/scrum-master/assets/sprint_report_template.md) -- Sprint review report with burndown, velocity, demo notes
- [`assets/team_health_check_template.md`](https://github.com/Patasse97/claude-skills/tree/main/project-management/scrum-master/assets/team_health_check_template.md) -- Spotify-style team health check across 8 dimensions

### Jira Expert

**Skill Location:** [`project-management/jira-expert`](https://github.com/Patasse97/claude-skills/tree/main/project-management/jira-expert)

**Knowledge Bases:**

- [`references/jql-examples.md`](https://github.com/Patasse97/claude-skills/tree/main/project-management/jira-expert/references/jql-examples.md) -- JQL query patterns for backlog grooming, sprint reporting, SLA tracking
- [`references/automation-examples.md`](https://github.com/Patasse97/claude-skills/tree/main/project-management/jira-expert/references/automation-examples.md) -- Jira automation rule templates for common workflows
- [`references/AUTOMATION.md`](https://github.com/Patasse97/claude-skills/tree/main/project-management/jira-expert/references/AUTOMATION.md) -- Comprehensive automation guide with triggers, conditions, actions
- [`references/WORKFLOWS.md`](https://github.com/Patasse97/claude-skills/tree/main/project-management/jira-expert/references/WORKFLOWS.md) -- Workflow design patterns, transition rules, validators, post-functions

### Confluence Expert

**Skill Location:** [`project-management/confluence-expert`](https://github.com/Patasse97/claude-skills/tree/main/project-management/confluence-expert)

**Knowledge Bases:**

- [`references/templates.md`](https://github.com/Patasse97/claude-skills/tree/main/project-management/confluence-expert/references/templates.md) -- Page templates for sprint plans, meeting notes, decision logs, architecture docs

### Atlassian Admin

**Skill Location:** [`project-management/atlassian-admin`](https://github.com/Patasse97/claude-skills/tree/main/project-management/atlassian-admin)
...
**Skill Location:** [`project-management/atlassian-templates`](https://github.com/Patasse97/claude-skills/tree/main/project-management/atlassian-templates)
...
2. **Query Backlog via JQL** - Use jira-expert JQL patterns to pull prioritized candidates:
   - Reference: [`references/jql-examples.md`](https://github.com/Patasse97/claude-skills/tree/main/project-management/jira-expert/references/jql-examples.md)
...
4. **Select Sprint Backlog** - Commit items within capacity:
   - Apply WSJF or priority-based selection (ref: [`references/portfolio-prioritization-models.md`](https://github.com/Patasse97/claude-skills/tree/main/project-management/senior-pm/references/portfolio-prioritization-models.md))
...
5. **Document Sprint Plan** - Create Confluence sprint plan page:
   - Use template from [`references/templates.md`](https://github.com/Patasse97/claude-skills/tree/main/project-management/confluence-expert/references/templates.md)
...
6. **Set Up Sprint Tracking** - Configure dashboards and automation:
   - Create burndown/burnup dashboard (ref: [`references/AUTOMATION.md`](https://github.com/Patasse97/claude-skills/tree/main/project-management/jira-expert/references/AUTOMATION.md))
...
5. **Prepare Executive Report** - Assemble findings into report:
   - Use template: [`assets/executive_report_template.md`](https://github.com/Patasse97/claude-skills/tree/main/project-management/senior-pm/assets/executive_report_template.md)
...
6. **Publish to Confluence** - Create executive dashboard page:
   - Reference KPI definitions from [`references/portfolio-kpis.md`](https://github.com/Patasse97/claude-skills/tree/main/project-management/senior-pm/references/portfolio-kpis.md)
...
2. **Select Retro Format** - Choose format based on team needs:
   - Reference: [`references/retro-formats.md`](https://github.com/Patasse97/claude-skills/tree/main/project-management/scrum-master/references/retro-formats.md)
...
3. **Facilitate Retrospective** - Run the session:
   ...
   - Reference team dynamics from [`references/team-dynamics-framework.md`](https://github.com/Patasse97/claude-skills/tree/main/project-management/scrum-master/references/team-dynamics-framework.md)
...
6. **Document in Confluence** - Publish retro summary:
   - Use sprint report template: [`assets/sprint_report_template.md`](https://github.com/Patasse97/claude-skills/tree/main/project-management/scrum-master/assets/sprint_report_template.md)
...
3. **Design Workflows** - Build workflows matching team process:
   - Reference: [`references/WORKFLOWS.md`](https://github.com/Patasse97/claude-skills/tree/main/project-management/jira-expert/references/WORKFLOWS.md)
...
4. **Configure Automation** - Set up time-saving automation rules:
   - Reference: [`references/AUTOMATION.md`](https://github.com/Patasse97/claude-skills/tree/main/project-management/jira-expert/references/AUTOMATION.md)
   - Examples from: [`references/automation-examples.md`](https://github.com/Patasse97/claude-skills/tree/main/project-management/jira-expert/references/automation-examples.md)
...
5. **Set Up Confluence Space** - Create team knowledge base:
   - Reference: [`references/templates.md`](https://github.com/Patasse97/claude-skills/tree/main/project-management/confluence-expert/references/templates.md)
...
6. **Create Dashboards** - Build visibility for team and stakeholders:
   ...
   - Use JQL patterns from [`references/jql-examples.md`](https://github.com/Patasse97/claude-skills/tree/main/project-management/jira-expert/references/jql-examples.md)
...
- [cs-product-manager](https://github.com/Patasse97/claude-skills/tree/main/agents/product/cs-product-manager.md) -- Product prioritization with RICE, customer discovery, PRD development
- [cs-agile-product-owner](https://github.com/Patasse97/claude-skills/tree/main/agents/product/cs-agile-product-owner.md) -- User story generation, backlog management, acceptance criteria (planned)
- cs-scrum-master -- Dedicated Scrum ceremony facilitation and team coaching (planned)

## References

- **Senior PM Skill:** [../../project-management/senior-pm/SKILL.md](https://github.com/Patasse97/claude-skills/tree/main/project-management/senior-pm/SKILL.md)
- **Scrum Master Skill:** [../../project-management/scrum-master/SKILL.md](https://github.com/Patasse97/claude-skills/tree/main/project-management/scrum-master/SKILL.md)
- **Jira Expert Skill:** [../../project-management/jira-expert/SKILL.md](https://github.com/Patasse97/claude-skills/tree/main/project-management/jira-expert/SKILL.md)
- **Confluence Expert Skill:** [../../project-management/confluence-expert/SKILL.md](https://github.com/Patasse97/claude-skills/tree/main/project-management/confluence-expert/SKILL.md)
- **Atlassian Admin Skill:** [../../project-management/atlassian-admin/SKILL.md](https://github.com/Patasse97/claude-skills/tree/main/project-management/atlassian-admin/SKILL.md)
- **PM Domain Guide:** [../../project-management/CLAUDE.md](https://github.com/Patasse97/claude-skills/tree/main/project-management/CLAUDE.md)
- **Agent Development Guide:** [../CLAUDE.md](https://github.com/Patasse97/claude-skills/tree/main/agents/CLAUDE.md)
