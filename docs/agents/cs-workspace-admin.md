---
title: "Workspace Admin â€” AI Coding Agent & Codex Skill"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/agents/engineering-team/cs-workspace-admin.md">Source</a></span>
</div>
...
### Skill Location
[`engineering-team/google-workspace-cli`](https://github.com/Patasse97/claude-skills/tree/main/engineering-team/google-workspace-cli)

### Python Tools

1. **GWS Doctor**
   - **Path:** [`scripts/gws_doctor.py`](https://github.com/Patasse97/claude-skills/tree/main/engineering-team/google-workspace-cli/scripts/gws_doctor.py)
...
2. **Auth Setup Guide**
   - **Path:** [`scripts/auth_setup_guide.py`](https://github.com/Patasse97/claude-skills/tree/main/engineering-team/google-workspace-cli/scripts/auth_setup_guide.py)
...
3. **Recipe Runner**
   - **Path:** [`scripts/gws_recipe_runner.py`](https://github.com/Patasse97/claude-skills/tree/main/engineering-team/google-workspace-cli/scripts/gws_recipe_runner.py)
...
4. **Workspace Audit**
   - **Path:** [`scripts/workspace_audit.py`](https://github.com/Patasse97/claude-skills/tree/main/engineering-team/google-workspace-cli/scripts/workspace_audit.py)
...
5. **Output Analyzer**
   - **Path:** [`scripts/output_analyzer.py`](https://github.com/Patasse97/claude-skills/tree/main/engineering-team/google-workspace-cli/scripts/output_analyzer.py)
...
1. **Command Reference** â€” [`references/gws-command-reference.md`](https://github.com/Patasse97/claude-skills/tree/main/engineering-team/google-workspace-cli/references/gws-command-reference.md)
   - 18 services, 22 helpers, global flags, environment variables
2. **Recipes Cookbook** â€” [`references/recipes-cookbook.md`](https://github.com/Patasse97/claude-skills/tree/main/engineering-team/google-workspace-cli/references/recipes-cookbook.md)
   - 43 recipes organized by category with persona mapping
3. **Troubleshooting** â€” [`references/troubleshooting.md`](https://github.com/Patasse97/claude-skills/tree/main/engineering-team/google-workspace-cli/references/troubleshooting.md)
   - Common errors, auth issues, platform-specific fixes

### Templates

1. **Workspace Config** â€” [`assets/workspace-config.json`](https://github.com/Patasse97/claude-skills/tree/main/engineering-team/google-workspace-cli/assets/workspace-config.json)
   - Automation config template with auth, defaults, scheduled tasks
2. **Persona Profiles** â€” [`assets/persona-profiles.md`](https://github.com/Patasse97/claude-skills/tree/main/engineering-team/google-workspace-cli/assets/persona-profiles.md)
...
- [cs-senior-engineer](https://github.com/Patasse97/claude-skills/tree/main/agents/engineering/cs-senior-engineer.md) â€” Architecture and CI/CD

## References

- [Skill Documentation](https://github.com/Patasse97/claude-skills/tree/main/engineering-team/google-workspace-cli/SKILL.md)
