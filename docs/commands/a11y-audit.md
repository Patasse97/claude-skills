---
title: "/a11y-audit â€” Slash Command for AI Coding Agents"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/commands/a11y-audit.md">Source</a></span>
</div>
...
Parse the JSON output. Group findings by severity (critical â†’ serious â†’ moderate â†’ minor).
...
- `tabindex` values > 0 â†’ set to 0
- Missing `type="button"` on non-submit buttons
- Outline removal without replacement â†’ add `:focus-visible` styles
