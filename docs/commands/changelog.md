---
title: "/changelog â€” Slash Command for AI Coding Agents"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/commands/changelog.md">Source</a></span>
</div>
...
## Scripts
- `engineering/changelog-generator/scripts/generate_changelog.py` â€” Parse commits, render changelog (`--from-tag`, `--to-tag`, `--from-ref`, `--to-ref`, `--format markdown|json`)
- `engineering/changelog-generator/scripts/commit_linter.py` â€” Validate conventional commit format (`--from-ref`, `--to-ref`, `--strict`, `--format text|json`)

## Skill Reference
â†’ `engineering/changelog-generator/SKILL.md`
