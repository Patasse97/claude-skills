---
title: "/competitive-matrix â€” Slash Command for AI Coding Agents"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/commands/competitive-matrix.md">Source</a></span>
</div>
...
## Scripts
- `product-team/competitive-teardown/scripts/competitive_matrix_builder.py` â€” Matrix builder

## Skill Reference
â†’ `product-team/competitive-teardown/SKILL.md`
