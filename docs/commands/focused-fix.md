---
title: "/focused-fix â€” Slash Command for AI Coding Agents"
description: "Deep-dive feature repair â€” systematically fix an entire feature/module across all its files and dependencies. Usage: /focused-fix <feature-path>. Slash command for Claude Code, Codex CLI, Gemini CLI."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/commands/focused-fix.md">Source</a></span>
</div>
