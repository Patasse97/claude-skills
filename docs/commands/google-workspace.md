---
title: "/google-workspace â€” Slash Command for AI Coding Agents"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/commands/google-workspace.md">Source</a></span>
</div>
...
- `engineering-team/google-workspace-cli/scripts/gws_doctor.py` â€” Pre-flight diagnostics
- `engineering-team/google-workspace-cli/scripts/auth_setup_guide.py` â€” Auth setup guide
- `engineering-team/google-workspace-cli/scripts/gws_recipe_runner.py` â€” Recipe catalog & runner
- `engineering-team/google-workspace-cli/scripts/workspace_audit.py` â€” Security audit
- `engineering-team/google-workspace-cli/scripts/output_analyzer.py` â€” JSON/NDJSON analyzer
