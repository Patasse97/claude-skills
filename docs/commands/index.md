...
description: "22 slash commands for Claude Code, Codex CLI, and Gemini CLI â€” sprint planning, tech debt analysis, PRDs, OKRs, and more."
---
...
-   :material-console:{ .lg .middle } **[`/seo-auditor`](seo-auditor.md)**
    ...
    Systematically scan, audit, and optimize documentation files for SEO. Targets README.md files and docs/ pages â€” fixes...
