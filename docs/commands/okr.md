---
title: "/okr â€” Slash Command for AI Coding Agents"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/commands/okr.md">Source</a></span>
</div>
...
## Scripts
- `product-team/product-strategist/scripts/okr_cascade_generator.py` â€” OKR cascade generator (`<strategy> [--teams "A,B,C"] [--contribution 0.3] [--json]`)
