---
title: "/persona â€” Slash Command for AI Coding Agents"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/commands/persona.md">Source</a></span>
</div>
...
## Scripts
- `product-team/ux-researcher-designer/scripts/persona_generator.py` â€” Persona generator (positional `json` arg for JSON output)
