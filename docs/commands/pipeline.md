---
title: "/pipeline â€” Slash Command for AI Coding Agents"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/commands/pipeline.md">Source</a></span>
</div>
...
## Scripts
- `engineering/ci-cd-pipeline-builder/scripts/stack_detector.py` â€” Detect stack and tooling (`--repo <path>`, `--format text|json`)
- `engineering/ci-cd-pipeline-builder/scripts/pipeline_generator.py` â€” Generate pipeline YAML (`--platform github|gitlab`, `--repo <path>`, `--input <stack.json>`, `--output <file>`)

## Skill Reference
â†’ `engineering/ci-cd-pipeline-builder/SKILL.md`
