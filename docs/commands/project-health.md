---
title: "/project-health â€” Slash Command for AI Coding Agents"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/commands/project-health.md">Source</a></span>
</div>
...
## Scripts
- `project-management/senior-pm/scripts/project_health_dashboard.py` â€” Health dashboard (`<data_file> [--format text|json]`)
- `project-management/senior-pm/scripts/risk_matrix_analyzer.py` â€” Risk matrix analyzer (`<data_file> [--format text|json]`)
