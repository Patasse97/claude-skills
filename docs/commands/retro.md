---
title: "/retro â€” Slash Command for AI Coding Agents"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/commands/retro.md">Source</a></span>
</div>
...
## Scripts
- `project-management/scrum-master/scripts/retrospective_analyzer.py` â€” Retrospective analyzer (`<data_file> [--format text|json]`)
