---
title: "/rice â€” Slash Command for AI Coding Agents"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/commands/rice.md">Source</a></span>
</div>
...
## Scripts
- `product-team/product-manager-toolkit/scripts/rice_prioritizer.py` â€” RICE prioritizer (`<input.csv> [--capacity N] [--output text|json|csv]`)
