---
title: "/saas-health â€” Slash Command for AI Coding Agents"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/commands/saas-health.md">Source</a></span>
</div>
...
## Scripts
- `finance/saas-metrics-coach/scripts/metrics_calculator.py` â€” Core SaaS metrics (ARR, MRR, churn, CAC, LTV, NRR, payback)
- `finance/saas-metrics-coach/scripts/quick_ratio_calculator.py` â€” Growth efficiency ratio
- `finance/saas-metrics-coach/scripts/unit_economics_simulator.py` â€” 12-month forward projection

## Skill Reference
â†’ `finance/saas-metrics-coach/SKILL.md`

## Related Commands
- `/financial-health` â€” Traditional financial analysis (ratios, DCF, budgets)
