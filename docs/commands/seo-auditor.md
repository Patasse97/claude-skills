---
title: "/seo-auditor â€” Slash Command for AI Coding Agents"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/commands/seo-auditor.md">Source</a></span>
</div>


Systematically scan, audit, and optimize documentation files for SEO. Targets README.md files and docs/ pages â€” fixes issues in place, preserves rankings on high-performing pages, and generates a final report.
...
Classify each file:
- **New/recently modified** â€” files changed in the last 2 commits (check via `git log`)
- **Index pages** â€” `index.md` files (high authority, handle with care)
- **Skill pages** â€” `docs/skills/**/*.md` (generated by `generate-docs.py`)
- **Static pages** â€” `docs/index.md`, `docs/getting-started.md`, `docs/integrations.md`, etc.
- **README files** â€” root and domain-level README.md

### 1b. Capture baseline

For each target file, extract current SEO state:
- `title:` frontmatter field â†’ becomes `<title>` tag
- `description:` frontmatter field â†’ becomes `<meta name="description">`
- First `# H1` heading
...
- For skill pages: should follow the pattern `{Skill Name} â€” {Differentiator} - {site_name}`
- site_name from `mkdocs.yml` is appended automatically â€” don't duplicate it in the title
...
- Must be unique across all pages â€” no two pages share the same description
...
- H2s follow H1, H3s follow H2 â€” no skipping levels
- Headings should contain keywords naturally (not stuffed)
- No duplicate headings on the same page

**Auto-fix:** If heading levels skip (H1 â†’ H3), adjust to proper hierarchy.
...
Check scores for:
- **Readability** â€” aim for score â‰¥ 70
- **Structure** â€” aim for score â‰¥ 60
- **Engagement** â€” aim for score â‰¥ 50
...
- Replace AI clichÃ©s ("delve into", "leverage", "it's important to note")
- Vary sentence length
- Add specific examples instead of generic statements
- Use active voice

**Important:** Only modify content that was recently created or updated. Do NOT rewrite pages that are ranking well â€” preserve their content.
...
- [ ] URL slug (for new pages only â€” never change existing URLs)

### 4c. Keyword density

- Primary keyword: 1-2% of total word count
- Secondary keywords: 0.5-1% each
- No keyword stuffing â€” if density exceeds 3%, reduce it
...
Compare H1 headings across all pages â€” no two pages should have the same H1.

### 5c. Orphan page detection

Check if every page in `docs/` is referenced in `mkdocs.yml` nav. Pages not in nav are orphans â€” they won't appear in navigation and may not be indexed.
...
â•‘  SEO AUDITOR REPORT                                         â•‘
â• â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•£
â•‘                                                              â•‘
â•‘  Pages scanned:        {n}                                   â•‘
â•‘  Issues found:         {n}                                   â•‘
â•‘  Auto-fixed:           {n}                                   â•‘
â•‘  Manual review needed: {n}                                   â•‘
â•‘                                                              â•‘
â•‘  META TAGS                                                   â•‘
â•‘    Titles optimized:     {n}                                 â•‘
â•‘    Descriptions fixed:   {n}                                 â•‘
â•‘    Duplicate titles:     {n} â†’ {n} (fixed)                   â•‘
â•‘    Duplicate descs:      {n} â†’ {n} (fixed)                   â•‘
â•‘                                                              â•‘
â•‘  CONTENT                                                     â•‘
â•‘    Readability improved: {n} pages                           â•‘
â•‘    Heading fixes:        {n}                                 â•‘
â•‘    AI score improved:    {n} pages                           â•‘
â•‘                                                              â•‘
â•‘  KEYWORDS                                                    â•‘
â•‘    Pages missing primary keyword in title: {n}               â•‘
â•‘    Pages missing keyword in description:   {n}               â•‘
â•‘    Pages with keyword stuffing:            {n}               â•‘
â•‘                                                              â•‘
â•‘  LINKS                                                       â•‘
â•‘    Broken links found:   {n} â†’ {n} (fixed)                   â•‘
â•‘    Orphan pages:         {n} â†’ {n} (added to nav)            â•‘
â•‘    Duplicate content:    {n} â†’ {n} (deduplicated)            â•‘
â•‘                                                              â•‘
â•‘  SITEMAP                                                     â•‘
â•‘    Total URLs:           {n}                                 â•‘
â•‘    Sitemap regenerated:  âœ…                                  â•‘
â•‘                                                              â•‘
â•‘  PRESERVED (no changes â€” ranking well)                       â•‘
â•‘    {list of pages left untouched}                            â•‘
â•‘                                                              â•‘
...
- `docs/index.md` â€” homepage, ranks for "Claude Code Skills"
- `docs/getting-started.md` â€” installation guide
- `docs/integrations.md` â€” multi-tool support
...
| AI Writing Detection | `marketing-skill/content-humanizer/references/ai-tells-checklist.md` | AI clichÃ© removal |
