---
title: "/sprint-health â€” Slash Command for AI Coding Agents"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/commands/sprint-health.md">Source</a></span>
</div>
...
## Scripts
- `project-management/scrum-master/scripts/sprint_health_scorer.py` â€” Sprint health scorer (`<data_file> [--format text|json]`)
- `project-management/scrum-master/scripts/velocity_analyzer.py` â€” Velocity analyzer (`<data_file> [--format text|json]`)
