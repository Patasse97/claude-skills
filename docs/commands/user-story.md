---
title: "/user-story â€” Slash Command for AI Coding Agents"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/commands/user-story.md">Source</a></span>
</div>
...
## Scripts
- `product-team/agile-product-owner/scripts/user_story_generator.py` â€” User story generator (positional args: `sprint <capacity>`)
