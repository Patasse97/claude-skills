---
title: Custom GPTs â€” Agent Skills in ChatGPT
...
Use Agent Skills directly in ChatGPT â€” no installation, no API keys, no setup.
...
-   :material-pencil:{ .lg .middle } **Conversion Copywriter**
    ...
    Landing pages, pricing pages, email sequences, CTAs, headlines, and A/B test variants â€” all conversion-focused.
...
2. **Start chatting** â€” the GPT is pre-configured with domain expertise
3. **Get structured output** â€” not generic advice, but frameworks and actionable workflows
...
The GPTs are a **preview** of what the full library offers. If you find a GPT useful, the installed skill version goes deeper â€” with access to your files, codebase, and project context.
...
- **4,600+ GitHub stars** Â· **500+ forks** Â· **7,400+ unique cloners** (last 14 days)
...
[View on GitHub :fontawesome-brands-github:](https://github.com/Patasse97/claude-skills){ .md-button }
