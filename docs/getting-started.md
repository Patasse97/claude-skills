---
title: Install Agent Skills â€” Codex, Gemini CLI, OpenClaw Setup
...
=== "Claude Code"
    ...
    <ol class="install-steps">
      <li>
        ...
        <pre><code>/plugin marketplace add Patasse97/claude-skills</code></pre>
      </li>
      <li>
      ...
      <li>
        <strong>Use them immediately</strong> â€” skills activate as slash commands or contextual expertise.
      </li>
    </ol>
...
All 305 tools use the standard library only â€” zero pip installs, all verified.
...
??? question "Can I use Agent Skills in ChatGPT?"
    Yes. We have [6 Custom GPTs](custom-gpts.md) that bring Agent Skills directly into ChatGPT â€” no installation needed. Just click and start chatting.
