...
|-------|--------------|-------------|
| **autoresearch-agent** | `/ar:run` | Autonomous experiment loop â€” edit, evaluate, keep or revert. Karpathy-inspired. |
...
| **research-summarizer** | `/research:summarize` | Structured research â†’ summary â†’ citations workflow. |
...
Claude Code Â· Gemini CLI Â· Cursor Â· OpenClaw Â· Aider Â· Windsurf Â· Kilo Code Â· OpenCode Â· Augment Â· Antigravity

See the [full README](https://github.com/Patasse97/claude-skills) for platform-specific install guides.
