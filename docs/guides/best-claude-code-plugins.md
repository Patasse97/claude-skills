...
Looking for the best Claude Code plugins to supercharge your workflow? This guide covers 20 production-ready plugins and agent skills â€” from engineering and DevOps to marketing, product management, and C-level advisory.
...
This repo provides **both formats** â€” every skill includes a `.claude-plugin` directory for native Claude Code plugin support, plus a `SKILL.md` for cross-platform compatibility.
...
claude /plugin install https://github.com/Patasse97/claude-skills
...
| **autoresearch-agent** | Autonomous experiment loop â€” optimizes any file by a measurable metric. | `/plugin install autoresearch-agent` |
...
| Plugin | What It Does | Install |
|--------|-------------|---------|
| **research-summarizer** | Structured research â†’ summary â†’ citations for papers and reports. | `/plugin install research-summarizer` |
...
Unlike single-purpose plugins, these are **POWERFUL-tier** agent skills â€” each includes:

- **Structured workflows** with slash commands (not just prompts)
- **Python CLI tools** (254 total, zero pip dependencies)
- **Reference documents** â€” templates, checklists, domain-specific knowledge
- **Cross-platform support** â€” works on 11 coding agents, not just Claude Code
...
- [Full Skill Catalog](https://github.com/Patasse97/claude-skills) â€” all 192 skills
- [Agent Skills for Codex](./agent-skills-for-codex.md) â€” Codex-specific guide
- [Gemini CLI Skills Guide](./gemini-cli-skills-guide.md) â€” Gemini CLI setup
- [Cursor Skills Guide](./cursor-skills-guide.md) â€” Cursor integration

---

*Last updated: March 2026 Â· [Patasse97/claude-skills](https://github.com/Patasse97/claude-skills)*
