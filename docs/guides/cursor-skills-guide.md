...
All 192 skills across 9 domains. See the [full README](https://github.com/Patasse97/claude-skills) for the complete list.

**Also works with:** Claude Code Â· OpenAI Codex Â· Gemini CLI Â· OpenClaw Â· Aider Â· Windsurf Â· Kilo Code Â· OpenCode Â· Augment Â· Antigravity
