...
Gemini CLI's free tier gives you **unlimited evaluation calls** â€” perfect for:

- **Autoresearch loops** â€” run overnight experiments with zero API cost
- **Content optimization** â€” LLM-judge evaluators for headlines, copy, prompts
- **Code review** â€” systematic multi-pass reviews without burning tokens
...
# The evaluator calls gemini CLI for scoring â€” free!
```
...
| Skill | What It Does |
|-------|-------------|
| **autoresearch-agent** | Autonomous experiment loop â€” edit, evaluate, keep or revert. Free with Gemini. |
...
| **research-summarizer** | Structured research â†’ summary â†’ citations workflow. |
...
Claude Code Â· OpenAI Codex Â· Cursor Â· OpenClaw Â· Aider Â· Windsurf Â· Kilo Code Â· OpenCode Â· Augment Â· Antigravity

See the [full catalog](https://github.com/Patasse97/claude-skills) for all 192 skills.
