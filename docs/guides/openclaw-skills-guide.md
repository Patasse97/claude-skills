# OpenClaw Skills Guide â€” Install & Use Agent Skills with OpenClaw

> **Last updated:** March 2026 Â· **Skills count:** 192+ Â· **Compatibility:** OpenClaw v2024.12+

## What Are OpenClaw Skills?

OpenClaw skills are modular instruction packages that extend your OpenClaw agent with domain expertise â€” from engineering and DevOps to marketing, compliance, and C-level advisory. Each skill drops into your OpenClaw workspace and works immediately with zero configuration.
...
OpenClaw's skill system is the most natural fit in the ecosystem â€” skills live in your workspace directory and are automatically loaded based on task context.
...
OpenClaw has native skill support â€” it scans `<available_skills>` in your workspace and auto-selects the right skill for each task.
...
|---|---|---|---|---|
| Native skill loading | âœ… Automatic | âœ… Manual | âš ï¸ Rules only | âš ï¸ Instructions |
| Slash commands | âœ… | âœ… | âŒ | âŒ |
| Python tool execution | âœ… | âœ… | âŒ | âœ… |
| Multi-agent delegation | âœ… Built-in | âŒ | âŒ | âŒ |
| Persistent memory | âœ… | âš ï¸ Session | âŒ | âŒ |
| Cron/scheduled tasks | âœ… | âŒ | âŒ | âŒ |

OpenClaw's architecture â€” persistent agents, memory, cron jobs, and multi-channel messaging â€” makes it the most capable platform for running agent skills autonomously.
...
```
skill-name/
â”œâ”€â”€ SKILL.md              # Instructions, workflows, slash commands
â”œâ”€â”€ .claude-plugin/
â”‚   â””â”€â”€ plugin.json       # Metadata for plugin registries
â”œâ”€â”€ scripts/
â”‚   â”œâ”€â”€ tool_one.py       # Executable Python tools
â”‚   â””â”€â”€ tool_two.py
â””â”€â”€ references/
    â”œâ”€â”€ patterns.md       # Domain knowledge, templates
...
- **GitHub:** [Patasse97/claude-skills](https://github.com/Patasse97/claude-skills)
...
*Part of the [Claude Code Skills & Agent Plugins](https://github.com/Patasse97/claude-skills) repository â€” 192+ production-ready skills for 11 AI coding tools.*
