---
title: "Agent Orchestration â€” Multi-Skill Coordination Protocol"
...
```
Week 1: startup-cto + engineering skills â†’ Build
Week 2: growth-marketer + marketing skills â†’ Prepare launch
...
```
1. content-strategy â†’ Identify topics and angles
2. copywriting â†’ Write the content
3. seo-audit â†’ Optimize for search
4. analytics-tracking â†’ Set up measurement
```
...
[:octicons-arrow-right-24: Full orchestration protocol](https://github.com/Patasse97/claude-skills/blob/main/orchestration/ORCHESTRATION.md)
