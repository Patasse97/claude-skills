---
title: "Business & Growth Skills â€” Agent Skill for Growth"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/business-growth/SKILL.md">Source</a></span>
</div>
...
### Codex CLI
```bash
npx agent-skills-cli add Patasse97/claude-skills/business-growth
```
