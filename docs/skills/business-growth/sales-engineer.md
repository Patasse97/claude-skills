---
title: "Sales Engineer Skill â€” Agent Skill for Growth"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/business-growth/sales-engineer/SKILL.md">Source</a></span>
</div>
...
**Validation checkpoint:** Coverage score must be >50% and must-have gaps â‰¤3 before proceeding to Phase 2. Check with:
```bash
...
**Priority Weighting:** Must-Have 3Ã—, Should-Have 2Ã—, Nice-to-Have 1Ã—.

**Bid/No-Bid Logic:**
- **Bid:** Coverage >70% AND must-have gaps â‰¤3
- **Conditional Bid:** Coverage 50â€“70% OR must-have gaps 2â€“3
...
- **Week 1:** Setup â€” environment provisioning, data migration, configuration
- **Weeks 2â€“3:** Core Testing â€” primary use cases, integration testing
- **Week 4:** Advanced Testing â€” edge cases, performance, security
- **Week 5:** Evaluation â€” scorecard completion, stakeholder review, go/no-go
...
- **Marketing Skills** - Leverage competitive intelligence and messaging frameworks from [`marketing-skill`](https://github.com/Patasse97/claude-skills/tree/main/marketing-skill)
- **Product Team** - Coordinate on roadmap items flagged as "Planned" in RFP analysis from [`product-team`](https://github.com/Patasse97/claude-skills/tree/main/product-team)
- **C-Level Advisory** - Escalate strategic deals requiring executive engagement from [`c-level-advisor`](https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor)
- **Customer Success** - Hand off POC results and success criteria to CSM from [`business-growth/customer-success-manager`](https://github.com/Patasse97/claude-skills/tree/main/business-growth/customer-success-manager)
