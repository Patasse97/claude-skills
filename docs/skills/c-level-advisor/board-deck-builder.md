---
title: "Board Deck Builder â€” Agent Skill for Executives"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/board-deck-builder/SKILL.md">Source</a></span>
</div>
...
Build board decks that tell a story â€” not just show data. Every section has an owner, a narrative, and a "so what."
...
Provide available metrics. The builder fills gaps with explicit placeholders â€” never invents numbers.

## Deck Structure (Standard Order)

Every section follows: **Headline â†’ Data â†’ Narrative â†’ Ask/Next**
...
*Good:* "We closed Q3 at $2.4M ARR (+22% QoQ), signed our largest enterprise contract, and enter Q4 with 14-month runway. The strategic shift to mid-market is working â€” ACV up 40% and sales cycle down 3 weeks. Q4 priority: close the $3M Series A and hit $2.8M ARR."
...
|--------|-------------|-------------|--------|--------|
| ARR | $2.4M | $1.97M | $2.3M | âœ… |
| MoM growth | 8.1% | 7.2% | 7.5% | âœ… |
| Burn multiple | 1.8x | 2.1x | <2x | âœ… |
| NRR | 112% | 108% | >110% | âœ… |
| CAC payback | 11 months | 14 months | <12 months | âœ… |
| Headcount | 24 | 21 | 25 | ðŸŸ¡ |
...
- ARR waterfall: starting â†’ new â†’ expansion â†’ churn â†’ ending
...
**Opening frame:** Start with the one thing that matters most â€” the board should know the key message by slide 3, not slide 30.
...
**Framework:**
1. **State it plainly** â€” "We missed Q3 ARR target by $300K (12% gap)"
2. **Own the cause** â€” "Primary driver was longer-than-expected sales cycle in enterprise segment"
3. **Show you understand it** â€” "We analyzed 8 lost/stalled deals; the pattern is X"
4. **Present the fix** â€” "We've made 3 changes: [specific, dated changes]"
5. **Update the forecast** â€” "Revised Q4 target is $2.6M; here's the bottom-up build"

**What NOT to do:**
- Don't lead with good news to soften bad news â€” boards notice and distrust the framing
- Don't explain without owning â€” "market conditions" is not a cause, it's a context
...
| Mistake | Fix |
|---------|-----|
| Too many slides (>25) | Cut ruthlessly â€” if you can't explain it in the room, the slide is wrong |
...
| Designing for the reader, not the room | Decks are presented â€” they must work spoken aloud |
...
**Monthly (for early-stage):** Condensed â€” metrics dashboard, financials, pipeline, top risks. 8-12 slides.
**Fundraising:** Opens with market/vision, closes with ask. See `references/deck-frameworks.md` for Sequoia format.

## References
- `references/deck-frameworks.md` â€” SaaS board pack format, Sequoia structure, investor tailoring
- `templates/board-deck-template.md` â€” fill-in template for complete board decks
