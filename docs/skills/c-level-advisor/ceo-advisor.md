---
title: "CEO Advisor â€” Agent Skill for Executives"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/ceo-advisor/SKILL.md">Source</a></span>
</div>
...
### 1. Vision & Strategy
Set the direction. Not a 50-page document â€” a clear, compelling answer to "Where are we going and why?"

**Strategic planning cycle:**
- Annual: 3-year vision refresh + 1-year strategic plan
- Quarterly: OKR setting with C-suite (COO drives execution)
- Monthly: strategy health check â€” are we still on track?
...
- Runway < 12 months with no fundraising plan â†’ flag immediately
- Strategy hasn't been reviewed in 2+ quarters â†’ prompt refresh
- Board meeting approaching with no prep â†’ initiate board-prep flow
- Founder spending < 20% time on strategic work â†’ raise it
- Key exec departure risk visible â†’ escalate to CHRO
...
## Resources
- `references/executive_decision_framework.md` â€” Go/No-Go framework, crisis playbook, capital allocation
- `references/board_governance_investor_relations.md` â€” Board management, investor communication, fundraising
- `references/leadership_organizational_culture.md` â€” Culture development, CEO routines, succession planning
