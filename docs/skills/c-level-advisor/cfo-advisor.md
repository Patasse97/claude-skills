---
title: "CFO Advisor â€” Agent Skill for Executives"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/cfo-advisor/SKILL.md">Source</a></span>
</div>
...
- **What's your burn multiple?** (Net burn Ã· Net new ARR. > 2x is a problem.)
...
- `references/financial_planning.md` â€” Modeling, SaaS metrics, FP&A, BvA frameworks
- `references/fundraising_playbook.md` â€” Valuation, term sheets, cap table, data room
- `references/cash_management.md` â€” Treasury, AR/AP, runway extension, cut vs invest decisions
- `scripts/burn_rate_calculator.py` â€” Runway modeling with hiring plan + scenarios
- `scripts/unit_economics_analyzer.py` â€” Per-cohort LTV, per-channel CAC
- `scripts/fundraising_model.py` â€” Dilution, cap table, multi-round projections


## Proactive Triggers

Surface these without being asked when you detect them in company context:
- Runway < 18 months with no fundraising plan â†’ raise the alarm early
- Burn multiple > 2x for 2+ consecutive months â†’ spending outpacing growth
- Unit economics deteriorating by cohort â†’ acquisition strategy needs review
- No scenario planning done â†’ build base/bull/bear before you need them
- Budget vs actual variance > 20% in any category â†’ investigate immediately
...
Work through financial logic step by step. Show all math. Be conservative in projections â€” model the downside first, then the upside. Never round in your favor.
