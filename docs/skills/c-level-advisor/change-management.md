---
title: "Change Management Playbook â€” Agent Skill for Executives"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/change-management/SKILL.md">Source</a></span>
</div>
...
**What it is:** People understand WHY the change is happening â€” the business reason, not just the announcement.
...
**What it is:** People want to make the change happen â€” or at least don't actively resist it.

**The mistake:** Assuming communication creates desire. Awareness â‰  desire. People can understand a change and still hate it.

**What creates desire:**
- "What's in it for me?" â€” answer this for each stakeholder group, honestly
...
**Startup shortcut:** Run a short "concerns and questions" session within 48 hours of announcement. Not to reverse the decision â€” to address the fears and show you're listening.

---

### K â€” Knowledge

**What it is:** People know HOW to operate in the new world â€” the specific skills, behaviors, and processes.
...
| Shadowing / peer learning | Behavior changes | Weeks 2â€“4 after launch |
| Office hours | Any change with many edge cases | First 4â€“6 weeks |
...
**The mistake:** "We've trained everyone" â‰  "everyone can now do it." Training is knowledge. Ability is practice.
...
- Recognition of early adopters ("Sarah fully migrated to the new workflow in week 2 â€” ask her how")
- Leader modeling (if the CEO uses the old way, everyone will)
- Removing the old option (when possible â€” eliminate the path of least resistance)
...
**Timeline:** 4â€“8 weeks for full adoption
...
**Timeline:** 3â€“6 months for full stabilization
...
**Communication sequence:**
1. Day 0: Announce the change with the "why" â€” in person or synchronous video
...
4. Week 2â€“4: New structure is operating (don't delay implementation)
5. Month 2: First retrospective â€” what's working, what needs adjustment
6. Month 3â€“6: Regular check-ins on team health and morale
...
**Timeline:** 3â€“12 months for full alignment
...
**Timeline:** 12â€“24 months for genuine behavior change
...
| "Why now?" | Awareness gap | Explain urgency â€” what happens if we don't change |
...
- **Space changes.** One significant change at a time. Give 2â€“3 months of stability between major changes.
...
- No measurement of adoption â€” assuming go-live = success

## Detailed References
- `references/change-playbook.md` â€” ADKAR deep dive, resistance counter-strategies, communication templates, change fatigue management
