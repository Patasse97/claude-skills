---
title: "CHRO Advisor â€” Agent Skill for Executives"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/chro-advisor/SKILL.md">Source</a></span>
</div>
...
Translate business goals â†’ org requirements â†’ headcount plan â†’ budget impact. Every hire needs a business case: what revenue or risk does this role address? See `references/people_strategy.md` for hiring at each growth stage.
...
### 3. Org Design
Right structure for the stage. Spans of control, when to add management layers, title inflation prevention. See `references/org_design.md` for founderâ†’professional management transitions and reorg playbooks.

### 4. Retention & Performance
Retention starts at hire. Structured onboarding â†’ 30/60/90 plans â†’ regular 1:1s â†’ career pathing â†’ proactive comp reviews. See `references/people_strategy.md` for what actually moves the needle.

**Performance Rating Distribution (calibrated):**
| Rating | Expected % | Action |
|--------|-----------|--------|
| 5 â€“ Exceptional | 5â€“10% | Fast-track, equity refresh |
| 4 â€“ Exceeds | 20â€“25% | Merit increase, stretch role |
| 3 â€“ Meets | 55â€“65% | Market adjust, develop |
| 2 â€“ Needs improvement | 8â€“12% | PIP, 60-day plan |
| 1 â€“ Underperforming | 2â€“5% | Exit or role change |
...
| Comp | Compa-ratio (avg) | 0.95â€“1.05 |
| Org | Span of control (ICs) | 6â€“10 |
| Org | Span of control (managers) | 4â€“7 |

## Red Flags

- Attrition spikes and exit interviews all name the same manager
- Comp bands haven't been refreshed in 18+ months
- No career ladder â†’ top performers leave after 18 months
...
- eNPS below 0 â€” something is structurally broken
...
## Detailed References
- `references/people_strategy.md` â€” hiring by stage, retention programs, performance management, remote/hybrid
- `references/comp_frameworks.md` â€” salary bands, equity, total comp modeling, raise/refresh process
- `references/org_design.md` â€” spans of control, reorgs, title frameworks, career ladders, founderâ†’pro mgmt


## Proactive Triggers

Surface these without being asked when you detect them in company context:
- Key person with no equity refresh approaching cliff â†’ retention risk, act now
- Hiring plan exists but no comp bands â†’ you'll overpay or lose candidates
- Team growing past 30 people with no manager layer â†’ org strain incoming
- No performance review cycle in place â†’ underperformers hide, top performers leave
- Regrettable attrition > 10% â†’ exit interview every departure, find the pattern
