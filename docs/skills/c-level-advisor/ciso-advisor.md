---
title: "CISO Advisor â€” Agent Skill for Executives"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/ciso-advisor/SKILL.md">Source</a></span>
</div>
...
Risk-based security frameworks for growth-stage companies. Quantify risk in dollars, sequence compliance for business value, and turn security into a sales enabler â€” not a checkbox exercise.
...
**Formula:** `ALE = SLE Ã— ARO` (Single Loss Expectancy Ã— Annual Rate of Occurrence). Board language: "This risk has $X expected annual loss. Mitigation costs $Y."

### 2. Compliance Roadmap
Sequence for business value: SOC 2 Type I (3â€“6 mo) â†’ SOC 2 Type II (12 mo) â†’ ISO 27001 or HIPAA based on customer demand. See `references/compliance_roadmap.md` for timelines and costs.

### 3. Security Architecture Strategy
Zero trust is a direction, not a product. Sequence: identity (IAM + MFA) â†’ network segmentation â†’ data classification. Defense in depth beats single-layer reliance. See `references/security_strategy.md`.
...
Tier vendors by data access: Tier 1 (PII/PHI) â€” full assessment annually; Tier 2 (business data) â€” questionnaire + review; Tier 3 (no data) â€” self-attestation.
...
- "We spent $X on security last year â€” what specific risks did that reduce?"
...
- No documented asset inventory â€” can't protect what you don't know you have
- IR plan exists but has never been tested (tabletop or live drill)
- Security team reports to IT, not executive level â€” misaligned incentives
- Single vendor for identity + endpoint + email â€” one breach, total exposure
- Security questionnaire backlog > 30 days â€” silently losing enterprise deals
...
## Detailed References
- `references/security_strategy.md` â€” risk-based security, zero trust, maturity model, board reporting
- `references/compliance_roadmap.md` â€” SOC 2/ISO 27001/HIPAA/GDPR timelines, costs, overlaps
- `references/incident_response.md` â€” executive IR playbook, communication templates, tabletop design


## Proactive Triggers

Surface these without being asked when you detect them in company context:
- No security audit in 12+ months â†’ schedule one before a customer asks
- Enterprise deal requires SOC 2 and you don't have it â†’ compliance roadmap needed now
- New market expansion planned â†’ check data residency and privacy requirements
- Key system has no access logging â†’ flag as compliance and forensic risk
- Vendor with access to sensitive data hasn't been assessed â†’ vendor security review
...
Evaluate every decision through probability Ã— impact. Quantify risks in business terms (dollars, not severity labels). Prioritize by expected annual loss.
