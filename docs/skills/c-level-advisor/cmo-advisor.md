---
title: "CMO Advisor â€” Agent Skill for Executives"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/cmo-advisor/SKILL.md">Source</a></span>
</div>
...
Strategic marketing leadership â€” brand positioning, growth model design, budget allocation, and org design. Not campaign execution or content creation; those have their own skills. This is the engine.
...
- `references/brand_positioning.md` â€” category design, messaging architecture, battlecards, rebrand framework
- `references/growth_frameworks.md` â€” PLG/SLG/CLG playbooks, growth loops, switching models
- `references/marketing_org.md` â€” team structure by stage, hiring sequence, agency vs. in-house

---

## The Four CMO Questions

Every CMO must own answers to these â€” no one else in the C-suite can:

1. **Who are we for?** â€” ICP, positioning, category
2. **Why do they choose us?** â€” Differentiation, messaging, brand
3. **How do they find us?** â€” Growth model, channel mix, demand gen
4. **Is it working?** â€” CAC, LTV:CAC, pipeline contribution, payback period

---

## Core Responsibilities (Brief)

**Brand & Positioning** â€” Define category, build messaging architecture, maintain competitive differentiation. Details â†’ `references/brand_positioning.md`

**Growth Model** â€” Choose and operate the right acquisition engine: PLG, sales-led, community-led, or hybrid. The growth model determines team structure, budget, and what "working" means. Details â†’ `references/growth_frameworks.md`

**Marketing Budget** â€” Allocate from revenue target backward: new customers needed â†’ conversion rates by stage â†’ MQLs needed â†’ spend by channel based on CAC. Run `marketing_budget_modeler.py` for scenarios.

**Marketing Org** â€” Structure follows growth model. Hire in sequence: generalist first, then specialist in the working channel, then PMM, then marketing ops. Details â†’ `references/marketing_org.md`

**Channel Mix** â€” Audit quarterly: MQLs, cost, CAC, payback, trend. Scale what's improving. Cut what's worsening. Don't optimize a channel that isn't in the strategy.

**Board Reporting** â€” Pipeline contribution, CAC by channel, payback period, LTV:CAC. Not impressions. Not MQLs in isolation.
...
- What's your MQL â†’ Opportunity conversion rate? (proxy for lead quality)
...
|----------|--------|---------------|
| **Pipeline** | Marketing-sourced pipeline % | 50â€“70% of total |
| **Pipeline** | Pipeline coverage ratio | 3â€“4x quarterly quota |
| **Pipeline** | MQL â†’ Opportunity rate | > 15% |
| **Efficiency** | Blended CAC payback | < 18 months |
| **Efficiency** | LTV:CAC ratio | > 3:1 |
| **Efficiency** | Marketing % of total S&M spend | 30â€“50% |
| **Growth** | Brand search volume trend | â†‘ QoQ |
...
- No defined ICP â€” "companies with 50-1000 employees" is not an ICP
- Marketing and sales disagree on what an MQL is (this is always a system problem, not a people problem)
- CAC tracked only as a blended number â€” channel-level CAC is non-negotiable
...
- Brand work and performance marketing have no shared narrative â€” they're contradicting each other
...
- CAC rising quarter over quarter â†’ channel efficiency declining, investigate
- No brand positioning documented â†’ messaging inconsistent across channels
- Marketing budget allocation hasn't changed in 6+ months â†’ market changed, budget didn't
- Competitor launched major campaign â†’ flag for competitive response
- Pipeline contribution from marketing unclear â†’ measurement gap, fix before spending more
