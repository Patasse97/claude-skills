---
title: "Company Operating System â€” Agent Skill for Executives"
description: "The meta-framework for how a company runs â€” the connective tissue between all C-suite roles. Covers operating system selection (EOS, Scaling Up. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/company-os/SKILL.md">Source</a></span>
</div>
...
The operating system is the collection of tools, rhythms, and agreements that determine how the company functions. Every company has one â€” most just don't know what it is. Making it explicit makes it improvable.
...
Most operational dysfunction isn't a people problem â€” it's a system problem. When:
...
```
CEO
â”œâ”€â”€ Sales (CRO/VP Sales)
â”‚   â”œâ”€â”€ Inbound pipeline
â”‚   â””â”€â”€ Outbound pipeline
â”œâ”€â”€ Product & Engineering (CTO/CPO)
â”‚   â”œâ”€â”€ Product roadmap
â”‚   â””â”€â”€ Engineering delivery
â”œâ”€â”€ Operations (COO)
â”‚   â”œâ”€â”€ Customer success
â”‚   â””â”€â”€ Finance & Legal
â””â”€â”€ People (CHRO/VP People)
    â”œâ”€â”€ Recruiting
...
2. Assign one owner per function â€” no exceptions
...
**Rules:**
- 5â€“15 metrics maximum. More than 15 and nothing gets attention.
- Each metric has an owner and a weekly target (not a range â€” a number).
...
|--------|-------|--------|-----------|--------|
| New MRR | CRO | â‚¬50K | â‚¬43K | ðŸ”´ |
| Churn | CS Lead | < 1% | 0.8% | ðŸŸ¢ |
| Active users | CPO | 2,000 | 2,150 | ðŸŸ¢ |
| Deployments | CTO | 3/week | 3 | ðŸŸ¢ |
| Open critical bugs | CTO | 0 | 2 | ðŸ”´ |
| Runway | CFO | > 18mo | 16mo | ðŸŸ¡ |

**Anti-pattern:** Measuring everything. If you track 40 KPIs, you're watching, not managing.

### 3. Meeting Pulse

The meeting rhythm that drives the company. Not optional â€” the pulse is what keeps the company alive.
...
| Quarterly planning | Quarterly | 1â€“2 days | Leadership | Set rocks, review strategy |
| Annual planning | Annual | 2â€“3 days | Leadership | 1-year + 3-year vision |

**The L10 meeting (Weekly Leadership Sync):**
Named for the goal of each meeting being a 10/10. Fixed agenda:
1. Good news (5 min) â€” personal + business
2. Scorecard review (5 min) â€” flag red items only
3. Rock review (5 min) â€” on/off track for each rock
4. Customer/employee headlines (5 min)
5. Issues list (60 min) â€” IDS (see below)
6. To-dos review (5 min) â€” last week's commitments
7. Conclude (5 min) â€” rate the meeting 1â€“10, what would make it a 10 next time
...
- **Identify:** What is the actual issue? (Not the symptom â€” the root cause) State it in one sentence.
...
**Anti-patterns:**
- "Let's take this offline" â€” most things taken offline never get resolved
- Discussing without deciding â€” a great discussion with no action item is wasted time
- Revisiting decided issues â€” once solved, it leaves the list. Reopen only with new information.

**The Issues List:** A running, prioritized list of all unresolved issues. Owned by the leadership team. Reviewed and pruned weekly. If an issue has been on the list for 3+ meetings and hasn't been discussed, it's either not a real issue or it's too scary to address â€” both deserve attention.

### 5. Rocks (90-Day Priorities)

Rocks are the 3â€“7 most important things each person must accomplish in the next 90 days. They're not the job description â€” they're the things that move the company forward.

**Why 90 days?** Long enough for meaningful progress. Short enough to stay real.

**Rock rules:**
- Each person: 3â€“7 rocks maximum. More than 7 and none get done.
- Company-level rocks (shared priorities): 3â€“7 for the leadership team
...
| If you are... | Consider... |
|---------------|-------------|
| 10â€“250 person company, founder-led, operational chaos | EOS / Traction |
...
2. Define 5â€“10 weekly scorecard metrics (leadership team alignment, 1 hour)
3. Start the weekly L10 meeting (no prep â€” just start)
...
**Partial implementation:** "We do OKRs but skip the weekly check-in." Half an operating system is worse than none â€” it creates theater without accountability.
...
## Detailed References
- `references/os-comparison.md` â€” EOS vs Scaling Up vs OKRs vs Holacracy vs hybrid
- `references/implementation-guide.md` â€” 90-day implementation plan
