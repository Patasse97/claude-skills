---
title: "Competitive Intelligence â€” Agent Skill for Executives"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/competitive-intel/SKILL.md">Source</a></span>
</div>
...
Systematic competitor tracking. Not obsession â€” intelligence that drives real decisions.
...
```
/ci:landscape         â€” Map your competitive space (direct, indirect, future)
/ci:battlecard [name] â€” Build a sales battlecard for a specific competitor
/ci:winloss           â€” Analyze recent wins and losses by reason
/ci:update [name]     â€” Track what a competitor did recently
/ci:map               â€” Build competitive positioning map
```
...
|---------|-----|-------------|-------------|------------|
| [Feature] | âœ… | âœ… | âŒ | Your advantage |
| [Feature] | âŒ | âœ… | âœ… | Gap â€” roadmap? |
| [Feature] | âœ… | âŒ | âŒ | Moat |
| [Feature] | âŒ | âŒ | âœ… | Competitor B only |

### Layer 4: Output Formats

**For Sales (CRO):** Battlecards â€” one page per competitor, designed for pre-call prep.
See `templates/battlecard-template.md`

**For Marketing (CMO):** Positioning update â€” message shifts, new differentiators, claims to stop or start making.

**For Product (CPO):** Feature gap summary â€” what customers ask for that we don't have, what competitors ship, what to reprioritize.

**For CEO/Board:** Monthly competitive summary â€” 1-page: who moved, what it means, recommended responses.
...
- Competitor raises funding â†’ assess implications within 48 hours
- Competitor launches major feature â†’ product + sales response within 1 week
- Competitor poaches key customer â†’ win/loss interview within 2 weeks
- Competitor changes pricing â†’ analyze and respond within 1 week
...
- Every competitive win (learn why â€” it may not be what you think)
...
**One source of truth:** All competitive intel lives in one place (Notion, Confluence, Salesforce). Avoid Slack-only distribution â€” it disappears.
...
| Prospects evaluate you to justify competitor decision | You're the "check box" â€” fix perception or segment |
...
## References
- `references/ci-playbook.md` â€” OSINT sources, win/loss framework, positioning map construction
- `templates/battlecard-template.md` â€” sales battlecard template
