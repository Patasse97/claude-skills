---
title: "CPO Advisor â€” Agent Skill for Executives"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/cpo-advisor/SKILL.md">Source</a></span>
</div>
...
Strategic product leadership. Vision, portfolio, PMF, org design. Not for feature-level work â€” for the decisions that determine what gets built, why, and by whom.
...
| **Metrics** | North star â†’ leading â†’ lagging hierarchy, board reporting | This file |
...
- What's blocking your slowest team â€” the people or the structure?
...
Every product gets one: **Invest / Maintain / Kill**. "Wait and see" is not a posture â€” it's a decision to lose share.
...
- Retention curve not flattening â†’ PMF at risk, raise before building more
- Feature requests piling up without prioritization framework â†’ propose RICE/ICE
- No user research in 90+ days â†’ product team is guessing
- NPS declining quarter over quarter â†’ dig into detractor feedback
- Portfolio has a "dog" everyone avoids discussing â†’ force the kill/invest decision
