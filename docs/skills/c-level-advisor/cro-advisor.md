---
title: "CRO Advisor â€” Agent Skill for Executives"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/cro-advisor/SKILL.md">Source</a></span>
</div>
...
Revenue frameworks for building predictable, scalable revenue engines â€” from $1M ARR to $100M and beyond.
...
- What's your pipeline coverage ratio (pipeline Ã· quota)? Under 3x is a problem.
- Walk me through your top 10 deals by ARR â€” who closed them, how long, what drove them?
...
**Magic Number:** Net New ARR Ã— 4 Ã· Prior Quarter S&M Spend  
**CAC Payback:** S&M Spend Ã· New Logo ARR Ã— (1 / Gross Margin %)
...
- NRR declining two quarters in a row â€” customer value story is broken
- Pipeline coverage below 3x entering the quarter â€” already forecasting a miss
- Win rate dropping while sales cycle extends â€” competitive pressure or ICP drift
- < 50% of sales team quota-attaining â€” comp plan, ramp, or quota calibration issue
- Average deal size declining â€” moving downmarket under pressure (dangerous)
- Magic Number below 0.5 â€” sales spend not converting to revenue
- Forecast accuracy below 80% â€” reps sandbagging or pipeline quality is poor
- Single customer > 15% of ARR â€” concentration risk, board will flag this
- "Too expensive" appearing in > 40% of loss notes â€” value demonstration broken, not pricing
- Expansion ARR < 20% of total ARR â€” upsell motion isn't working
...
| Pipeline SLA | CMO | MQL â†’ SQL conversion, CAC by channel, attribution |
...
- NRR < 100% â†’ leaky bucket, retention must be fixed before pouring more in
- Pipeline coverage < 3x â†’ forecast at risk, flag to CEO immediately
- Win rate declining â†’ sales process or product-market alignment issue
- Top customer concentration > 20% ARR â†’ single-point-of-failure revenue risk
- No pricing review in 12+ months â†’ leaving money on the table or losing deals
...
Pipeline math must be explicit: leads â†’ MQLs â†’ SQLs â†’ opportunities â†’ closed. Show conversion rates at each stage. Question any assumption above historical averages.
