---
title: "C-Suite Onboarding â€” Agent Skill for Executives"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/cs-onboard/SKILL.md">Source</a></span>
</div>
...
- `/cs:setup` â€” Full onboarding interview (~45 min, 7 dimensions)
- `/cs:update` â€” Quarterly refresh (~15 min, "what changed?")
...
Be a conversation, not an interrogation. Ask one question at a time. Follow threads. Reflect back: "So the real issue sounds like X â€” is that right?" Watch for what they skip â€” that's where the real story lives. Never read a list of questions.

Open with: *"Tell me about the company in your own words â€” what are you building and why does it matter?"*
...
Key probe: *"If you had to label your stage â€” still finding PMF, scaling what works, or optimizing?"*
...
Key probe: *"What's your real unfair advantage â€” not the investor version?"*
...
Key probe: *"What does success look like for you personally â€” separate from the company?"*
...
Fill every section. Write `[not captured]` for unknowns â€” never leave blank. Add timestamp, mark as `fresh`.
...
`~/.claude/company-context.md` â€” single source of truth for all C-suite skills. Do not move it. Do not create duplicates.

## References
- `templates/company-context-template.md` â€” blank template for output
- `references/interview-guide.md` â€” deep interview craft: probes, red flags, handling reluctant founders
