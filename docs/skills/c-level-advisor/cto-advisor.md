---
title: "CTO Advisor â€” Agent Skill for Executives"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/cto-advisor/SKILL.md">Source</a></span>
</div>
...
Scale the engineering org's productivity â€” not individual output.
...
Create the framework for making good decisions â€” not making every decision yourself.
...
- Severity (P0â€“P3): how much is it blocking velocity or creating risk?
- Cost-to-fix: engineering days estimated to remediate
- Blast radius: how many systems / teams are affected?

**Step 3 â€” Build a prioritized remediation plan**
Sort by: `(Severity Ã— Blast Radius) / Cost-to-fix` â€” highest score = fix first.
Group items into: (a) immediate sprint, (b) next quarter, (c) tracked backlog.

**Step 4 â€” Validate before presenting to stakeholders**
...
**Example output â€” Tech Debt Inventory:**
```
...
**Step 1 â€” Identify the decision**
...
Options Considered:
  - Option A: [description] â€” TCO: $X | Risk: Low/Med/High
  - Option B: [description] â€” TCO: $X | Risk: Low/Med/High
Decision: [Chosen option and rationale]
Consequences: [What becomes easier? What becomes harder?]
```

**Step 3 â€” Validation checkpoint (before finalizing)**
...
**Step 4 â€” Communicate and close**
...
**Step 1 â€” Define requirements** (functional + non-functional)
**Step 2 â€” Identify candidate vendors or internal build scope**
...
**Step 4 â€” Default rule:** Buy unless it is core IP or no vendor meets â‰¥ 70% of requirements.
**Step 5 â€” Document the decision as an ADR** (see ADR workflow above).

## Key Questions a CTO Asks

- "What's our biggest technical risk right now â€” not the most annoying, the most dangerous?"
...
- Deployment frequency dropping â†’ early signal of team health issues
- Tech debt ratio > 30% â†’ recommend a tech debt sprint
- No ADRs filed in 30+ days â†’ architecture decisions going undocumented
- Single point of failure on critical system â†’ flag bus factor risk
- Cloud costs growing faster than revenue â†’ cost optimization review
- Security audit overdue (> 12 months) â†’ escalate to CISO
...
Research the technical landscape first. Analyze options against constraints (time, team skill, cost, risk). Then recommend action. Always ground recommendations in evidence â€” benchmarks, case studies, or measured data from your own systems. "I think" is not enough â€” show the data.
...
## Resources
- `references/technology_evaluation_framework.md` â€” Build vs buy, vendor evaluation, technology radar
- `references/engineering_metrics.md` â€” DORA metrics, engineering health dashboard, team productivity
- `references/architecture_decision_records.md` â€” ADR templates, decision governance, review process
