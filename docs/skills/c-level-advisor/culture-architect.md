---
title: "Culture Architect â€” Agent Skill for Executives"
description: "Build, measure, and evolve company culture as operational behavior â€” not wall posters. Covers mission/vision/values workshops, values-to-behaviors. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/culture-architect/SKILL.md">Source</a></span>
</div>
...
Culture is what you DO, not what you SAY. This skill builds culture as an operational system â€” observable behaviors, measurable health, and rituals that scale.
...
If your values say "transparency" but you punish bearers of bad news â€” your real value is "optics." Culture is not aspirational. It's descriptive. The work is closing the gap between stated and actual.
...
**Mission** â€” Why do we exist (beyond making money)?
...
| Ownership | "We take responsibility" | "We don't hand off problems â€” we own them until resolved, even across team boundaries" |
| Speed | "We move fast" | "Decisions under â‚¬5K happen at team level, same day, no approval needed" |
...
**Workshop exercise:** Write your value. Then ask "How would a new hire know we actually live this on day 30?" If you can't answer concretely, it's not a value â€” it's an aspiration.
...
3. Who doesn't thrive here (honest â€” this is the useful part)
...
- "We're a family" â€” families don't fire each other for performance
- Listing only positive traits â€” the "who doesn't thrive here" section is what makes it credible
- Making it aspirational instead of descriptive

### 4. Culture Health Assessment

Run quarterly. 8â€“12 questions. Anonymous. See `references/culture-playbook.md` for survey design.

**Core areas to measure:**
1. Psychological safety â€” "Can I raise a concern without fear?"
2. Clarity â€” "Do I know how my work connects to company goals?"
3. Fairness â€” "Are decisions made consistently and transparently?"
4. Growth â€” "Am I learning and being challenged here?"
5. Trust in leadership â€” "Do I believe what leadership tells me?"

**Score interpretation:**
| Score | Signal | Action |
|-------|--------|--------|
| 80â€“100% | Healthy | Maintain, celebrate, document |
| 65â€“79% | Warning | Identify specific friction â€” don't over-react |
| 50â€“64% | Damaged | Urgent leadership attention + specific fixes |
| < 50% | Crisis | Culture emergency â€” all-hands intervention |
...
- Monthly retrospective: what's working, what's not â€” no hierarchy
- "Default to transparency": share everything unless there's a specific reason not to

**Early growth (15â€“50 people)**
...
**Scaling (50â€“200 people)**
- Culture committee (peer-driven, not HR): 4â€“6 people rotating quarterly
...
- Subculture management: engineering culture â‰  sales culture â€” both must align to company core
...
## Detailed References
- `references/culture-playbook.md` â€” Netflix analysis, survey design, ritual examples, M&A playbook
- `templates/culture-code-template.md` â€” Culture code document template
