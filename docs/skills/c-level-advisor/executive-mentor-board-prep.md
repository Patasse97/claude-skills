---
title: "/em:board-prep â€” Board Meeting Preparation â€” Agent Skill for Executives"
description: "/em -board-prep â€” Board Meeting Preparation. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---

# /em:board-prep â€” Board Meeting Preparation

<div class="page-meta" markdown>
<span class="meta-badge">:material-account-tie: C-Level Advisory</span>
<span class="meta-badge">:material-identifier: `board-prep`</span>
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/executive-mentor/skills/board-prep/SKILL.md">Source</a></span>
</div>
...
They know when you're not being straight with them. The question isn't whether they'll ask the hard questions â€” it's whether you're ready for them.
...
1. **Where we are (honest)** â€” Current state of business, the real number, not the smoothed one
2. **What we learned** â€” What the data is telling us that we didn't know 90 days ago
3. **What we got wrong** â€” Name it directly. Don't make them ask.
4. **What we're doing about it** â€” Specific, dated, owned actions
5. **What we need from this room** â€” Concrete ask. Not "support" â€” specific introductions, decisions, resources.
...
- **The operator** â€” wants to know what's breaking and who owns fixing it
- **The financial investor** â€” focused on path to profitability or next raise
- **The strategic investor** â€” worried about competitive position and moat
- **The independent** â€” watching governance, team dynamics, and your judgment
...
- [ ] 3 hardest questions you expect â€” rehearsed out loud
