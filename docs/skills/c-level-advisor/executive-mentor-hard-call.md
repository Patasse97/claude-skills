---
title: "/em:hard-call â€” Framework for Decisions With No Good Options â€” Agent Skill for Executives"
description: "/em -hard-call â€” Framework for Decisions With No Good Options. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---

# /em:hard-call â€” Framework for Decisions With No Good Options

<div class="page-meta" markdown>
<span class="meta-badge">:material-account-tie: C-Level Advisory</span>
<span class="meta-badge">:material-identifier: `hard-call`</span>
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/executive-mentor/skills/hard-call/SKILL.md">Source</a></span>
</div>
...
1. **Real people are affected** â€” someone loses a job, a relationship ends, a team is hurt
2. **You've been avoiding the decision** â€” which means the problem is already worse than it was
3. **Irreversibility** â€” unlike most business decisions, you can't undo this easily
4. **You have skin in the game** â€” your judgment about the right call is clouded by your feelings about it
...
- **Reversible** â€” try it, learn, adjust (fire the vendor, kill the feature, change the strategy)
- **Partially reversible** â€” painful to undo but possible (restructure, change co-founder roles)
- **Irreversible** â€” cannot be undone (layoff a person, shut down a product with customer lock-in, close a legal entity)

For irreversible decisions, the bar for certainty is higher. You must do more due diligence before acting. Not because you might be wrong â€” but because you can't take it back.
...
This isn't about finding the option that hurts nobody â€” there isn't one. It's about understanding the full picture before you decide.
...
Writing it forces you to confront the reality of what you're doing. It also surfaces whether your reasoning holds under examination. "We're making this change becauseâ€¦" â€” does that sentence ring true?

### Step 6: The Communication Plan

Hard decisions almost always get harder if communication is bad. The decision itself is not the only thing that matters â€” how it's done matters enormously.
...
- **What you'll say** (honest, direct, compassionate â€” see `references/hard_things.md`)
...
### Firing a Co-Founder
See `references/hard_things.md â€” Co-Founder Conflicts` for full framework.

Key questions to answer first:
- Is this a performance problem or a values/culture problem? (Different conversations)
- Have you been explicit â€” not hinted, but direct â€” about the problem?
...
- Are you cutting deep enough? (Insufficient layoffs are worse than no layoffs â€” two rounds destroys trust.)
...
- What's the narrative â€” internally and externally?
