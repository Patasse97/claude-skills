---
title: "/em:postmortem â€” Honest Analysis of What Went Wrong â€” Agent Skill for Executives"
description: "/em -postmortem â€” Honest Analysis of What Went Wrong. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---

# /em:postmortem â€” Honest Analysis of What Went Wrong

<div class="page-meta" markdown>
<span class="meta-badge">:material-account-tie: C-Level Advisory</span>
<span class="meta-badge">:material-identifier: `postmortem`</span>
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/executive-mentor/skills/postmortem/SKILL.md">Source</a></span>
</div>
...
**The blame session** â€” someone gets scapegoated, defensive walls go up, actual causes don't get examined, and the same problem happens again in a different form.

**The whitewash** â€” "We learned a lot, we're going to do better, here are 12 vague action items." Nothing changes. Same problem, different quarter.
...
Precision matters. "We missed Q3 revenue" is not precise enough. "We closed $420K in new ARR vs $680K target â€” a $260K miss driven primarily by three deals that slipped to Q4 and one deal that was lost to a competitor" is precise.

### Step 2: The 5 Whys â€” Done Properly
...
â†’ Conclusion: Nothing to do. It's just enterprise.
...
â†’ Root cause: Qualification criteria outdated, no owner, no review process.
â†’ Fix: Update criteria, assign owner, add quarterly review.
...
**Contributing factor:** Made it worse, but isn't the core reason. If removed, the outcome might have been different â€” but the same class of problem would recur.

**Root cause:** The fundamental condition that made the outcome probable. Fix this, and this class of problem doesn't recur.

Example â€” failed hire:
...
This step is particularly important for systemic issues â€” "we didn't feel safe raising the concern" is a much deeper root cause than "the deal qualification was off."
...
Every post-mortem ends with a change register â€” specific commitments, owned and dated.
...
â€¢ [Factor] â€” how it contributed
â€¢ [Factor] â€” how it contributed

WARNING SIGNS MISSED
â€¢ [Signal visible at what date] â€” why it wasn't acted on
...
The goal isn't to establish that someone made a mistake. The goal is to understand why the system produced that outcome â€” so the system can be improved.
