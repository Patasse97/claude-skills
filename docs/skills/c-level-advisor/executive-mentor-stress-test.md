---
title: "/em:stress-test â€” Business Assumption Stress Testing â€” Agent Skill for Executives"
description: "/em -stress-test â€” Business Assumption Stress Testing. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---

# /em:stress-test â€” Business Assumption Stress Testing

<div class="page-meta" markdown>
<span class="meta-badge">:material-account-tie: C-Level Advisory</span>
<span class="meta-badge">:material-identifier: `stress-test`</span>
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/executive-mentor/skills/stress-test/SKILL.md">Source</a></span>
</div>
...
Founders are optimists by nature. That's a feature â€” you need optimism to start something from nothing. But it becomes a liability when assumptions in business models get inflated by the same optimism that got you started.

**The most dangerous assumptions are the ones everyone agrees on.**

When the whole team believes the $50M market is real, when every investor call goes well so you assume the round will close, when your model shows $2M ARR by December and nobody questions it â€” that's when you're most exposed.
...
State it explicitly. Not "our market is large" but "the total addressable market for B2B spend management software in German SMEs is â‚¬2.3B."

The more specific the assumption, the more testable it is. Vague assumptions are unfalsifiable â€” and therefore useless.

**Common assumption types:**
- **Market size** â€” TAM, SAM, SOM; growth rate; customer segments
- **Customer behavior** â€” willingness to pay, churn, expansion, referrals
- **Revenue model** â€” conversion rates, deal size, sales cycle, CAC
- **Competitive position** â€” moat durability, competitor response speed, switching cost
- **Execution** â€” team velocity, hire timeline, product timeline, operational scaling
- **Macro** â€” regulatory environment, economic conditions, technology availability
...
The goal isn't to find a reason to stop â€” it's to surface what you don't know.
...
- **Validation hedge** â€” test it before betting on it (pilot, customer conversation, small experiment)
- **Contingency hedge** â€” if it's wrong, what's plan B?
- **Early warning hedge** â€” what's the leading indicator that would tell you it's breaking before it's too late to act?
...
SOURCE: [Where this came from â€” model, investor pitch, team gut feel]

COUNTER-EVIDENCE
â€¢ [Specific evidence that challenges this assumption]
â€¢ [Comparable failure case]
â€¢ [Data point that contradicts the assumption]

DOWNSIDE MODEL
â€¢ Bear case (-30%): [Impact on plan]
â€¢ Stress case (-50%): [Impact on plan]
â€¢ Catastrophic (-80%): [Impact on plan â€” does the business survive?]

SENSITIVITY
This assumption has [HIGH / MEDIUM / LOW] sensitivity.
A 10% change â†’ [X] change in outcome.

HEDGE
â€¢ Validation: [How to test this before betting on it]
â€¢ Contingency: [Plan B if it's wrong]
â€¢ Early warning: [Leading indicator to watch â€” and at what threshold to act]
```
