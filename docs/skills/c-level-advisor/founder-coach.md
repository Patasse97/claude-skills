---
title: "Founder Development Coach â€” Agent Skill for Executives"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/founder-coach/SKILL.md">Source</a></span>
</div>
...
Your company can only grow as fast as you do. This skill treats founder development as a strategic priority â€” not a personal indulgence.
...
The founder is always the constraint. Not intentionally â€” it's structural. You built the company. You know everything. Decisions flow through you. This works until it doesn't.
...
**Rules:**
- High skill + high will â†’ Give the work and get out of the way
- High will + low skill â†’ Invest in them. They want to grow.
- High skill + low will â†’ Find out why. Fix the environment or accept the mismatch.
- Low skill + low will â†’ Don't delegate to them. Address the performance issue.

### The Delegation Ladder

Not all delegation is equal. Build up gradually:

1. "Do exactly what I tell you" â€” not delegation, instruction
2. "Research this and report back" â€” information gathering
3. "Propose a solution and I'll decide" â€” thinking delegation
4. "Decide and tell me what you decided" â€” decision delegation with review
5. "Handle it completely â€” update me if it's outside these parameters" â€” full delegation

Start at level 2â€“3. Move people up as trust is established. Most founders never get past level 3 with their team â€” that's the bottleneck.
...
Founders manage energy, not just time. Time is fixed. Energy is renewable â€” but only if you manage it.
...
**Categories:**
- ðŸŸ¢ **Energizing:** Activities that leave you sharper after doing them
- ðŸŸ¡ **Neutral:** Neither energizing nor draining
- ðŸ”´ **Draining:** Activities that leave you depleted
...
**Protect deep work time.** 2â€“4 hours of uninterrupted thinking time, 3â€“5 days per week. Schedule it. Defend it. This is where strategy happens.

**Batch shallow work.** Email, Slack, administrative tasks â€” twice a day maximum.

**Single-task during recovery.** If you're depleted, don't try to do your best work. Do tasks that don't require your best.

**Identify your peak window.** Most people have 4â€“6 peak hours per day. Schedule your hardest work in those windows.
...
|----------|-------------|----------|
| Strategy | Thinking, planning, direction-setting | 20â€“25% |
| People | 1:1s, coaching, recruiting | 20â€“25% |
| External | Customers, investors, partners | 20% |
| Execution | Direct work, decisions | 15% |
| Admin | Email, scheduling, overhead | < 15% |
| Recovery | Exercise, meals, thinking | 10â€“15% |
...
**Executive â†’ Institutional CEO (200+):**
...
**The hardest transition:** Manager â†’ Leader. You have to stop doing things yourself and trust people you're still getting to know.

---

## 6. Blind Spot Identification

Everyone has them. Founders more than most â€” because nobody in the early company had the authority or safety to tell you.

### Common founder blind spots

- **Communication:** "I said it once, they should know" â€” you said it; they didn't hear it or didn't believe it
...
- **Normalize the feeling:** "I feel underprepared for this" â‰  "I am an imposter." Feeling and fact are different.
...
- **Protect recovery time.** Not weekends â€” protected time during the week where you're not available.
...
Paul Graham's "Founder Mode" essay made the case that great founders stay deeply involved in operations â€” skip middle management and go direct. It resonated because it's sometimes true.
...
Building a company that works without you is not disloyalty â€” it's the ultimate expression of leadership.
...
## Detailed References
- `references/leadership-growth.md` â€” Maxwell levels, situational leadership, founder-to-CEO transition
- `references/founder-toolkit.md` â€” Weekly reflection, energy audit, delegation matrix, 1:1 templates
