---
title: "Internal Narrative Builder â€” Agent Skill for Executives"
description: "Build and maintain one coherent company story across all audiences â€” employees, investors, customers, candidates, and partners. Detects narrative. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/internal-narrative/SKILL.md">Source</a></span>
</div>
...
One company. Many audiences. Same truth â€” different lenses. Narrative inconsistency is trust erosion. This skill builds and maintains coherent communication across every stakeholder group.
...
- To investors: "Smart capital allocation â€” they're doubling down on the winner"
- To customers of Product A: "Are they abandoning us?"
- To candidates: "Exciting new focus â€” are they decisive?"
...
> [Company name] exists to [mission â€” present tense, specific]. We're building [what you're building] because [the problem you're solving]. Our approach is [your unique way of doing this]. We're at [honest description of current state] and heading toward [where you're going in concrete terms].

**Good core narrative (example):**
> Acme Health exists to reduce preventable falls in elderly care using smartphone-based mobility analysis. We're building an AI diagnostic tool for care teams because current fall risk assessments are subjective, infrequent, and often wrong. Our approach â€” using the phone's camera during a 10-second walking test â€” means no new hardware, no specialist required. We have 80 care facilities in DACH paying us â‚¬800K ARR, and we're heading to â‚¬3M ARR by demonstrating clinical value at scale before our Series B.
...
|------|----------------------|----------------------|----------------------|------------------------|
| We have 80 customers | "We've proven the model â€” your work matters" | "Product-market fit signal, capital efficient" | "80 care facilities trust us" | "Traction you'd be joining" |
...
| We missed Q2 revenue | "Here's why, here's the plan, here's what you can do" | "Revenue mix shifted â€” trailing indicator improving" | [Usually don't tell customers revenue misses] | [Usually not shared externally] |
| We're hiring fast | "The team is growing â€” your network matters" | "Headcount plan aligned to growth" | [Not relevant unless it affects service] | "This is a rocket ship moment" |

**Rules:**
- Never contradict yourself across audiences. Different framing â‰  different facts.
...
**Question 3:** Are these consistent? If not â€” which version is true?
...
- Leave time for real Q&A â€” not curated questions.

**All-hands failure modes:**
- CEO speaks for 55 of 60 minutes; Q&A is "any quick questions?"
- All good news, all the time â€” employees know when you're not being honest
- Metrics without context: "ARR grew 15%" without explaining if that's good, bad, or expected
- Questions deflected: "That's a great point, we should follow up on that" â†’ never followed up

---

### Step 6: Crisis Communication

When the narrative breaks â€” someone leaves publicly, a product fails, a security breach, a press article.
...
**Hour 4â€“24 (external if needed):**
1. External statement (press, social) only if the event is public
2. Consistent with the internal message â€” same facts, audience-appropriate framing
...
## Detailed References
- `references/narrative-frameworks.md` â€” Storytelling structures, founder narrative, bad news delivery, all-hands templates
- `templates/all-hands-template.md` â€” All-hands presentation template
