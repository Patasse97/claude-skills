---
title: "International Expansion â€” Agent Skill for Executives"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/intl-expansion/SKILL.md">Source</a></span>
</div>
...
**Decision sequence:** Market selection â†’ Entry mode â†’ Regulatory assessment â†’ Localization plan â†’ GTM strategy â†’ Team structure â†’ Launch.
...
**Default path:** Export â†’ Partnership â†’ Local team â†’ Entity (graduate as revenue justifies).
...
## Resources
- `references/market-entry-playbook.md` â€” detailed entry playbook by market type
- `references/regional-guide.md` â€” specific considerations for key regions (EU, US, APAC, LATAM)
