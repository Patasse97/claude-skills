---
title: "M&A Playbook â€” Agent Skill for Executives"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/ma-playbook/SKILL.md">Source</a></span>
</div>
...
**Acquiring:** Start with strategic rationale â†’ target screening â†’ due diligence â†’ valuation â†’ negotiation â†’ integration.

**Being Acquired:** Start with readiness assessment â†’ data room prep â†’ advisor selection â†’ negotiation â†’ transition.
...
## Resources
- `references/integration-playbook.md` â€” 100-day post-acquisition integration plan
- `references/due-diligence-checklist.md` â€” comprehensive DD checklist by domain
