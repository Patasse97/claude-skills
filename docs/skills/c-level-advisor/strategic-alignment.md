---
title: "Strategic Alignment Engine â€” Agent Skill for Executives"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/c-level-advisor/strategic-alignment/SKILL.md">Source</a></span>
</div>
...
**Scoring:**
- All five give the same answer: âœ… Articulation is clear
- 3â€“4 give similar answers: ðŸŸ¡ Loose alignment â€” clarify and communicate
- < 3 agree: ðŸ”´ Strategy isn't clear enough to cascade. Fix this before fixing cascade.

**Format test:** The strategy should be statable in one sentence. If leadership needs a paragraph, teams won't internalize it.
- âŒ "We focus on product-led growth while maintaining enterprise relationships and expanding our international presence and investing in platform capabilities"
- âœ… "Win the mid-market healthcare segment in DACH before Series B"

### Step 2: Cascade Mapping

Map the flow from company strategy â†’ each level of the organization.
...
What the CEO says â‰  what teams hear. The gap grows with company size.

**The message decay model:**
- CEO communicates strategy at all-hands â†’ managers filter through their lens â†’ teams receive modified version â†’ individuals interpret further
...
A quick health check. Score each area 0â€“10:
...
| Score | Status |
|-------|--------|
| 45â€“50 | Excellent. Maintain the system. |
| 35â€“44 | Good. Address specific weak areas. |
| 20â€“34 | Misalignment is costing you. Immediate attention required. |
...
## Detailed References
- `scripts/alignment_checker.py` â€” Automated OKR alignment analysis (orphans, conflicts, coverage)
- `references/alignment-playbook.md` â€” Cascade techniques, quarterly alignment check, common patterns
