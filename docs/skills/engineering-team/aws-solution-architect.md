---
title: "AWS Solution Architect â€” Agent Skill & Codex Plugin"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/engineering-team/aws-solution-architect/SKILL.md">Source</a></span>
</div>
...
```json
{
  ...
  "recommendations": [
    { "action": "Right-size RDS db.r5.2xlarge â†’ db.r5.large", "savings_usd": 420, "priority": "high" },
...
- IAM permission errors â†’ verify `--capabilities CAPABILITY_IAM` and role trust policies
- Resource limit exceeded â†’ request quota increase via Service Quotas console
- Invalid template syntax â†’ run `aws cloudformation validate-template --template-body file://template.yaml` before deploying
