---
title: "Azure Cloud Architect â€” Agent Skill & Codex Plugin"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/engineering-team/azure-cloud-architect/SKILL.md">Source</a></span>
</div>
...
```yaml
# GitHub Actions â€” deploy Bicep to Azure
...
- **Identity**: Entra ID (Azure AD) with RBAC, Managed Identity for service-to-service auth â€” never store credentials in code
...
- RBAC permission errors â€” verify the deploying principal has Contributor on the resource group
- Resource provider not registered â€” run `az provider register --namespace Microsoft.Web`
- Naming conflicts â€” Azure resource names are often globally unique (storage accounts, web apps)
- Quota exceeded â€” request quota increase via Azure Portal > Subscriptions > Usage + quotas
...
|---|---|---|
| ARM JSON templates for new projects | Verbose, hard to read, no modules | Use Bicep â€” compiles to ARM, cleaner syntax |
...
- **Bicep**: Recommended â€” first-party, module support, clean syntax
...
| `engineering-team/gcp-cloud-architect` | GCP equivalent â€” completes the cloud trifecta |
| `engineering-team/senior-devops` | Broader DevOps scope â€” pipelines, monitoring, containerization |
| `engineering/terraform-patterns` | IaC implementation â€” use for Terraform modules targeting Azure |
| `engineering/ci-cd-pipeline-builder` | Pipeline construction â€” automates Azure DevOps and GitHub Actions |
