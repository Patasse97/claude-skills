---
title: "Google Workspace CLI â€” Agent Skill & Codex Plugin"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/engineering-team/google-workspace-cli/SKILL.md">Source</a></span>
</div>
...
**Goal:** Automate email operations â€” send, search, label, and filter management.
...
1. Use OAuth with minimal scopes â€” request only what each workflow needs
