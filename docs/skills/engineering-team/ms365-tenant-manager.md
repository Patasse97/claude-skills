---
title: "Microsoft 365 Tenant Manager â€” Agent Skill & Codex Plugin"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/engineering-team/ms365-tenant-manager/SKILL.md">Source</a></span>
</div>
...
**Validation:** Spot-check 3â€“5 accounts in the M365 admin portal; confirm licenses show "Active."
...
3. Never hardcode credentials in scripts â€” use Azure Key Vault or `Get-Credential`
...
- **Global Administrator** â€” Full tenant setup
- **User Administrator** â€” User management
- **Security Administrator** â€” Security policies
- **Exchange Administrator** â€” Mailbox management
