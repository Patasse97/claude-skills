---
title: "Initialize Playwright Project â€” Agent Skill & Codex Plugin"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/engineering-team/playwright-pro/skills/init/SKILL.md">Source</a></span>
</div>
...
- Check for `tsconfig.json` â†’ use TypeScript; otherwise JavaScript
...
â”œâ”€â”€ pages/
â”‚   â””â”€â”€ .gitkeep          # Page object models
â”œâ”€â”€ test-data/
â”‚   â””â”€â”€ .gitkeep          # Test data files
â””â”€â”€ example.spec.ts       # First example test
```
