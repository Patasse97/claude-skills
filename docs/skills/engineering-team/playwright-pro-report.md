---
title: "Smart Test Reporting â€” Agent Skill & Codex Plugin"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/engineering-team/playwright-pro/skills/report/SKILL.md">Source</a></span>
</div>
...
curl -X POST "$SLACK_WEBHOOK_URL" \
  ...
  -d '{
    "text": "ðŸ§ª Test Results: âœ… {{passed}} | âŒ {{failed}} | â±ï¸ {{duration}}\n{{failed_details}}"
  }'
```
