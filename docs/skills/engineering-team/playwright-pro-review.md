---
title: "Review Playwright Tests â€” Agent Skill & Codex Plugin"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/engineering-team/playwright-pro/skills/review/SKILL.md">Source</a></span>
</div>
...
For each file:
```
## <filename> â€” Score: X/10

### Critical
- Line 15: `waitForTimeout(2000)` â†’ use `expect(locator).toBeVisible()`
- Line 28: CSS selector `.btn-submit` â†’ `getByRole('button', { name: "submit" })`

### Warning
- Line 42: Test name "test login" â†’ "should redirect to dashboard after login"
