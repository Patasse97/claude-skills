---
title: "TestRail Integration â€” Agent Skill & Codex Plugin"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/engineering-team/playwright-pro/skills/testrail/SKILL.md">Source</a></span>
</div>
...
- `TESTRAIL_URL` â€” e.g., `https://your-instance.testrail.io`
- `TESTRAIL_USER` â€” your email
- `TESTRAIL_API_KEY` â€” API key from TestRail

If not set, inform the user how to configure them and stop.

## Capabilities

### 1. Import Test Cases â†’ Generate Playwright Tests
...
### 2. Push Test Results â†’ TestRail
...
3. Call `testrail_add_result` MCP tool for each test:
   - Pass â†’ status_id: 1
   - Fail â†’ status_id: 5, include error message
   - Skip â†’ status_id: 2
