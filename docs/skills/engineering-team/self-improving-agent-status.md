---
title: "/si:status â€” Memory Health Dashboard â€” Agent Skill & Codex Plugin"
...
# /si:status â€” Memory Health Dashboard

<div class="page-meta" markdown>
<span class="meta-badge">:material-code-braces: Engineering - Core</span>
<span class="meta-badge">:material-identifier: `status`</span>
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/engineering-team/self-improving-agent/skills/status/SKILL.md">Source</a></span>
</div>
...
Output: `ðŸ“Š Memory: {{n}}/200 lines | {{count}} rules | {{status_emoji}} {{status_word}}`
...
- Stale entries waste space â€” delete references to files that no longer exist
- Topic files are fine â€” Claude creates them to keep MEMORY.md under 200 lines
