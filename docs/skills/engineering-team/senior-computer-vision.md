---
title: "Senior Computer Vision Engineer â€” Agent Skill & Codex Plugin"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/engineering-team/senior-computer-vision/SKILL.md">Source</a></span>
</div>
...
|-------------------|-------------------|
| NVIDIA GPU (cloud) | PyTorch â†’ ONNX â†’ TensorRT FP16 |
| NVIDIA GPU (edge) | PyTorch â†’ TensorRT INT8 |
| Intel CPU | PyTorch â†’ ONNX â†’ OpenVINO |
| Apple Silicon | PyTorch â†’ CoreML |
| Generic CPU | PyTorch â†’ ONNX Runtime |
| Mobile | PyTorch â†’ TFLite or ONNX Mobile |
...
â†’ See references/reference-docs-and-commands.md for details
