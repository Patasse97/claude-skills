---
title: "Senior Data Scientist â€” Agent Skill & Codex Plugin"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/engineering-team/senior-data-scientist/SKILL.md">Source</a></span>
</div>
...
# 1. Never fit transformers on the full dataset â€” fit on train, transform test.
...
def evaluate_model(model, X, y, cv=5):
    """
    Cross-validate and return mean Â± std for each scorer.
...
# 6. Log every run to MLflow â€” never rely on notebook output for comparison.
```
...
def diff_in_diff(df, outcome, treatment_col, post_col, controls=None):
    ...
    Returns the interaction coefficient (treatment Ã— post) and its p-value.
    """
