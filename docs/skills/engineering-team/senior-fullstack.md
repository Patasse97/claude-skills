---
title: "Senior Fullstack â€” Agent Skill & Codex Plugin"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/engineering-team/senior-fullstack/SKILL.md">Source</a></span>
</div>
...
4. Run initial quality check â€” address any P0 issues before proceeding
...
2. Review security findings â€” fix all P0 (critical) issues immediately
...
1. **SEO Required?** â†’ Next.js with SSR
2. **API-heavy backend?** â†’ Separate FastAPI or NestJS
3. **Real-time features?** â†’ Add WebSocket layer
4. **Team expertise** â†’ Match stack to team skills
