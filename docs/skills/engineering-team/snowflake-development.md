---
title: "Snowflake Development â€” Agent Skill & Codex Plugin"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/engineering-team/snowflake-development/SKILL.md">Source</a></span>
</div>
...
> Originally contributed by [James Cha-Earley](https://github.com/jamescha-earley) â€” enhanced and integrated by the claude-skills team.
...
4. **Monitor costs**: Cortex AI is billed per token â€” sample before running on full tables
...
| Skill | Relationship |
|-------|-------------|
| `engineering/sql-database-assistant` | General SQL patterns â€” use for non-Snowflake databases |
| `engineering/database-designer` | Schema design â€” use for data modeling before Snowflake implementation |
| `engineering-team/senior-data-engineer` | Broader data engineering â€” pipelines, Spark, Airflow, data quality |
| `engineering-team/senior-data-scientist` | Analytics and ML â€” use alongside Snowpark for feature engineering |
