---
title: "/hub:eval â€” Evaluate Agent Results â€” Agent Skill for Codex & OpenClaw"
...
# /hub:eval â€” Evaluate Agent Results

<div class="page-meta" markdown>
<span class="meta-badge">:material-rocket-launch: Engineering - POWERFUL</span>
<span class="meta-badge">:material-identifier: `eval`</span>
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/engineering/agenthub/skills/eval/SKILL.md">Source</a></span>
</div>
...
3. Compare all diffs and rank by:
   - **Correctness** â€” Does it solve the task?
   - **Simplicity** â€” Fewer lines changed is better (when equal correctness)
   - **Quality** â€” Clean execution, good structure, no regressions
