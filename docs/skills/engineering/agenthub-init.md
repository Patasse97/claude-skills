---
title: "/hub:init â€” Create New Session â€” Agent Skill for Codex & OpenClaw"
...
# /hub:init â€” Create New Session

<div class="page-meta" markdown>
<span class="meta-badge">:material-rocket-launch: Engineering - POWERFUL</span>
<span class="meta-badge">:material-identifier: `init`</span>
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/engineering/agenthub/skills/init/SKILL.md">Source</a></span>
</div>
...
1. **Task** â€” What should the agents do? (required)
2. **Agent count** â€” How many parallel agents? (default: 3)
3. **Eval command** â€” Command to measure results (optional â€” skip for LLM judge mode)
4. **Metric name** â€” What metric to extract from eval output (required if eval command given)
5. **Direction** â€” Is lower or higher better? (required if metric given)
6. **Base branch** â€” Branch to fork from (default: current branch)
...
For content or research tasks (no eval command â†’ LLM judge mode):
...
This baseline is used by `result_ranker.py --baseline` during evaluation to show deltas. If the eval command fails at this stage, warn the user but continue â€” baseline is optional.
