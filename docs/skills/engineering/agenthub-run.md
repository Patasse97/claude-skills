---
title: "/hub:run â€” One-Shot Lifecycle â€” Agent Skill for Codex & OpenClaw"
description: "One-shot lifecycle command that chains init â†’ baseline â†’ spawn â†’ eval â†’ merge in a single invocation. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---

# /hub:run â€” One-Shot Lifecycle

<div class="page-meta" markdown>
<span class="meta-badge">:material-rocket-launch: Engineering - POWERFUL</span>
<span class="meta-badge">:material-identifier: `run`</span>
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/engineering/agenthub/skills/run/SKILL.md">Source</a></span>
</div>
...
| `--direction` | No | `lower` or `higher` â€” which direction is better (required if `--metric` given) |
...
- **Sequential execution** â€” each step depends on the previous
- **Stop on failure** â€” if any step fails, report the error and stop
- **User confirms merge** â€” never auto-merge without asking
- **Template is optional** â€” without `--template`, agents use the default dispatch prompt from `/hub:spawn`
