---
title: "/ar:loop â€” Autonomous Experiment Loop â€” Agent Skill for Codex & OpenClaw"
...
# /ar:loop â€” Autonomous Experiment Loop

<div class="page-meta" markdown>
<span class="meta-badge">:material-rocket-launch: Engineering - POWERFUL</span>
<span class="meta-badge">:material-identifier: `loop`</span>
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/engineering/autoresearch-agent/skills/loop/SKILL.md">Source</a></span>
</div>
...
Select loop interval:
  1. Every 10 minutes  (rapid â€” stay and watch)
  2. Every hour         (background â€” check back later)
...
- **3-day auto-expiry**: CronCreate jobs expire after 3 days. For longer experiments, the user must re-run `/ar:loop` to restart. Results persist â€” the new loop picks up where the old one left off.
- **One loop per experiment**: Don't start multiple loops for the same experiment.
- **Concurrent experiments**: Multiple experiments can loop simultaneously ONLY if they're on different git branches (which they are by default â€” each experiment gets `autoresearch/{domain}/{name}`).
