---
title: "/ar:resume â€” Resume Experiment â€” Agent Skill for Codex & OpenClaw"
...
# /ar:resume â€” Resume Experiment

<div class="page-meta" markdown>
<span class="meta-badge">:material-rocket-launch: Engineering - POWERFUL</span>
<span class="meta-badge">:material-identifier: `resume`</span>
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/engineering/autoresearch-agent/skills/resume/SKILL.md">Source</a></span>
</div>
...
Resuming: engineering/api-speed
  ...
  Experiments: 23 total â€” 8 kept, 12 discarded, 3 crashed
  Best: 185ms (-42% from baseline of 320ms)
  Last experiment: "added response caching" â†’ KEEP (185ms)
...
How would you like to continue?
  1. Single iteration (/ar:run)  â€” I'll make one change and evaluate
  2. Start a loop (/ar:loop)     â€” Autonomous with scheduled interval
  3. Just show me the results    â€” I'll review and decide
```
