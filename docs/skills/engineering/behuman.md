---
title: "BeHuman â€” Self-Mirror Consciousness Loop â€” Agent Skill for Codex & OpenClaw"
description: "Use when the user wants more human-like AI responses â€” less robotic, less listy, more authentic. Triggers: 'behuman', 'be real', 'like a human'. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---

# BeHuman â€” Self-Mirror Consciousness Loop

<div class="page-meta" markdown>
<span class="meta-badge">:material-rocket-launch: Engineering - POWERFUL</span>
<span class="meta-badge">:material-identifier: `behuman`</span>
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/engineering/behuman/SKILL.md">Source</a></span>
</div>
...
> Originally contributed by [voidborne-d](https://github.com/voidborne-d) â€” enhanced and integrated by the claude-skills team.

Give AI a mirror. Let it talk to itself before responding â€” like a human does.

## What This Does

Humans have inner dialogue before every response. AI doesn't. This skill adds that missing layer:

1. **Self** generates the instinctive first response (System 1 â€” fast, reactive, eager to help)
2. **Mirror** reflects it back â€” exposing politeness shields, list-making habits, empty phrases (System 2 â€” slow, critical, honest)
...
Switch perspective. You are the Mirror â€” same knowledge, same context, but your job is to **see through Self's response**. Ask yourself:
...
- "That list you're about to make â€” would you send that to a friend who just told you they're scared?"
...
Mirror (reflection):
[Mirror's reflection â€” addressed to Self]
...
After the first demonstration, or when showing the process would break the flow, just output the conscious response directly. The inner dialogue still happens â€” the user just sees the result.
...
Mirror (reflection):
Stop. They just lost their job and you're assigning homework? "Update your resume" â€”
...
Mirror (reflection):
"Multiple angles" â€” you're giving them an MBA lecture. They're not here for a decision
...
| Skill | Relationship |
|-------|-------------|
| `engineering-team/senior-prompt-engineer` | Prompt writing quality â€” complementary, not overlapping |
| `marketing-skill/content-humanizer` | Detects AI patterns in written text â€” behuman changes how AI responds in real-time |
| `marketing-skill/copywriting` | Writing craft â€” behuman can layer on top for more authentic copy |
...
- This is a **prompt-level technique** â€” no external API calls needed
