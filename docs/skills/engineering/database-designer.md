---
title: "Database Designer - POWERFUL Tier Skill â€” Agent Skill for Codex & OpenClaw"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/engineering/database-designer/SKILL.md">Source</a></span>
</div>
...
â†’ See references/database-design-reference.md for details
...
```
migrations/
â”œâ”€â”€ 20260101_000001_create_users.up.sql
â”œâ”€â”€ 20260101_000001_create_users.down.sql
â”œâ”€â”€ 20260115_000002_add_users_email_index.up.sql
â””â”€â”€ 20260115_000002_add_users_email_index.down.sql
```
...
1. **Expand** â€” add the new column/table (nullable, with default)
2. **Migrate data** â€” backfill in batches; dual-write from application
3. **Transition** â€” application reads from new column; stop writing to old
4. **Contract** â€” drop old column in a follow-up migration
...
- Keep rollback window short â€” if the contract step has run, rollback requires a new forward migration
...
- **Nested Loop** with high row estimates â€” consider hash/merge join or add index
- **Buffers shared read** much higher than **hit** â€” working set exceeds memory
...
**When to choose:**
- **PostgreSQL** â€” default choice for new projects; best extensibility and standards compliance
- **MySQL** â€” existing MySQL ecosystem; simple read-heavy web applications
- **SQLite** â€” mobile apps, CLI tools, unit test databases, IoT/edge
- **SQL Server** â€” mandated by enterprise policy; deep .NET/Azure integration
...
- **sql-database-assistant** â€” query writing, optimization, and debugging for day-to-day SQL work
- **database-schema-designer** â€” ERD modeling, normalization analysis, and schema generation
- **migration-architect** â€” large-scale migration planning across database engines or major schema overhauls
- **senior-backend** â€” application-layer patterns (connection pooling, ORM best practices)
- **senior-devops** â€” infrastructure provisioning for database clusters and replicas
