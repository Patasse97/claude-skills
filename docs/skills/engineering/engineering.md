---
title: "Engineering Advanced Skills (POWERFUL Tier) â€” Agent Skill for Codex & OpenClaw"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/engineering/SKILL.md">Source</a></span>
</div>
...
### Codex CLI
```bash
npx agent-skills-cli add Patasse97/claude-skills/engineering
```
