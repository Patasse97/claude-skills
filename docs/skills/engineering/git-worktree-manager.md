---
title: "Git Worktree Manager â€” Agent Skill for Codex & OpenClaw"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/engineering/git-worktree-manager/SKILL.md">Source</a></span>
</div>
...
See [docker-compose-patterns.md](https://github.com/Patasse97/claude-skills/tree/main/engineering/git-worktree-manager/references/docker-compose-patterns.md) for concrete templates.
...
See [port-allocation-strategy.md](https://github.com/Patasse97/claude-skills/tree/main/engineering/git-worktree-manager/references/port-allocation-strategy.md) for the full strategy and edge cases.
...
- [port-allocation-strategy.md](https://github.com/Patasse97/claude-skills/tree/main/engineering/git-worktree-manager/references/port-allocation-strategy.md)
- [docker-compose-patterns.md](https://github.com/Patasse97/claude-skills/tree/main/engineering/git-worktree-manager/references/docker-compose-patterns.md)
- [README.md](https://github.com/Patasse97/claude-skills/tree/main/engineering/git-worktree-manager/README.md) for quick start and installation details
