---
title: "LLM Cost Optimizer â€” Agent Skill for Codex & OpenClaw"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/engineering/llm-cost-optimizer/SKILL.md">Source</a></span>
</div>
...
| Setting a single global max_tokens | Some endpoints need 2000 tokens, others need 50 â€” a global cap either wastes or truncates | Set max_tokens per endpoint based on measured p95 output length |
...
| Treating cost optimization as a one-time project | Model pricing changes, traffic patterns shift, and new features launch â€” costs drift | Set up continuous cost monitoring with weekly spend reports and anomaly alerts |
