---
title: "Monorepo Navigator â€” Agent Skill for Codex & OpenClaw"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/engineering/monorepo-navigator/SKILL.md">Source</a></span>
</div>
...
- **Claude Code config** â€” workspace-aware CLAUDE.md with per-package instructions
...
| CLAUDE.md too generic â€” Claude modifies wrong package | Add explicit "When working on X, only touch files in apps/X" rules per package CLAUDE.md |

---

## Best Practices

1. **Root CLAUDE.md defines the map** â€” document every package, its purpose, and dependency rules
2. **Per-package CLAUDE.md defines the rules** â€” what's allowed, what's forbidden, testing commands
