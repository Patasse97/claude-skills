---
title: "Observability Designer (POWERFUL) â€” Agent Skill for Codex & OpenClaw"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/engineering/observability-designer/SKILL.md">Source</a></span>
</div>
...
- **Hierarchy:** Overview â†’ Service â†’ Component â†’ Instance drill-down paths
- **Golden Ratio:** 80% operational metrics, 20% exploratory metrics
- **Cognitive Load:** Maximum 7Â±2 panels per dashboard screen
