---
title: "Prompt Governance â€” Agent Skill for Codex & OpenClaw"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/engineering/prompt-governance/SKILL.md">Source</a></span>
</div>
...
| One person owns all prompt knowledge | Bus factor of 1 â€” when that person leaves, prompt context is lost | Document prompts in a registry with ownership, rationale, and version history |
