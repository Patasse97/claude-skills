---
title: "Release Manager â€” Agent Skill for Codex & OpenClaw"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/engineering/release-manager/SKILL.md">Source</a></span>
</div>
...
```python
# Alpha: 1.0.0-alpha.1 â†’ 1.0.0-alpha.2
# Beta: 1.0.0-alpha.5 â†’ 1.0.0-beta.1  
# RC: 1.0.0-beta.3 â†’ 1.0.0-rc.1
# Release: 1.0.0-rc.2 â†’ 1.0.0
```
...
#### Git Flow
```
main (production) â† release/1.2.0 â† develop â† feature/login
...
```
main â† feature/login (short-lived)
    â† feature/payment (short-lived)  
    â† hotfix/critical-fix
```
