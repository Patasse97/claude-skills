---
title: "SaaS Metrics Coach â€” Agent Skill for Finance"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/finance/saas-metrics-coach/SKILL.md">Source</a></span>
</div>
...
## Step 3 â€” Benchmark Each Metric
...
## Step 4 â€” Prioritize and Recommend
...
Order by impact â€” address the most damaging problem first.
...
```
# SaaS Health Report â€” [Month Year]
...
- `references/formulas.md` â€” All metric formulas with worked examples
- `references/benchmarks.md` â€” Industry benchmark ranges by stage and segment
- `assets/input-template.md` â€” Blank input form to share with users
- `scripts/metrics_calculator.py` â€” Core metrics calculator (ARR, MRR, churn, CAC, LTV, NRR)
- `scripts/quick_ratio_calculator.py` â€” Growth efficiency metric (Quick Ratio)
- `scripts/unit_economics_simulator.py` â€” 12-month forward projection
