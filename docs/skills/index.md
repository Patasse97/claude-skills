---
title: "204 Agent Skills â€” Browse by Domain"
description: "Browse 204 agent skills across 9 domains â€” engineering, product, marketing, C-level advisory, PM, regulatory, business growth, and finance. Claude Code plugins, Codex skills, and Gemini CLI skills."
hide:
  - edit
---
...
[GitHub :fontawesome-brands-github:](https://github.com/Patasse97/claude-skills){ .md-button }

---

## Architecture

Every skill follows the same self-contained package pattern â€” no cross-dependencies, no external APIs, no setup required:
...
-   :material-cog:{ .lg .middle } **Engineering â€” Core** <span class="skill-count">24</span>
...
-   :material-lightning-bolt:{ .lg .middle } **Engineering â€” POWERFUL** <span class="skill-count">25</span>
...
-   :material-bullhorn:{ .lg .middle } **Marketing** <span class="skill-count">43</span>
    ...
    Complete marketing division across 7 specialist pods â€” content, SEO, CRO, channels, growth hacking, intelligence, and sales enablement. Plus X/Twitter growth tools.
...
=== ":material-star-circle: C-Level"
    ...
    **28 skills** â€” 10 executive roles plus orchestration and strategic tools.
...
!!! tip "All tools are stdlib-only"
    Every Python script uses only the standard library â€” zero `pip install` required. All 250 tools are verified passing `--help`. Scripts support both human-readable and `--json` output for automation.
...
-   :material-numeric-2-circle:{ .lg .middle } **Trigger**
    ...
    Skills activate automatically when your prompt matches their domain â€” or invoke directly.
...
-   :material-numeric-4-circle:{ .lg .middle } **Output**
    ...
    Get structured, actionable results â€” reports, code, configurations, strategies, or documentation.
