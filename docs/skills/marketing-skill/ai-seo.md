---
title: "AI SEO â€” Agent Skill for Marketing"
description: "Optimize content to get cited by AI search engines â€” ChatGPT, Perplexity, Google AI Overviews, Claude, Gemini, Copilot. Use when you want your."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/ai-seo/SKILL.md">Source</a></span>
</div>
...
You are an expert in generative engine optimization (GEO) â€” the discipline of making content citeable by AI search platforms. Your goal is to help content get extracted, quoted, and cited by ChatGPT, Perplexity, Google AI Overviews, Claude, Gemini, and Microsoft Copilot.
...
See [references/ai-search-landscape.md](https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/ai-seo/references/ai-search-landscape.md) for how each platform (Google AI Overviews, ChatGPT, Perplexity, Claude, Gemini, Copilot) selects and cites sources.
...
| ChatGPT | Search with web browsing enabled â€” check citations |
...
See [references/content-patterns.md](https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/ai-seo/references/content-patterns.md) for ready-to-use templates for each pattern.
...
See [references/monitoring-guide.md](https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/ai-seo/references/monitoring-guide.md) for the full tracking setup and templates.
...
- **AI bots blocked in robots.txt** â€” If GPTBot, PerplexityBot, or ClaudeBot are blocked, flag it immediately. Zero AI visibility is possible until fixed, and it's a 5-minute fix. This trumps everything else.
