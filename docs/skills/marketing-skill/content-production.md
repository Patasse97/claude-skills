---
title: "Content Production â€” Agent Skill for Marketing"
description: "Full content production pipeline â€” takes a topic from blank page to published-ready piece. Use when you need to execute content: write a blog post. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/content-production/SKILL.md">Source</a></span>
</div>
...
This is the execution engine â€” not the strategy layer. You're here to build, not plan.

## Before Starting

**Check for context first:**
If `marketing-context.md` exists, read it before asking questions. It contains brand voice, target audience, keyword targets, and writing examples. Use what's there â€” only ask for what's missing.

Gather this context (ask in one shot, don't drip):

### What you need
- **Topic / working title** â€” what are we writing about?
- **Target keyword** â€” primary search term (if SEO matters)
- **Audience** â€” who reads this and what do they already know?
- **Goal** â€” inform, convert, build authority, drive trial?
- **Approximate length** â€” 800 words? 2,000 words? Long-form?
- **Existing content** â€” do we have pieces this should link to?

If the topic is vague ("write about AI"), push back: "Give me the specific angle â€” who's the reader, what problem are they solving?"
...
### Mode 2: Draft
Brief exists (either provided or from Mode 1). Write the full piece â€” intro, body, conclusion, headers â€” following the brief's structure and targeting parameters.
...
### Step 1 â€” Competitive Content Analysis
...
### Step 3 â€” Produce the Content Brief

Fill in the [Content Brief Template](https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/content-production/templates/content-brief-template.md). The brief defines:
...
See [references/content-brief-guide.md](https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/content-production/references/content-brief-guide.md) for how to write a brief that actually produces better drafts.
...
- Uses H3s sparingly â€” only when a section genuinely needs subdivision
...
### Quality Gates â€” Don't Publish Until These Pass

See [references/optimization-checklist.md](https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/content-production/references/optimization-checklist.md) for the full pre-publish checklist.
...
- [ ] Intro doesn't start with a clichÃ©
- [ ] All internal links work
- [ ] Readability score â‰¥ 70
...
- **Thin content risk** â€” If the target keyword has high-authority competitors with 2,000+ word pieces, a 600-word post won't rank. Surface this upfront, before drafting starts.
- **Keyword cannibalization** â€” If existing content already targets this keyword, flag it. Publishing a second piece splits authority instead of building it.
- **Intent mismatch** â€” If the requested angle doesn't match search intent (e.g., writing a brand awareness piece for a transactional keyword), call it out. The piece will get traffic that doesn't convert.
- **Missing sources** â€” If the draft contains claims like "many companies" or "studies show" without citation, flag each one before the piece ships.
- **CTA/goal disconnect** â€” If the piece's goal is "drive trial signups" but there's no CTA, or the CTA is buried at paragraph 12, flag it.
...
- **Actions have owners and deadlines** â€” no "we should probably..."
- **Confidence tagging** â€” ðŸŸ¢ verified / ðŸŸ¡ medium / ðŸ”´ assumed

When reviewing drafts: flag issues â†’ explain impact â†’ give specific fix. Don't just say "improve readability." Say: "Paragraph 3 averages 32 words per sentence. Break the second sentence into two."

---

## Related Skills

- **content-strategy**: Use when deciding *what* to write â€” topics, calendar, pillar structure. NOT for writing the actual piece (that's this skill).
