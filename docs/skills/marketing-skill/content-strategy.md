---
title: "Content Strategy â€” Agent Skill for Marketing"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/content-strategy/SKILL.md">Source</a></span>
</div>
...
â†’ See references/content-strategy-reference.md for details
...
- **No content plan exists** â†’ Immediately propose a 3-pillar starter strategy with 10 seed topics before asking more questions.
- **User has content but low traffic** â†’ Flag the searchable vs. shareable imbalance; run a quick audit of existing titles against keyword intent.
- **User is writing content without a keyword target** â†’ Warn that effort may be wasted; offer to identify the right keyword before they start writing.
- **Content covers too many audiences** â†’ Flag ICP dilution; recommend splitting pillars by persona or use-case.
- **Competitor content clearly outranks them on core topics** â†’ Trigger a gap analysis and surface quick-win opportunities where competition is lower.
...
- **Bottom line first** â€” recommendation before rationale
- **What + Why + How** â€” every strategy has all three
- **Actions have owners and deadlines** â€” no "you might consider"
- **Confidence tagging** â€” ðŸŸ¢ high confidence / ðŸŸ¡ medium / ðŸ”´ assumption

Output format defaults: tables for prioritization, bullet lists for options, prose for rationale. Match depth to request â€” a quick question gets a quick answer, not a strategy doc.

---

## Related Skills

- **marketing-context**: USE as the foundation before any strategy work â€” reads product, audience, and brand context. NOT a substitute for this skill.
