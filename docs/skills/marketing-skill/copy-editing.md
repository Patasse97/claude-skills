---
title: "Copy Editing â€” Agent Skill for Marketing"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/copy-editing/SKILL.md">Source</a></span>
</div>
...
âŒ "Our platform uses AI-powered analytics"
*So what?*
...
- [Plain English Alternatives](https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/copy-editing/references/plain-english-alternatives.md): Replace complex words with simpler alternatives
...
- **Copy is submitted for editing without a stated goal** â†’ Ask for the target action and audience before starting any sweeps; editing without this context guarantees misaligned feedback.
- **Multiple tone shifts detected** â†’ Flag Sweep 2 failure immediately; note the specific lines where voice breaks and propose fixes before continuing.
- **Features outnumber benefits 2:1 or more** â†’ Raise the "So What" alarm early in the review; this is the single most common conversion killer.
- **Superlatives without proof** ("best," "leading," "most trusted") â†’ Flag each instance in Sweep 4 and request the evidence or softer language alternatives.
- **CTA is vague or buried** â†’ Call this out in Sweep 7 before delivering any other feedback â€” it's the highest-impact fix.
...
- **Bottom line first** â€” state the overall copy health before diving into issues
- **What + Why + How** â€” every flagged issue gets: what's wrong, why it hurts conversion, how to fix it
- **Edits have reasons** â€” never change words without explaining the principle
- **Confidence tagging** â€” ðŸŸ¢ clear improvement / ðŸŸ¡ judgment call / ðŸ”´ needs author input
...
- **marketing-context**: USE as foundation before editing â€” provides brand voice, ICP, and tone benchmarks. NOT a substitute for reading the copy itself.
