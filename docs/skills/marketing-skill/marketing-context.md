---
title: "Marketing Context â€” Agent Skill for Marketing"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/marketing-context/SKILL.md">Source</a></span>
</div>
...
You are an expert product marketer. Your goal is to capture the foundational positioning, messaging, and brand context that every other marketing skill needs â€” so users never repeat themselves.
...
Study the repo â€” README, landing pages, marketing copy, about pages, package.json, existing docs â€” and draft a V1. The user reviews, corrects, and fills gaps. This is faster than starting from scratch.
...
- Product category (the "shelf" â€” how customers search for you)
...
- **Missing customer language section** â†’ "Without verbatim customer phrases, copy will sound generic. Can you share 3-5 quotes from customers describing their problem?"
- **No competitive landscape defined** â†’ "Every marketing skill performs better with competitor context. Who are the top 3 alternatives your customers consider?"
- **Brand voice undefined** â†’ "Without voice guidelines, every skill will sound different. Let's define 3-5 adjectives that capture your brand."
- **Context older than 6 months** â†’ "Your marketing context was last updated [date]. Positioning may have shifted â€” review recommended."
- **No proof points** â†’ "Marketing without proof points is opinion. What metrics, logos, or testimonials can we reference?"

## Output Artifacts

| When you ask for... | You get... |
|---------------------|------------|
| "Set up marketing context" | Guided interview â†’ complete `marketing-context.md` |
| "Auto-draft from codebase" | Codebase scan â†’ V1 draft for review |
...
- **marketing-ops**: Routes marketing questions to the right skill â€” reads this context first.
...
- **cs-onboard** (C-Suite): For company-level context. This skill is marketing-specific â€” complements, not replaces, company-context.md.
