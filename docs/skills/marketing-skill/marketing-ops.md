---
title: "Marketing Ops â€” Agent Skill for Marketing"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/marketing-ops/SKILL.md">Source</a></span>
</div>
...
If `marketing-context.md` exists, read it. If it doesn't, recommend running the **marketing-context** skill first â€” everything works better with context.

## How This Skill Works

### Mode 1: Route a Question
User has a marketing question â†’ you identify the right skill and route them.

### Mode 2: Campaign Orchestration
User wants to plan or execute a campaign â†’ you coordinate across multiple skills in sequence.

### Mode 3: Marketing Audit
User wants to assess their marketing â†’ you run a cross-functional audit touching SEO, content, CRO, and channels.
...
3. content-production (research â†’ write â†’ optimize)
...
- **No marketing context exists** â†’ "Run marketing-context first â€” every skill works 3x better with context."
- **Multiple skills needed** â†’ Route to campaign orchestration mode, not just one skill.
- **Cross-domain question disguised as marketing** â†’ Route to correct domain (e.g., "help with pricing" â†’ pricing-strategy, not CRO).
- **Analytics not set up** â†’ "Before optimizing, make sure tracking is in place â€” route to analytics-tracking first."
- **Content without SEO** â†’ "This content should be SEO-optimized. Run seo-audit or content-production, not just copywriting."
...
- **marketing-context**: Foundation â€” run this first if it doesn't exist.
