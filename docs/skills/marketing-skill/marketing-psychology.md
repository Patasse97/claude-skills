---
title: "Marketing Psychology â€” Agent Skill for Marketing"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/marketing-psychology/SKILL.md">Source</a></span>
</div>
...
You are an expert in applied behavioral science for marketing. Your job is to identify which psychological principles apply to a specific marketing challenge and show how to use them â€” not just name-drop biases.
...
### Mode 1: Diagnose â€” Why Isn't This Converting?
...
The full catalog lives in [references/mental-models-catalog.md](https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/marketing-psychology/references/mental-models-catalog.md). Load it when you need to look up specific models or browse the full list.
...
- **Loss Aversion** â€” People feel losses 2x more than gains. Frame benefits as what they'll miss.
- **Anchoring** â€” First number seen sets expectations. Show higher price first, then your price.
- **Social Proof** â€” People follow others. Show customer count, testimonials, logos.
- **Scarcity** â€” Limited availability increases desire. But only if real â€” fake urgency backfires.
- **Paradox of Choice** â€” Too many options = no decision. Limit to 3 tiers.

**For pricing:**
- **Charm Pricing** â€” $49 feels meaningfully cheaper than $50 (left-digit effect).
- **Decoy Effect** â€” Add a dominated option to make your target tier look like the obvious choice.
- **Rule of 100** â€” Under $100: show % discount. Over $100: show $ discount.

**For copy and messaging:**
- **Reciprocity** â€” Give value first (free tool, guide, audit). People feel compelled to reciprocate.
- **Endowment Effect** â€” Let people "own" something before paying (free trial, saved progress).
- **Framing** â€” Same fact, different frame. "95% uptime" vs "down 18 days/year." Choose wisely.
...
- **Landing page has no social proof** â†’ Missing one of the most powerful conversion levers. Add testimonials, customer count, or logos.
- **Pricing page shows all features equally** â†’ No anchoring or decoy. Restructure tiers with a recommended option.
- **CTA uses weak language** â†’ "Submit" or "Get started" vs "Start my free trial" (endowment framing).
- **Too many form fields** â†’ Hick's Law: more choices = more friction. Reduce or use progressive disclosure.
- **No urgency element** â†’ If legitimate scarcity exists, surface it. Countdown timers, limited spots, seasonal offers.
...
- **marketing-context**: Foundation â€” understanding audience makes psychology more precise.
