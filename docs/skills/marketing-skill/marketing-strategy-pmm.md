---
title: "Marketing Strategy & PMM â€” Agent Skill for Marketing"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/marketing-strategy-pmm/SKILL.md">Source</a></span>
</div>
...
| Features | Supporting evidence | AI automation â†’ 10 hrs/week saved |
...
- **No documented positioning** â†’ Without clear positioning, all marketing is guesswork.
- **Messaging differs across channels** â†’ Inconsistent story confuses buyers.
- **No ICP defined** â†’ Selling to everyone means selling to no one.
- **Competitor repositioning** â†’ Market shift detected. Review your positioning.
