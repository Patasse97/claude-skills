---
title: "Pricing Strategy â€” Agent Skill for Marketing"
description: "Design, optimize, and communicate SaaS pricing â€” tier structure, value metrics, pricing pages, and price increase strategy. Use when building a. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/pricing-strategy/SKILL.md">Source</a></span>
</div>
...
Prices need to go up â€” because of inflation, value improvements, or market repositioning. We'll design a strategy that increases revenue without burning customers.
...
```
         ...
         â”‚   PACKAGING     â”‚  What's in each tier?
         â”‚  (what you get) â”‚
         â””â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”˜
                  â”‚
         â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”´â”€â”€â”€â”€â”€â”€â”€â”€â”
         â”‚  VALUE METRIC   â”‚  What do you charge for?
         â”‚ (how it scales) â”‚
         â””â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”˜
                  â”‚
         â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”´â”€â”€â”€â”€â”€â”€â”€â”€â”
         â”‚  PRICE POINT    â”‚  How much?
         â”‚    (the number) â”‚
         â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜
```
...
1. **What makes a customer willing to pay more?** â†’ That's your value metric
2. **Does the metric scale with their success?** â†’ If they grow, you grow
3. **Is it easy to understand?** â†’ Complexity kills conversion
4. **Is it hard to game?** â†’ Customers shouldn't be able to work around it

**Red flags:**
- "Per seat" in a tool where one power user does all the work â†’ seats don't scale with value
- "Flat fee" when some customers derive 10x the value of others â†’ you're subsidizing heavy users
- "Per API call" when call count varies wildly week to week â†’ unpredictable bills = churn

---

## Good-Better-Best Tier Structure

Three tiers is the standard. Not because of tradition â€” because it anchors perception.

### Tier Design Principles

**Entry tier (Good):**
- Captures the segment that will churn if priced higher
- Limited â€” either by features, usage, or support
- NOT free. Free is a separate strategy (freemium), not a tier.
- Should cover your costs at minimum

**Middle tier (Better) â€” your default:**
...
|----------------|-------|--------|------|
| Core product | âœ… (limited) | âœ… (full) | âœ… (full) |
...
| Admin features | â€” | â€” | SSO, audit log, SCIM |
| SLA | â€” | â€” | âœ… |

See [references/pricing-models.md](https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/pricing-strategy/references/pricing-models.md) for model deep dives and SaaS examples.
...
- Time saved Ã— hourly rate of the person using it
...
- Don't price at 50% of value â€” customers feel they're overpaying
- Don't price below the next-best alternative â€” signals you don't believe in your own product

**Conversion rate as a signal:**
- >40% trial-to-paid: likely underpriced â€” test a price increase
...
2. At what price would this product be a bargain â€” great deal?
3. At what price would this product start to feel expensive â€” still acceptable?
...
**When to use:** B2B SaaS, nâ‰¥30 respondents, existing customers or qualified prospects.

### MaxDiff Analysis

Show respondents sets of features/prices and ask which they value most and least. Statistical analysis reveals relative value of each feature â€” informs packaging more than price point.
...
**Don't just copy competitor prices** â€” their pricing reflects their cost structure and positioning, not yours.
...
|---------|---------|------|
| **New customers only** | Significant pushback expected | Low â€” doesn't touch existing base |
| **Grandfather + delayed** | Loyal customer base, contract risk | Medium â€” existing customers feel respected |
| **Tied to value delivery** | Clear new features/improvement | Low â€” justifiable |
| **Plan restructure** | Significant packaging change | Medium â€” complexity for customers |
...
4. **Communicate the reason:** New features, rising costs, investment in [X] â€” be specific
...
- Price with billing toggle (monthly/annual â€” annual should show savings)
...
- **Full feature comparison table** â€” comprehensive, scannable, uses âœ… and âŒ not walls of text
- **FAQ section** â€” address the 5 objections that stop people from buying:
  - "Can I cancel anytime?"
  - "What happens when I hit limits?"
  - "Do you offer refunds?"
  - "Is my data secure?"
  - "What if I need to upgrade/downgrade?"
- **Social proof** â€” logos, quotes, or case studies relevant to each tier
- **Security badges** if B2B enterprise (SOC2, ISO 27001, GDPR)

### Annual vs. Monthly Toggle

- Show annual pricing by default (or highlight it) â€” it improves LTV
- Show savings explicitly: "Save 20%" or "2 months free"
- Don't hide the monthly price â€” hiding it builds distrust

See [references/pricing-page-playbook.md](https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/pricing-strategy/references/pricing-page-playbook.md) for design specs and copy templates.
...
- **Conversion rate >40% trial-to-paid** â†’ Strong signal of underpricing. Flag: test 20-30% price increase.
- **All customers on the middle tier** â†’ No upsell path. Flag: enterprise tier needed or feature lock-in missing.
- **Customer asked for features that aren't in their tier** â†’ Expansion revenue being left on the table. Flag: feature gatekeeping review.
- **Churn rate >5% monthly** â†’ Before raising prices, fix churn. Price increases accelerate churners.
- **Price hasn't changed in 2+ years** â†’ Inflation alone justifies 10-15% increase. Flag for strategic review.
- **Only one pricing option** â†’ No anchoring, no upsell. Flag: add a third tier even if rarely purchased.
...
- **Bottom line first** â€” recommendation before justification
- **What + Why + How** â€” every recommendation has all three
- **Actions have owners and deadlines** â€” no vague "consider"
- **Confidence tagging** â€” ðŸŸ¢ verified benchmark / ðŸŸ¡ estimated / ðŸ”´ assumed
...
- **churn-prevention**: Use when churn is the underlying issue â€” fix retention before raising prices.
