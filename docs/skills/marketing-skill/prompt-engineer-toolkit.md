---
title: "Prompt Engineer Toolkit â€” Agent Skill for Marketing"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/prompt-engineer-toolkit/SKILL.md">Source</a></span>
</div>
...
1. Picking prompts from single-case outputs â€” use a realistic, edge-case-rich test suite.
2. Changing prompt and model simultaneously â€” always isolate variables.
...
6. Optimizing one benchmark while harming edge cases â€” track the full suite.
...
- [references/prompt-templates.md](https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/prompt-engineer-toolkit/references/prompt-templates.md)
- [references/technique-guide.md](https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/prompt-engineer-toolkit/references/technique-guide.md)
- [references/evaluation-rubric.md](https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/prompt-engineer-toolkit/references/evaluation-rubric.md)
- [README.md](https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/prompt-engineer-toolkit/README.md)
