---
title: "Social Media Analyzer â€” Agent Skill for Marketing"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/social-media-analyzer/SKILL.md">Source</a></span>
</div>
...
| Reach Rate | Reach / Followers Ã— 100 | Content distribution |
| Virality Rate | Shares / Impressions Ã— 100 | Share-worthiness |
| Save Rate | Saves / Reach Ã— 100 | Content value |
...
6. **Validation:** ROI = (Value - Spend) / Spend Ã— 100
...
| Cost Per Thousand (CPM) | (Spend / Impressions) Ã— 1000 |
...
- **Engagement rate below platform average** â†’ Content isn't resonating. Analyze top performers for patterns.
- **Follower growth stalled** â†’ Content distribution or frequency issue. Audit posting patterns.
- **High impressions, low engagement** â†’ Reach without resonance. Content quality issue.
- **Competitor outperforming significantly** â†’ Content gap. Analyze their successful posts.
