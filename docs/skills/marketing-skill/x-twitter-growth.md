---
title: "X/Twitter Growth Engine â€” Agent Skill for Marketing"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/marketing-skill/x-twitter-growth/SKILL.md">Source</a></span>
</div>
...
- [ ] Specific niche â€” not "entrepreneur | thinker | builder"
...
## Step 2 â€” Competitive Intelligence
...
### What to Extract
- **Hook patterns** â€” How do top posts start? Question? Bold claim? Statistic?
- **Content themes** â€” What 3-5 topics get the most engagement?
- **Format mix** â€” Ratio of tweets vs threads vs replies vs quotes
- **Posting times** â€” When do their best posts go out?
- **Engagement triggers** â€” What makes people reply vs like vs retweet?

---

## Step 3 â€” Content Creation
...
```
Structure:
- Tweet 1: Hook â€” must stop the scroll in <7 words
...
- Number the tweets or use "â†“" in tweet 1
```
...
- One idea per tweet
- No links in tweet body (kills reach â€” put link in reply)
...
- Your reply IS your content â€” make it tweet-worthy
...
| Link clicks | Low (penalized) | Never put links in tweet body â€” use reply |
...
## Step 6 â€” Content Calendar Generation
...
1. **Posting links directly** â€” Always put links in the first reply, never in the tweet body
2. **Thread tweet 1 is weak** â€” If the hook doesn't stop scrolling, nothing else matters
3. **Inconsistent posting** â€” Algorithm rewards daily consistency over occasional bangers
4. **Only broadcasting** â€” Replies and engagement are 50%+ of growth, not just posting
5. **Generic bio** â€” "Helping people do things" tells nobody anything
6. **Copying formats without adapting** â€” What works for tech Twitter doesn't work for marketing Twitter

## Related Skills

- `social-content` â€” Multi-platform content creation
- `social-media-manager` â€” Overall social strategy
- `social-media-analyzer` â€” Cross-platform analytics
- `content-production` â€” Long-form content that feeds X threads
- `copywriting` â€” Headline and hook writing techniques
