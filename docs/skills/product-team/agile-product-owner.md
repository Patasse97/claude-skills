---
title: "Agile Product Owner â€” Agent Skill for Product Teams"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/product-team/agile-product-owner/SKILL.md">Source</a></span>
</div>
...
5. Validate each story is â‰¤8 points
...
|-----------|-------------|---------|
| By workflow step | Linear process | "Checkout" â†’ "Add to cart" + "Enter payment" + "Confirm order" |
| By persona | Multiple user types | "Dashboard" â†’ "Admin dashboard" + "User dashboard" |
| By data type | Multiple inputs | "Import" â†’ "Import CSV" + "Import Excel" |
| By operation | CRUD functionality | "Manage users" â†’ "Create" + "Edit" + "Delete" |
| Happy path first | Risk reduction | "Feature" â†’ "Basic flow" + "Error handling" + "Edge cases" |
...
â”œâ”€â”€ US-001: View key metrics (5 pts) - End User
â”œâ”€â”€ US-002: Customize layout (5 pts) - Power User
â”œâ”€â”€ US-003: Export data to CSV (3 pts) - End User
â”œâ”€â”€ US-004: Share with team (5 pts) - End User
â”œâ”€â”€ US-005: Set up alerts (5 pts) - Power User
â”œâ”€â”€ US-006: Filter by date range (3 pts) - End User
â”œâ”€â”€ US-007: Admin overview (5 pts) - Admin
â””â”€â”€ US-008: Enable caching (3 pts) - Enabler
```
...
8. **Validation:** Committed points â‰¤85% capacity; all stories have acceptance criteria

### Capacity Calculation

```
Sprint Capacity = Average Velocity Ã— Availability Factor
...
| **S**mall | Can this complete in one sprint? | â‰¤8 story points |
...
|--------|---------|--------|
| Velocity | Points completed / sprint | Stable Â±10% |
...
- **Scrum Master** (`project-management/scrum-master/`) â€” Velocity data and sprint ceremonies complement backlog management
- **Product Manager Toolkit** (`product-team/product-manager-toolkit/`) â€” RICE prioritization feeds backlog ordering
