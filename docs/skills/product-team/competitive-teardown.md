---
title: "Competitive Teardown â€” Agent Skill for Product Teams"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/product-team/competitive-teardown/SKILL.md">Source</a></span>
</div>
...
1. **Define competitors** â€” List 2â€“4 competitors to analyze. Confirm which is the primary focus.
2. **Collect data** â€” Use `references/data-collection-guide.md` to gather raw signals from at least 3 sources per competitor (website, reviews, job postings, SEO, social).  
...
3. **Score using rubric** â€” Apply the 12-dimension rubric below to produce a numeric scorecard for each competitor and your own product.  
   _Validation checkpoint: Every dimension should have a score and at least one supporting evidence note._
4. **Generate outputs** â€” Populate the templates in `references/analysis-templates.md` (Feature Matrix, Pricing Analysis, SWOT, Positioning Map, UX Audit).
5. **Build action plan** â€” Translate findings into the Action Items template (quick wins / medium-term / strategic).
6. **Package for stakeholders** â€” Assemble the Stakeholder Presentation using outputs from steps 3â€“5.
...
- **Praise** â†’ what users love (defend / strengthen these)
- **Feature requests** â†’ unmet needs (opportunity gaps)
- **Bugs** â†’ quality signals
- **UX complaints** â†’ friction points you can beat them on
...
- **Engineering volume** â†’ scaling vs. consolidating
- **Specific tech mentions** â†’ stack (React/Vue, Postgres/Mongo, AWS/GCP)
- **Sales/CS ratio** â†’ product-led vs. sales-led motion
- **Data/ML roles** â†’ upcoming AI features
- **Compliance roles** â†’ regulatory expansion
...
**Example completed row** (Competitor: Acme Corp, Dimension 3 â€“ UX):
...
Score each cell 1â€“5. Sum to get total out of 60.  
...
Summarize: price leader, value leader, premium positioning, your position, and 2â€“3 pricing opportunity bullets.

### SWOT Analysis

For each competitor: 3â€“5 bullets per quadrant (Strengths, Weaknesses, Opportunities for us, Threats to us). Anchor every bullet to a data signal (review quote, job posting count, pricing page, etc.).

### Positioning Map

2x2 axes (e.g., Simple â†” Complex / Low Value â†” High Value). Place each competitor and your product. Bubble size = market share or funding. See `references/analysis-templates.md` for ASCII and editable versions.
...
|---------|--------|---------|
| Quick wins (0â€“4 wks) | Low | Add review badges, publish comparison landing page |
| Medium-term (1â€“3 mo) | Moderate | Launch free tier, improve onboarding TTFV, add top-requested integration |
| Strategic (3â€“12 mo) | High | Enter new market, build API v2, achieve SOC2 Type II |

### Stakeholder Presentation (7 slides)

1. **Executive Summary** â€” Threat level (LOW/MEDIUM/HIGH/CRITICAL), top strength, top opportunity, recommended action
2. **Market Position** â€” 2x2 positioning map
3. **Feature Scorecard** â€” 12-dimension radar or table, total scores
4. **Pricing Analysis** â€” Comparison table + key insight
5. **UX Highlights** â€” What they do better (3 bullets) vs. where we win (3 bullets)
6. **Voice of Customer** â€” Top 3 review complaints (quoted or paraphrased)
7. **Our Action Plan** â€” Quick wins, medium-term, strategic priorities; Appendix with raw data

## Related Skills

- **Product Strategist** (`product-team/product-strategist/`) â€” Competitive insights feed OKR and strategy planning
- **Landing Page Generator** (`product-team/landing-page-generator/`) â€” Competitive positioning informs landing page messaging
