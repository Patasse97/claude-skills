---
title: "Product Skills â€” Agent Skills & Codex Plugins"
description: "16 product skills â€” product management agent skill and Claude Code plugin for PRDs, discovery, analytics, and roadmaps. Works with Claude Code, Codex CLI, Gemini CLI, and OpenClaw."
---
...
-   **[Code â†’ PRD: Reverse-Engineer Any Codebase into Product Requirements](code-to-prd.md)**
...
-   **[Spec to Repo](spec-to-repo.md)**
    ...
    Turn a natural-language project specification into a complete, runnable starter repository. Not a template filler â€” a...
