---
title: "Product Team Skills â€” Agent Skill for Product Teams"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/product-team/SKILL.md">Source</a></span>
</div>
...
### Codex CLI
```bash
npx agent-skills-cli add Patasse97/claude-skills/product-team
```
