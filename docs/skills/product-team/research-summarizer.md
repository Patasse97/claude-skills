---
title: "Research Summarizer â€” Agent Skill for Product Teams"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/product-team/research-summarizer/SKILL.md">Source</a></span>
</div>
...
### `/research:summarize` â€” Single Source Summary
...
### `/research:compare` â€” Multi-Source Comparison
...
### `/research:cite` â€” Citation Extraction
