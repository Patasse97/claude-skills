---
title: "UX Researcher & Designer â€” Agent Skill for Product Teams"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/product-team/ux-researcher-designer/SKILL.md">Source</a></span>
</div>
...
3. **Map the stages**
   ...
   ```
   Awareness â†’ Evaluation â†’ Onboarding â†’ Adoption â†’ Advocacy
   ```
...
4. **Fill in layers for each stage**
   ...
   ```
   Stage: [Name]
   â”œâ”€â”€ Actions: What does user do?
   â”œâ”€â”€ Touchpoints: Where do they interact?
   â”œâ”€â”€ Emotions: How do they feel? (1-5)
   â”œâ”€â”€ Pain Points: What frustrates them?
   â””â”€â”€ Opportunities: Where can we improve?
   ```

5. **Identify opportunities**

   Priority Score = Frequency Ã— Severity Ã— Solvability
...
3. **Design tasks**
   ...
   Task progression: Warm-up â†’ Core â†’ Secondary â†’ Edge case â†’ Free exploration
...
ðŸ˜¤ Frustrations:
  â€¢ Slow loading times (14/20 users)
  â€¢ No keyboard shortcuts
  â€¢ Limited API access
...
- **UI Design System** (`product-team/ui-design-system/`) â€” Research findings inform design system decisions
- **Product Manager Toolkit** (`product-team/product-manager-toolkit/`) â€” Customer interview analysis complements persona research
