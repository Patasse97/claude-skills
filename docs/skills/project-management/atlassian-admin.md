---
title: "Atlassian Administrator Expert â€” Agent Skill for PM"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/project-management/atlassian-admin/SKILL.md">Source</a></span>
</div>
...
### Integration Setup
**Common Integrations**:
- **Slack**: `Jira Settings > Apps > Slack integration` â€” notifications for Jira and Confluence
- **GitHub/Bitbucket**: `Jira Settings > Apps > DVCS accounts` â€” link commits to issues
...
- Limit org admins to 2â€“3 individuals; audit admin actions monthly
- Require MFA for all admins: `Security > Authentication policies > Require 2FA`

### Naming Conventions
**Jira**: Project keys 3â€“4 uppercase letters (PROJ, WEB); issue types Title Case; custom fields prefixed (CF: Story Points)
...
### Incident Response
**Severity Levels**:
- **P1 (Critical)**: System down â€” respond in 15 min
- **P2 (High)**: Major feature broken â€” respond in 1 hour
- **P3 (Medium)**: Minor issue â€” respond in 4 hours
- **P4 (Low)**: Enhancement â€” respond in 24 hours
