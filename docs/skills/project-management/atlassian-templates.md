---
title: "Atlassian Template & Files Creator Expert â€” Agent Skill for PM"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/project-management/atlassian-templates/SKILL.md">Source</a></span>
</div>
...
5. **Test**: Validate with sample data â€” confirm template renders correctly in preview before publishing
...
h2. Action Items
{tasks}
* [ ] [Action item] â€” Owner: @[name] â€” Due: {date}
* [ ] [Action item] â€” Owner: @[name] â€” Due: {date}
{tasks}
...
```json
{
  ...
  "parameters": {
    ...
    "version_comment": "v2 â€” added status macro to header"
  }
}
```
