---
title: "Atlassian Confluence Expert â€” Agent Skill for PM"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/project-management/confluence-expert/SKILL.md">Source</a></span>
</div>
...
- **Jira Expert** (`project-management/jira-expert/`) â€” Jira issue macros and linking complement Confluence docs
- **Atlassian Templates** (`project-management/atlassian-templates/`) â€” Template patterns for Confluence content creation
