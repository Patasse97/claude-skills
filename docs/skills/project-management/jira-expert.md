---
title: "Atlassian Jira Expert â€” Agent Skill for PM"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/project-management/jira-expert/SKILL.md">Source</a></span>
</div>
...
## Quick Start â€” Most Common Operations
...
### Workflow Design
1. Map out process states (To Do â†’ In Progress â†’ Done)
...
4. **Validate**: Preview all changes before executing; confirm the JQL filter matches only intended issues â€” bulk edits are difficult to reverse
...
- **Confluence Expert** (`project-management/confluence-expert/`) â€” Documentation complements Jira workflows
- **Atlassian Admin** (`project-management/atlassian-admin/`) â€” Permission and user management for Jira projects
