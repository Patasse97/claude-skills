---
title: "Project Management Skills â€” Agent Skill for PM"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/project-management/SKILL.md">Source</a></span>
</div>
...
### Codex CLI
```bash
npx agent-skills-cli add Patasse97/claude-skills/project-management
```
