---
title: "Internal Comms â€” Agent Skill for PM"
description: "Write internal company communications â€” 3P updates (Progress/Plans/Problems), company-wide newsletters, FAQ roundups, incident reports, leadership. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/project-management/team-communications/SKILL.md">Source</a></span>
</div>
...
If the type is ambiguous, ask one clarifying question â€” don't guess.
...
- Use "we" â€” you are part of the company.
...
- Professional but approachable â€” not corporate-speak.
- Put the most important information first.

## When tools are unavailable

If the user hasn't connected Slack, Gmail, Drive, or Calendar, don't stall. Ask them to paste or describe what they want covered. You're formatting and sharpening â€” that's still valuable. Mention which tools would improve future drafts so they can connect them later.
...
|---|---|---|
| Writing updates without reading the reference template first | Output won't match company format â€” user has to reformat | Always load the matching reference file before drafting |
| Inventing metrics or accomplishments | Internal comms must be factual â€” fabrication destroys trust | Only include data the user provided or MCP tools retrieved |
| Using passive voice for accomplishments | "The feature was shipped" hides who did the work | "Team X shipped the feature" â€” active voice credits the team |
| Writing walls of text for status updates | Leadership scans, doesn't read â€” key info gets buried | Lead with the headline, follow with 3-5 bullet points |
...
| Skill | Relationship |
|-------|-------------|
| `project-management/senior-pm` | Broader PM scope â€” status reports feed into PM reporting |
...
| `marketing-skill/content-production` | External comms â€” use for public-facing content, not internal |
