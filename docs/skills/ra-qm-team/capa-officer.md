---
title: "CAPA Officer â€” Agent Skill for Compliance"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/ra-qm-team/capa-officer/SKILL.md">Source</a></span>
</div>
...
â””â”€â”€ No â†’ Is human error the suspected primary cause?
    ...
    â””â”€â”€ No â†’ How many potential contributing factors?
        â”œâ”€â”€ 1-2 factors (linear causation) â†’ Use 5 WHY ANALYSIS
        â”œâ”€â”€ 3-6 factors (complex, systemic) â†’ Use FISHBONE DIAGRAM
        â””â”€â”€ Unknown/proactive assessment â†’ Use FMEA
```
...
â”œâ”€â”€ Yes â†’ CAPA INEFFECTIVE (re-investigate root cause)
â””â”€â”€ No â†’ Were all effectiveness criteria met?
    â”œâ”€â”€ Yes â†’ CAPA EFFECTIVE (proceed to closure)
    â””â”€â”€ No â†’ Extent of gap?
        â”œâ”€â”€ Minor gap â†’ Extend verification or accept with justification
        â””â”€â”€ Significant gap â†’ CAPA INEFFECTIVE (revise actions)
```
