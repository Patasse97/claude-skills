---
title: "MDR 2017/745 Specialist â€” Agent Skill for Compliance"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/ra-qm-team/mdr-745-specialist/SKILL.md">Source</a></span>
</div>
...
â”œâ”€â”€ Device description and UDI-DI
â”œâ”€â”€ Label and instructions for use
â”œâ”€â”€ Design and manufacturing info
â”œâ”€â”€ GSPR compliance matrix
â”œâ”€â”€ Benefit-risk analysis
â”œâ”€â”€ Verification and validation
â””â”€â”€ Clinical evaluation report
```
...
|-------------|----------|--------|
| Safe design (GSPR 1-3) | Risk management file | â˜ |
| Chemical properties (GSPR 10.1) | Biocompatibility report | â˜ |
| Infection risk (GSPR 10.2) | Sterilization validation | â˜ |
| Software requirements (GSPR 17) | IEC 62304 documentation | â˜ |
| Labeling (GSPR 23) | Label artwork, IFU | â˜ |
...
â”œâ”€â”€ Device scope and intended purpose
â”œâ”€â”€ Clinical background (state of the art)
â”œâ”€â”€ Literature search methodology
â”œâ”€â”€ Data appraisal and analysis
â”œâ”€â”€ Safety and performance conclusions
â”œâ”€â”€ Benefit-risk determination
â””â”€â”€ PMCF plan summary
```
