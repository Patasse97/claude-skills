---
title: "Quality Documentation Manager â€” Agent Skill for Compliance"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/ra-qm-team/quality-documentation-manager/SKILL.md">Source</a></span>
</div>
...
|-------------|-------------------|---------|
| Major revision | Increment number | Rev 01 â†’ Rev 02 |
| Minor revision | Increment sub-revision | Rev 01 â†’ Rev 01.1 |
| Administrative | No change or letter suffix | Rev 01 â†’ Rev 01a |
...
- Electronic record requirements (Â§11.10)
- Electronic signature requirements (Â§11.50, 11.100, 11.200)
