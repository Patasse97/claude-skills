---
title: "Senior Quality Manager Responsible Person (QMR) â€” Agent Skill for Compliance"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/ra-qm-team/quality-manager-qmr/SKILL.md">Source</a></span>
</div>
...
See: [references/management-review-guide.md](https://github.com/Patasse97/claude-skills/tree/main/ra-qm-team/quality-manager-qmr/references/management-review-guide.md)
...
|----------|-----|--------|-------------|
| Process | First Pass Yield | >95% | (Units passed first time / Total units) Ã— 100 |
| Process | Nonconformance Rate | <1% | (NC count / Total units) Ã— 100 |
| CAPA | CAPA Closure Rate | >90% | (On-time closures / Due closures) Ã— 100 |
| CAPA | CAPA Effectiveness | >85% | (Effective CAPAs / Verified CAPAs) Ã— 100 |
| Audit | Finding Closure Rate | >90% | (On-time closures / Due closures) Ã— 100 |
| Audit | Repeat Finding Rate | <10% | (Repeat findings / Total findings) Ã— 100 |
| Customer | Complaint Rate | <0.1% | (Complaints / Units sold) Ã— 100 |
...
See: [references/quality-kpi-framework.md](https://github.com/Patasse97/claude-skills/tree/main/ra-qm-team/quality-manager-qmr/references/quality-kpi-framework.md)
...
|------|-------|---------------|
| Document control system current | â˜ | |
| Training records complete | â˜ | |
| CAPA system current, no overdue items | â˜ | |
| Complaint files complete | â˜ | |
| Equipment calibration current | â˜ | |
| Supplier qualification files complete | â˜ | |
| Management review records available | â˜ | |
| Internal audit program current | â˜ | |
...
| Tool | Purpose | Usage |
|------|---------|-------|
| [management_review_tracker.py](https://github.com/Patasse97/claude-skills/tree/main/ra-qm-team/quality-manager-qmr/scripts/management_review_tracker.py) | Track review inputs, actions, metrics | `python management_review_tracker.py --help` |
...
| Document | Content |
|----------|---------|
| [management-review-guide.md](https://github.com/Patasse97/claude-skills/tree/main/ra-qm-team/quality-manager-qmr/references/management-review-guide.md) | ISO 13485 Clause 5.6 requirements, input/output templates, action tracking |
| [quality-kpi-framework.md](https://github.com/Patasse97/claude-skills/tree/main/ra-qm-team/quality-manager-qmr/references/quality-kpi-framework.md) | KPI categories, targets, calculations, dashboard templates |
...
|-------|-------------------|
| [quality-manager-qms-iso13485](https://github.com/Patasse97/claude-skills/tree/main/ra-qm-team/quality-manager-qms-iso13485) | QMS process management |
| [capa-officer](https://github.com/Patasse97/claude-skills/tree/main/ra-qm-team/capa-officer) | CAPA system oversight |
| [qms-audit-expert](https://github.com/Patasse97/claude-skills/tree/main/ra-qm-team/qms-audit-expert) | Internal audit program |
| [quality-documentation-manager](https://github.com/Patasse97/claude-skills/tree/main/ra-qm-team/quality-documentation-manager) | Document control oversight |
