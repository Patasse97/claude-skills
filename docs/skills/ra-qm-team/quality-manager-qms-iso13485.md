---
title: "Quality Manager - QMS ISO 13485 Specialist â€” Agent Skill for Compliance"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/ra-qm-team/quality-manager-qms-iso13485/SKILL.md">Source</a></span>
</div>
...
6. Create required documented procedures â€” see [Mandatory Documented Procedures](#quick-reference-mandatory-documented-procedures) for the full list
...
> Use the Gap Analysis Matrix template in [qms-process-templates.md](https://github.com/Patasse97/claude-skills/tree/main/ra-qm-team/quality-manager-qms-iso13485/references/qms-process-templates.md) to document clause-by-clause current state, gaps, priority, and actions.
...
|--------|--------|-------------|
| Accept Rate | >98% | (Accepted lots / Total lots) Ã— 100 |
| On-Time Delivery | >95% | (On-time / Total orders) Ã— 100 |
| Response Time | <5 days | Average days to resolve issues |
| Documentation | 100% | (Complete CoCs / Required CoCs) Ã— 100 |

---

## QMS Process Reference

For detailed requirements and audit questions for each ISO 13485:2016 clause, see [iso13485-clause-requirements.md](https://github.com/Patasse97/claude-skills/tree/main/ra-qm-team/quality-manager-qms-iso13485/references/iso13485-clause-requirements.md).
...
| Tool | Purpose | Usage |
|------|---------|-------|
| [qms_audit_checklist.py](https://github.com/Patasse97/claude-skills/tree/main/ra-qm-team/quality-manager-qms-iso13485/scripts/qms_audit_checklist.py) | Generate audit checklists by clause or process | `python qms_audit_checklist.py --help` |
...
| Document | Content |
|----------|---------|
| [iso13485-clause-requirements.md](https://github.com/Patasse97/claude-skills/tree/main/ra-qm-team/quality-manager-qms-iso13485/references/iso13485-clause-requirements.md) | Detailed requirements for each ISO 13485:2016 clause with audit questions |
| [qms-process-templates.md](https://github.com/Patasse97/claude-skills/tree/main/ra-qm-team/quality-manager-qms-iso13485/references/qms-process-templates.md) | Ready-to-use templates for gap analysis, audit program, document control, CAPA, supplier, training |
...
|-------|-------------------|
| [quality-manager-qmr](https://github.com/Patasse97/claude-skills/tree/main/ra-qm-team/quality-manager-qmr) | Management review, quality policy |
| [capa-officer](https://github.com/Patasse97/claude-skills/tree/main/ra-qm-team/capa-officer) | CAPA system management |
| [qms-audit-expert](https://github.com/Patasse97/claude-skills/tree/main/ra-qm-team/qms-audit-expert) | Advanced audit techniques |
| [quality-documentation-manager](https://github.com/Patasse97/claude-skills/tree/main/ra-qm-team/quality-documentation-manager) | DHF, DMR, DHR management |
| [risk-management-specialist](https://github.com/Patasse97/claude-skills/tree/main/ra-qm-team/risk-management-specialist) | ISO 14971 integration |
