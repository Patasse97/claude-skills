---
title: "Regulatory Affairs & Quality Management Skills â€” Agent Skill for Compliance"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/ra-qm-team/SKILL.md">Source</a></span>
</div>
...
### Codex CLI
```bash
npx agent-skills-cli add Patasse97/claude-skills/ra-qm-team
```
