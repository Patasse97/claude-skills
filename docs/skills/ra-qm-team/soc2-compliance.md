---
title: "SOC 2 Compliance â€” Agent Skill for Compliance"
...
<span class="meta-badge">:material-github: <a href="https://github.com/Patasse97/claude-skills/tree/main/ra-qm-team/soc2-compliance/SKILL.md">Source</a></span>
</div>
...
SOC 2 (System and Organization Controls 2) is an auditing framework developed by the AICPA that evaluates how a service organization manages customer data. It applies to any technology company that stores, processes, or transmits customer information â€” primarily SaaS, cloud infrastructure, and managed service providers.
...
```
Gap Assessment â†’ Remediation â†’ Type I Audit â†’ Observation Period â†’ Type II Audit â†’ Annual Renewal
...
### Security (Common Criteria CC1-CC9) â€” Required
...
### Processing Integrity (PI1) â€” Optional
...
```
{CATEGORY}-{NUMBER}
SEC-001 through SEC-NNN  â†’ Security
AVL-001 through AVL-NNN  â†’ Availability
CON-001 through CON-NNN  â†’ Confidentiality
PRI-001 through PRI-NNN  â†’ Processing Integrity
PRV-001 through PRV-NNN  â†’ Privacy
```
...
5. Validate coverage â€” every selected TSC criterion must have at least one control
...
1. **Document existing controls** â€” inventory all security policies, procedures, and technical controls
2. **Map to TSC** â€” align existing controls to Trust Service Criteria
3. **Collect evidence samples** â€” gather proof that controls exist and operate
4. **Interview control owners** â€” verify understanding and execution

### Phase 2: Gap Identification

Run `gap_analyzer.py` against your current controls to identify:

- **Missing controls** â€” TSC criteria with no corresponding control
- **Partially implemented** â€” Control exists but lacks evidence or consistency
- **Design gaps** â€” Control designed but does not adequately address the criteria
- **Operating gaps** (Type II only) â€” Control designed correctly but not operating effectively
...
1. **Automated evidence gathering** â€” scripts that pull evidence on schedule
2. **Control dashboards** â€” real-time visibility into control status
3. **Alert-based monitoring** â€” notify when a control drifts out of compliance
4. **Evidence repository** â€” centralized, timestamped evidence storage
...
1. **Vendor inventory** â€” maintain a register of all service providers
2. **Risk classification** â€” categorize vendors by data access level
3. **Due diligence** â€” collect SOC 2 reports, security questionnaires, certifications
4. **Contractual protections** â€” ensure DPAs, security requirements, breach notification clauses
5. **Ongoing monitoring** â€” annual reassessment, continuous news monitoring
...
- **Inclusive method** â€” your report covers the subservice org's controls (requires their cooperation)
- **Carve-out method** â€” your report excludes their controls but references their SOC 2 report
...
1. **Automate evidence gathering** â€” cron jobs, API integrations, IaC snapshots
2. **Build control dashboards** â€” aggregate control status into a single view
3. **Configure drift alerts** â€” notify when controls fall out of compliance
4. **Establish review cadence** â€” weekly control owner check-ins, monthly steering
5. **Maintain evidence repository** â€” centralized, timestamped, auditor-accessible
...
- [Trust Service Criteria Reference](https://github.com/Patasse97/claude-skills/tree/main/ra-qm-team/soc2-compliance/references/trust_service_criteria.md) â€” All 5 TSC categories with sub-criteria, control objectives, and evidence examples
- [Evidence Collection Guide](https://github.com/Patasse97/claude-skills/tree/main/ra-qm-team/soc2-compliance/references/evidence_collection_guide.md) â€” Evidence types per control, automation tools, documentation requirements
- [Type I vs Type II Comparison](https://github.com/Patasse97/claude-skills/tree/main/ra-qm-team/soc2-compliance/references/type1_vs_type2.md) â€” Detailed comparison, timeline, cost analysis, and upgrade path

---

## Cross-References

- **[gdpr-dsgvo-expert](https://github.com/Patasse97/claude-skills/tree/main/ra-qm-team/gdpr-dsgvo-expert/SKILL.md)** â€” SOC 2 Privacy criteria overlaps significantly with GDPR requirements; use together when processing EU personal data
- **[information-security-manager-iso27001](https://github.com/Patasse97/claude-skills/tree/main/ra-qm-team/information-security-manager-iso27001/SKILL.md)** â€” ISO 27001 Annex A controls map closely to SOC 2 Security criteria; organizations pursuing both can share evidence
- **[isms-audit-expert](https://github.com/Patasse97/claude-skills/tree/main/ra-qm-team/isms-audit-expert/SKILL.md)** â€” Audit methodology and finding management patterns transfer directly to SOC 2 audit preparation
