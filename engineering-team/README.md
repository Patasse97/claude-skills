...
npx ai-agent-skills install Patasse97/claude-skills/engineering-team

# Install to Claude Code only
npx ai-agent-skills install Patasse97/claude-skills/engineering-team --agent claude

# Install to Cursor only
npx ai-agent-skills install Patasse97/claude-skills/engineering-team --agent cursor
```
...
```bash
# Core Engineering
npx ai-agent-skills install Patasse97/claude-skills/engineering-team/senior-architect
npx ai-agent-skills install Patasse97/claude-skills/engineering-team/senior-frontend
npx ai-agent-skills install Patasse97/claude-skills/engineering-team/senior-backend
npx ai-agent-skills install Patasse97/claude-skills/engineering-team/senior-fullstack
npx ai-agent-skills install Patasse97/claude-skills/engineering-team/senior-qa
npx ai-agent-skills install Patasse97/claude-skills/engineering-team/senior-devops
npx ai-agent-skills install Patasse97/claude-skills/engineering-team/senior-secops
npx ai-agent-skills install Patasse97/claude-skills/engineering-team/code-reviewer
npx ai-agent-skills install Patasse97/claude-skills/engineering-team/senior-security

# Cloud & Enterprise
npx ai-agent-skills install Patasse97/claude-skills/engineering-team/aws-solution-architect
npx ai-agent-skills install Patasse97/claude-skills/engineering-team/ms365-tenant-manager

# Development Tools
npx ai-agent-skills install Patasse97/claude-skills/engineering-team/tdd-guide
npx ai-agent-skills install Patasse97/claude-skills/engineering-team/tech-stack-evaluator

# AI/ML/Data
npx ai-agent-skills install Patasse97/claude-skills/engineering-team/senior-data-scientist
npx ai-agent-skills install Patasse97/claude-skills/engineering-team/senior-data-engineer
npx ai-agent-skills install Patasse97/claude-skills/engineering-team/senior-ml-engineer
npx ai-agent-skills install Patasse97/claude-skills/engineering-team/senior-prompt-engineer
npx ai-agent-skills install Patasse97/claude-skills/engineering-team/senior-computer-vision
```
...
â”œâ”€â”€ references/               # 3 detailed reference guides
â”‚   â”œâ”€â”€ [topic]_patterns.md
â”‚   â”œâ”€â”€ [topic]_guide.md
â”‚   â””â”€â”€ [topic]_practices.md
â””â”€â”€ scripts/                  # 3 automation scripts
    â”œâ”€â”€ [tool]_generator.py
    â”œâ”€â”€ [tool]_analyzer.py
    â””â”€â”€ [tool]_scaffolder.py
```
...
â†’ Use `senior-fullstack` or `senior-architect`

**Building frontend features?**
â†’ Use `senior-frontend`

**Designing APIs?**
â†’ Use `senior-backend`

**Setting up CI/CD?**
â†’ Use `senior-devops`

**Security concerns?**
â†’ Use `senior-secops` or `senior-security`
...
1. âœ… **Senior Architect** - System design and architecture
2. âœ… **Senior Frontend** - React/Next.js development
3. âœ… **Senior Backend** - API and backend development
4. âœ… **Senior Fullstack** - End-to-end development
5. âœ… **Senior QA** - Testing and quality assurance
6. âœ… **Senior DevOps** - CI/CD and infrastructure
7. âœ… **Senior SecOps** - Security operations
8. âœ… **Code Reviewer** - Code review automation
9. âœ… **Senior Security** - Security architecture
