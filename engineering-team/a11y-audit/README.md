# A11y Audit â€” WCAG 2.2 Accessibility Audit & Fix
...
Both are stdlib-only â€” no pip install needed. CI-friendly exit codes (0 = pass, 1 = blocking issues).
...
- `references/wcag-quick-ref.md` â€” WCAG 2.2 Level A/AA criteria table
- `references/aria-patterns.md` â€” ARIA roles, live regions, keyboard patterns
- `references/framework-a11y-patterns.md` â€” React, Vue, Angular, Svelte fix patterns
