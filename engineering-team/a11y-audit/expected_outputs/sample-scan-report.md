# A11y Audit Report â€” sample-component.tsx
...
- **Fix:** Use `tabIndex={0}` â€” positive values disrupt natural tab order
...
- **Fix:** Add text or icon alongside color: `{row.active ? 'âœ“ Active' : 'âœ— Inactive'}`
