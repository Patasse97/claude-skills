...
**Form labels:**
```jsx
// âŒ Bad â€” placeholder as label
<input placeholder="Email" type="email" />

// âœ… Good â€” explicit label
<label htmlFor="email">Email</label>
<input id="email" type="email" placeholder="user@example.com" />

// âœ… Good â€” aria-label for icon-only inputs
<input type="search" aria-label="Search products" />
```

**Click handlers on divs:**
```jsx
// âŒ Bad â€” not keyboard accessible
<div onClick={handleClick}>Click me</div>

// âœ… Good â€” use button
<button onClick={handleClick}>Click me</button>

// âœ… If div is required â€” add keyboard support
<div
  role="button"
  tabIndex={0}
  onClick={handleClick}
...
```jsx
// Layout component â€” announce page changes
'use client';
...
- `@radix-ui/*` â€” accessible primitives (Dialog, Tabs, Select, etc.)
- `@headlessui/react` â€” unstyled accessible components
- `react-aria` â€” Adobe's accessibility hooks
- `eslint-plugin-jsx-a11y` â€” lint rules for JSX accessibility
...
- `vue-announcer` â€” route change announcements
- `@headlessui/vue` â€” accessible components
- `eslint-plugin-vuejs-accessibility` â€” lint rules
...
- `@angular/cdk/a11y` â€” `FocusTrap`, `LiveAnnouncer`, `FocusMonitor`
- `codelyzer` â€” a11y lint rules for Angular templates
...
```svelte
<!-- âŒ Bad â€” on:click without keyboard -->
<div on:click={handleClick}>Action</div>

<!-- âœ… Good â€” Svelte a11y warning built-in -->
...
**Note:** Svelte has built-in a11y warnings in the compiler â€” it flags missing alt text, click-without-keyboard, and other common issues at build time.
...
```css
/* âŒ Bad â€” removes focus indicator entirely */
:focus { outline: none; }

/* âœ… Good â€” custom focus indicator */
:focus-visible {
  outline: 2px solid #005fcc;
  outline-offset: 2px;
}

/* âœ… Good â€” enhanced for high contrast mode */
