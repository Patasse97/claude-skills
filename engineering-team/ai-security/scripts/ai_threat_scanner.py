#!/usr/bin/env python3
"""
ai_threat_scanner.py â€” AI/LLM Security Threat Scanner
...
def main():
    parser = argparse.ArgumentParser(
        description="AI/LLM Security Threat Scanner â€” Detects prompt injection, jailbreaks, and ATLAS threats.",
    ...
    if args.output_json:
        ...
        print(f"Auth Required   : {'YES â€” obtain authorization before proceeding' if auth_required else 'No'}")
