...
- Lowercase only (some resources require it â€” be consistent everywhere)
...
3. **Scope to the narrowest level** â€” resource group or resource, not subscription
4. **Use Managed Identity** for service-to-service â€” never store credentials
