...
- **Start with App Service** for web apps and APIs â€” simplest operational model.
- **Use Container Apps** for microservices â€” serverless containers without Kubernetes complexity.
...
**Always use v5 generation or newer** â€” better price-performance than older series.
...
**Opinionated recommendation:**
- **Default to Azure SQL Serverless** for most relational workloads â€” auto-pause saves money in dev/staging.
