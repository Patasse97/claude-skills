...
def _app_service_web(users: int, reqs: Dict) -> Dict[str, Any]:
    ...
    return {
        ...
        "pros": [
            "Managed platform â€” no OS patching",
...
def _aks_microservices(users: int, reqs: Dict) -> Dict[str, Any]:
    ...
    return {
        ...
        "pros": [
            ...
            "Workload identity â€” no credentials in pods",
        ],
        "cons": [
...
def _container_apps(users: int, reqs: Dict) -> Dict[str, Any]:
    ...
    return {
        ...
        "pros": [
            "Serverless containers â€” scale to zero",
...
def _serverless_functions(users: int, reqs: Dict) -> Dict[str, Any]:
    ...
    return {
        ...
        "pros": [
            "Pay-per-execution â€” true serverless",
...
def _synapse_pipeline(users: int, reqs: Dict) -> Dict[str, Any]:
    ...
    return {
        ...
        "pros": [
            ...
            "Serverless SQL â€” pay per query",
            "Native Spark integration",
            "Data Lake Gen2 â€” hierarchical namespace, cheap storage",
...
def main():
    parser = argparse.ArgumentParser(
        description="Azure Architecture Designer â€” recommend Azure architecture patterns based on application requirements.",
        epilog="Examples:\n"
               "  python architecture_designer.py --app-type web_app --users 10000\n"
