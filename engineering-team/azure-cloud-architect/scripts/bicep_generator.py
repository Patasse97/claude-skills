...
def _web_app_template() -> str:
    return r"""// =============================================================================
// Azure Web App Architecture â€” Bicep Template
...
def _microservices_template() -> str:
    return r"""// =============================================================================
// Azure Microservices Architecture â€” Bicep Template
...
def _serverless_template() -> str:
    return r"""// =============================================================================
// Azure Serverless Architecture â€” Bicep Template
...
def _data_pipeline_template() -> str:
    return r"""// =============================================================================
// Azure Data Pipeline Architecture â€” Bicep Template
...
def main():
    parser = argparse.ArgumentParser(
        description="Azure Bicep Generator â€” generate Bicep IaC templates for common Azure architecture patterns.",
        epilog="Examples:\n"
               "  python bicep_generator.py --arch-type web-app\n"
               "  python bicep_generator.py --arch-type microservices --output main.bicep\n"
               "  python bicep_generator.py --arch-type serverless --json",
