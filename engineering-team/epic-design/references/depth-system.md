...
```
A depth-0 element at scroll position 500px moves only -50px (barely moves â€” feels far away).
A depth-5 element at 500px moves -600px (moves fast â€” feels close).
...
**Depth 5 â€” Foreground Particles / FX**
- Sparkles, floating dots, light particles, decorative splashes
- Small (32â€“128px), file size: 2â€“10KB
...
## Compositional Hierarchy â€” Size Relationships Between Assets
...
|---|---|---|
| Hero / star element | 50â€“85vw | depth-3 |
| Primary companion | 8â€“15vw | depth-2 |
| Secondary companion | 5â€“10vw | depth-2 |
| Accent / particle | 1â€“4vw | depth-5 |
...
When the hero grows or exits, companions scatter outward â€” not just fade.
...
1. Is this the hero? â†’ make it large enough to command the viewport
2. Is this a companion? â†’ it should be 15â€“25% of the hero's display size
...
Every element at depth 2â€“5 should have a floating animation. Nothing should be perfectly static â€” it kills the 3D illusion.

```css
/* Float variants â€” apply different ones to different elements */
@keyframes float-y {
