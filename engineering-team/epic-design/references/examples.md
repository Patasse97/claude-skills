...
```
[LOADING SCREEN â€” brand logo on black, splits open]
     â†“
[HERO â€” dark purple gradient]
...
[FLOATING PRODUCT BRIDGE â€” glass hovers between sections]

[INGREDIENTS â€” warm cream/yellow section]
...
[FLAVORS â€” cascading card stack, 3 cards]
  Card 1: Orange â€” scales down as Card 2 arrives
  Card 2: Mango â€” scales down as Card 3 arrives  
  Card 3: Berry â€” stays full screen
...
**Key Code Pattern â€” The Glass Journey:**
```javascript
...
**Color Palette:**
- Hero: `#0a0014` (deep purple) â†’ `#2d0b4e`
...
**Brief:** B2B SaaS product â€” analytics dashboard. Premium, modern, tech-forward. Animated product screenshots.
...
```
[HERO â€” midnight blue]
  Entry: window pane iris â€” site reveals from tiny centered rectangle
...
[FEATURE ZOOM â€” pinned section, 300vh scroll distance]
...
[HOW IT WORKS â€” top-down clip birth]
  3-step process
...
```
[INTRO â€” stark black]
  NO loading screen â€” shock with immediate bold text
  depth-0: pure black (#000)
  depth-4: MASSIVE bleed title â€” name in 180px+ font
           offset diagonal layout:
           Line 1: "ALEX" â€” top-left, x: 5%
           Line 2: "MORENO" â€” lower-right, x: 40%
           Line 3: "Designer" â€” far right, smaller, italic
  Cursor spotlight effect follows mouse
  CTA: "See Work â†“" â€” subtle, bottom-right

[MARQUEE DIVIDER]
  Scroll-speed reactive marquee:
  "AVAILABLE FOR WORK  Â·  BASED IN LONDON  Â·  OPEN TO REMOTE  Â·"
  Speed up when user scrolls fast

[PROJECTS â€” horizontal scroll, 4 projects]
...
[HERO â€” extreme depth parallax]
  ...
  depth-3: CHARACTER PNG â€” hero character (main float-loop)
  depth-4: game title â€” "SHADOWREALM" (split converge from sides)
  depth-5: foreground particles â€” embers/sparks (fast float)
  Cursor: particle trail (sparks follow cursor)

[FLY-THROUGH â€” perspective zoom, 300vh]
  Pinned section
  Camera appears to fly INTO the game world
  Background rushes toward viewer (scale 0.3 â†’ 1.4)
  Character appears from far (scale 0.05 â†’ 1)
  Title resolves via scramble text

[LORE â€” word scroll lighting, pinned 400vh]
...
[CHARACTERS â€” cascading card stack, 4 characters]
...
```
[HERO â€” pure white or cream]
  No loading screen â€” immediate elegance
  ...
  depth-3: WATCH PNG â€” centered, generous space, slow float (14s loop, tiny movement)
  depth-4: brand name â€” thin weight, large tracking
           "Est. 1887" â€” tiny, centered below
  Parallax factors reduced: depth-3 factor = 0.3 (elegant, not dramatic)

[PRODUCT TRANSITION â€” GSAP Flip]
...
[MATERIALS â€” clip-path section birth]
  Cream/beige section
...
## Combining Patterns â€” Quick Reference
