...
<!-- ScrollTrigger plugin â€” required for all scroll patterns -->
<script src="https://cdn.jsdelivr.net/npm/gsap@3.12.5/dist/ScrollTrigger.min.js"></script>
<!-- ScrollSmoother â€” optional, pairs with ScrollTrigger -->
<script src="https://cdn.jsdelivr.net/npm/gsap@3.12.5/dist/ScrollSmoother.min.js"></script>
<!-- Flip plugin â€” for cross-section element morphing -->
<script src="https://cdn.jsdelivr.net/npm/gsap@3.12.5/dist/Flip.min.js"></script>
<!-- MotionPathPlugin â€” for curved element paths -->
...
**Visual result:** Section feels like a chapter â€” the page "lives inside it" for a while, then moves on.
...
.h-scroll-container {
  display: flex;
  width: calc(300vw); /* 3 panels Ã— 100vw */
  height: 100vh;
  overflow: hidden;
}
.h-panel {
...
Full-page scroll snapping between sections â€” creates a chapter-like book feeling.
...
micro-rotation shake fires on landing â€” simulating physical weight and impact.
...
function initElasticDrop(productEl, wrapperEl) {
  ...
  // Apply to the WRAPPER not the element â€” avoids transform conflicts
  .to(wrapperEl, {
    keyframes: [
...
Ease variants:
- `elastic.out(1, 0.65)` â€” standard product, moderate bounce
- `elastic.out(1.2, 0.5)` â€” heavier object, more overshoot
- `elastic.out(0.8, 0.8)` â€” lighter, quicker settle
- `back.out(2.5)` â€” no oscillation, one clean overshoot

Do NOT use for: gentle floaters, airy elements (flowers, feathers) â€” use `power3.out` instead.
