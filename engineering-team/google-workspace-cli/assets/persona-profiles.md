...
**Top Commands:**
- `gws helpers morning-briefing` â€” Start the day with schedule + inbox overview
- `gws helpers find-time` â€” Find available slots for meetings
- `gws helpers meeting-prep --event-id <id>` â€” Prepare meeting agenda
- `gws gmail users.messages send me` â€” Send emails on behalf
- `gws helpers eod-wrap` â€” End of day summary
...
**Top Commands:**
- `gws recipes standup-report` â€” Generate standup updates
- `gws helpers find-time` â€” Schedule sprint ceremonies
- `gws tasks tasks insert` â€” Create and assign tasks
- `gws sheets spreadsheets.values get` â€” Read project trackers
- `gws recipes project-status` â€” Aggregate project status
...
**Top Commands:**
- `gws admin users list` â€” List all domain users
- `gws admin users get <email>` â€” Look up employee details
- `gws docs documents create` â€” Create onboarding docs
- `gws drive permissions create` â€” Share folders with new hires
- `gws people people.connections list` â€” Export contact directory
...
**Top Commands:**
- `gws gmail users.messages send me` â€” Send proposals and follow-ups
- `gws gmail users.messages list me --query` â€” Search client conversations
- `gws helpers find-time` â€” Schedule client meetings
- `gws docs documents create` â€” Create proposals
- `gws sheets spreadsheets.values update` â€” Update pipeline tracker
...
**Top Commands:**
- `gws admin users list --domain` â€” Audit user accounts
- `gws admin activities list login` â€” Monitor login activity
- `gws admin groups list` â€” Manage groups
- `python3 workspace_audit.py` â€” Run security audit
- `gws drive files list --orderBy "quotaBytesUsed desc"` â€” Find storage hogs
...
**Top Commands:**
- `gws sheets spreadsheets.values get` â€” Read config/data from Sheets
- `gws sheets spreadsheets.values update` â€” Write results to Sheets
- `gws drive files create --upload` â€” Upload build artifacts
- `gws chat spaces.messages create` â€” Post deployment notifications
- `gws tasks tasks insert` â€” Create tasks from CI/CD
...
**Top Commands:**
- `gws docs documents create` â€” Draft blog posts and briefs
- `gws drive files create --upload` â€” Upload creative assets
- `gws sheets spreadsheets.values append` â€” Log campaign metrics
- `gws gmail users.messages send me` â€” Send campaign emails
- `gws chat spaces.messages create` â€” Coordinate with team
...
**Top Commands:**
- `gws sheets spreadsheets.values get` â€” Pull financial data
- `gws sheets spreadsheets.values update` â€” Update forecasts
- `gws sheets spreadsheets create` â€” Create new reports
- `gws drive files export` â€” Export reports as PDF
- `gws drive permissions create` â€” Share with auditors
...
**Top Commands:**
- `gws docs documents create` â€” Draft contracts
- `gws drive files export` â€” Export final versions as PDF
- `gws drive permissions create` â€” Manage document access
- `gws gmail users.messages list me --query` â€” Search for compliance emails
- `gws admin activities list` â€” Audit trail for compliance
...
**Top Commands:**
- `gws gmail users.messages list me --query` â€” Search customer emails
- `gws gmail users.messages reply me` â€” Reply to tickets
- `gws gmail users.labels create` â€” Organize by ticket status
- `gws tasks tasks insert` â€” Create follow-up tasks
- `gws chat spaces.messages create` â€” Escalate to team
