...
**Causes and fixes:**
1. **Wrong scope** â€” Re-auth with correct scopes
2. **Not the file owner** â€” Request access from the owner
3. **Domain policy** â€” Check Admin Console sharing policies
4. **API not enabled** â€” Enable the API in Google Cloud Console
...
gws auth setup --no-browser
# Prints a URL â€” open on another machine, paste code back
