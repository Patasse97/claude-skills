#!/usr/bin/env python3
"""
Google Workspace CLI Doctor â€” Pre-flight diagnostics for gws CLI.
...
DEMO_CHECKS = [
    ...
    Check("gmail-access", "PASS", "Gmail API accessible â€” user profile retrieved"),
    Check("drive-access", "PASS", "Drive API accessible â€” root folder listed"),
    Check("calendar-access", "PASS", "Calendar API accessible â€” primary calendar found"),
...
Examples:
  ...
  %(prog)s --demo                   # Demo mode (no gws required)
    ...
    if args.json:
        ...
        if report.demo_mode:
            print(f"  (DEMO MODE â€” sample data)")
        print(f"{'='*60}\n")
