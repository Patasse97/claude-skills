#!/usr/bin/env python3
"""
Google Workspace Security Audit â€” Audit Workspace configuration for security risks.
...
def calculate_score(report: AuditReport) -> AuditReport:
    ...
    report.summary = f"{passes} passed, {warns} warnings, {fails} failures â€” Score: {score}/100 (Grade: {report.grade})"
    return report
