...
[2-3 sentence summary of the incident: what happened, impact scope, resolution status. Written for executive audience â€” no jargon, focus on business impact.]
...
| **Data Loss** | [Yes/No â€” if yes, detail below] |
...
1. **[HH:MM] [Decision]** â€” [Rationale and outcome]
2. **[HH:MM] [Decision]** â€” [Rationale and outcome]
...
[Clear, specific statement of the root cause. Not "human error" â€” describe the systemic failure.]

### Contributing Factors

1. **[Factor Category: Process/Tooling/Human/Environment]** â€” [Description]
2. **[Factor Category]** â€” [Description]
3. **[Factor Category]** â€” [Description]
...
- [INC-YYYY-NNNN] â€” [Brief description of related incident]
