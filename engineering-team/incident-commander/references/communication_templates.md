...
**Subject:** ðŸš¨ [SEV1] CRITICAL: {Service} Complete Outage - Immediate Response Required
...
âœ“ Incident Commander: {Name} - ASSIGNED
âœ“ War Room: {Bridge/Chat Link} - JOIN NOW
âœ“ On-Call Response: {Team} - PAGED
â³ Executive Notification: In progress
â³ Status Page Update: Within 15 minutes
...
**Subject:** ðŸš¨ URGENT: Customer-Impacting Outage - {Service}
...
Current Actions:
â€¢ {Action 1 - customer-friendly description}
â€¢ {Action 2 - customer-friendly description}
â€¢ {Action 3 - customer-friendly description}
...
**Subject:** âš ï¸ [SEV2] {Service} Performance Issues - Response Team Mobilizing
...
â³ {Action 2 - in progress}
â³ {Action 3 - next step}
...
â€¢ {Response action 1}
â€¢ {Response action 2}
â€¢ {Monitoring/verification steps}
...
**Subject:** ESCALATION: {Original Severity} â†’ {New Severity} - {Service}
...
Escalation Reasons:
â€¢ {Reason 1 - scope expansion/duration/impact}
â€¢ {Reason 2}
â€¢ {Reason 3}
...
â€¢ {Challenge 1}
â€¢ {Challenge 2}
â€¢ {Resource/expertise needs}

Business Impact:
{Updated assessment of business implications}

Management Decision Required:
â€¢ {Decision 1 - resource allocation/external expertise/communication}
â€¢ {Decision 2}
...
Next Steps:
â€¢ Post-incident review scheduled for {date}
â€¢ Action items to be tracked in {system}
â€¢ Follow-up communication: {If needed}
