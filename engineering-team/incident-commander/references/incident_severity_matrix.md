...
#### Escalation Path
1. **Immediate**: On-call Engineer â†’ Incident Commander
...
#### Escalation Path
1. **Immediate**: On-call Engineer â†’ Team Lead
...
1. Is this a security incident with data exposure?
   â†’ YES: SEV1 (regardless of user count)
...
```
Subject: ðŸš¨ CRITICAL INCIDENT - [Service] Complete Outage
...
### SEV2 Major Impact
```
Subject: âš ï¸ [SEV2] [Service] - Major Performance Impact
