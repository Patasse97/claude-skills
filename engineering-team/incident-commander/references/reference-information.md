...
- **Why 1:** Why did the database become unresponsive? â†’ Connection pool was exhausted
- **Why 2:** Why was the connection pool exhausted? â†’ Application was creating more connections than usual
- **Why 3:** Why was the application creating more connections? â†’ New feature wasn't properly connection pooling
- **Why 4:** Why wasn't the feature properly connection pooling? â†’ Code review missed this pattern
- **Why 5:** Why did code review miss this? â†’ No automated checks for connection pooling patterns
