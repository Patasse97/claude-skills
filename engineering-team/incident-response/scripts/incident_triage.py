#!/usr/bin/env python3
"""
incident_triage.py â€” Incident Classification, Triage, and Escalation
...
Exit codes:
    0  SEV3/SEV4 or clean â€” standard handling
    1  SEV2 â€” elevated response required
    2  SEV1 â€” critical incident declared
"""
...
# ---------------------------------------------------------------------------
# Constants â€” Forensic Pre-Analysis Base (reused from pre_analysis.py logic)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Constants â€” Incident Taxonomy and Escalation
# ---------------------------------------------------------------------------
...
def classify_incident(fact: dict) -> Tuple[str, float]:
    ...
    Returns:
        (incident_type, confidence) where confidence is 0.0â€“1.0.
