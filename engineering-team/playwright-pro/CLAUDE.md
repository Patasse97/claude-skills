...
7. **Traces: `'on-first-retry'`** â€” rich debugging without CI slowdown
...
4. Match the project's language (check for `tsconfig.json` â†’ TypeScript, else JavaScript)
