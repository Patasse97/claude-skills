...
test.describe('API Error Responses', () => {
  ...
  // 429 Too Many Requests (handled in rate-limiting template â€” kept here for completeness)
...
| Variant | Description |
|---------|-------------|
| 400 Bad Request | Invalid body â†’ 400 + errors detail |
| 401 Unauthorized | No token â†’ 401 |
| 403 Forbidden | Wrong role â†’ 403 |
| 404 Not Found | Missing resource â†’ 404 |
| 422 Unprocessable | Missing required field â†’ 422/400 |
| 429 Rate Limit | Threshold exceeded â†’ 429 |
| 500 Server Error | Mocked 500 â†’ error body present |
