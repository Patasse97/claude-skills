...
| Variant | Description |
|---------|-------------|
| Persistent cookie | Remember me â†’ long-lived cookie (>7 days) |
| Session cookie | No remember me â†’ session-scoped cookie |
| Survives reload | Persistent cookie keeps user logged in across restart |
| Expired cookie | Stale cookie â†’ redirect to /login |
