...
| Variant | Description |
|---------|-------------|
| Delete confirmed | Dialog confirmed â†’ entity removed â†’ list page |
| Delete from list | Row action â†’ confirm â†’ row removed |
| Cancel deletion | Dialog cancelled â†’ entity intact |
| Dependent error | Entity with children â†’ deletion blocked |
