...
test.describe('Update {{entityName}}', () => {
  ...
  // Happy path: edit then navigate away â€” unsaved changes warning
...
| Variant | Description |
|---------|-------------|
| Edit form | Full edit form â†’ save â†’ detail page |
| Inline edit | Click field â†’ type â†’ Enter to save |
| Unsaved changes | Navigation shows discard confirmation |
| Required field | Cleared required field â†’ validation |
| Conflict | Concurrent edit â†’ conflict error |
