...
test.describe('Date Range Filter', () => {
  ...
  // Happy path: preset range â€” last 7 days
  ...
  // Happy path: preset range â€” last 30 days
...
| Custom range | Date picker â†’ start + end â†’ apply |
| Data reload | API called again on range change |
| Invalid range | End before start â†’ apply disabled |
