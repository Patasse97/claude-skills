...
test.describe('Realtime Updates', () => {
  ...
  // Error case: WebSocket disconnected â€” shows offline indicator
  ...
  // Error case: connection refused â€” error state shown
...
| Disconnected | WS close â†’ disconnected indicator |
| Connection refused | WS blocked â†’ error alert |
