...
test.describe('Notification Preferences', () => {
  ...
  // Error case: save fails â€” preferences not changed
...
| Variant | Description |
|---------|-------------|
| Enable email | Toggle on â†’ saved â†’ success |
| Disable push | Toggle off â†’ saved |
| Persists reload | Saved state survives page reload |
| Frequency selector | Dropdown value saved and restored |
| Save error | Server error â†’ error alert |
