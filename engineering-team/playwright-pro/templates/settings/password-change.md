...
| Variant | Description |
|---------|-------------|
| Success | All fields valid â†’ success alert |
| Login with new pw | New password accepted at login |
| Wrong current | Incorrect current â†’ error alert |
| Mismatch | Confirm â‰  new â†’ validation error |
| Weak password | Short password â†’ strength error |
