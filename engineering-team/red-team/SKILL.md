...
| [incident-response](../incident-response/SKILL.md) | Red team activity should trigger incident response procedures â€” detection and response quality is a primary success metric |
