#!/usr/bin/env python3
"""
engagement_planner.py â€” Red Team Engagement Planner
...
def main():
    parser = argparse.ArgumentParser(
        description="Red Team Engagement Planner â€” Builds structured engagement plans from MITRE ATT&CK techniques.",
    ...
    if args.output_json:
        ...
        if plan["choke_points"]:
            for cp in plan["choke_points"]:
                print(f"  {cp['technique_id']} {cp['technique_name']} â€” {cp['note']}")
        else:
