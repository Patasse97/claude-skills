...
```
Subject: Security Vulnerability Report â€” [Brief Title]
...
## Description
[Clear, technical description of the vulnerability â€” what it is, where it exists, and why it matters.]
...
```
Subject: Re: Security Vulnerability Report â€” [Brief Title] (Follow-Up)
...
```
Subject: Re: Security Vulnerability Report â€” [Brief Title] (30-Day Update Request)
...
```
Subject: Re: Security Vulnerability Report â€” [Brief Title] (Pre-Disclosure Notice)
...
## Remediation
[Steps users should take â€” update to version X, apply config change, etc.]
...
3. **Do not exfiltrate data.** Demonstrate the vulnerability with minimal proof. A screenshot showing "1000 records returned" is sufficient â€” downloading the records is not.
...
1. **Read the entire policy** before testing â€” scope, exclusions, safe harbor
2. **Test only in-scope assets** â€” out-of-scope findings may not be rewarded and could be legally risky
3. **Report one vulnerability per submission** â€” do not bundle unrelated issues
4. **Provide clear reproduction steps** â€” assume the reader cannot read your mind
5. **Do not duplicate** â€” search existing reports before submitting
6. **Be patient** â€” triage can take days to weeks depending on program volume
...
4. Do not expect payment â€” responsible disclosure is an ethical practice, not a paid service
...
4. **Document everything.** Timestamps, evidence, communications â€” protect yourself and the process.
