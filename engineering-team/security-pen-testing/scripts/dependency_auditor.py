...
def format_report_text(result: Dict) -> str:
    ...
    if risky:
        ...
        for r in risky:
            lines.append(f"  [{r.severity.upper()}] {r.package} â€” {r.pattern_type}")
...
def main():
    parser = argparse.ArgumentParser(
        description="Dependency Auditor â€” Analyze package manifests for known vulnerabilities and risky patterns.",
