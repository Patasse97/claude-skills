# Self-Improving Agent â€” Claude Code Instructions
...
- `/si:review` â€” Analyze auto-memory health and find promotion candidates
- `/si:promote <pattern>` â€” Graduate a learning to CLAUDE.md or `.claude/rules/`
- `/si:extract <pattern>` â€” Create a reusable skill from a proven pattern
- `/si:status` â€” Quick memory health dashboard
- `/si:remember <knowledge>` â€” Explicitly save something to auto-memory
...
This plugin reads that directory â€” it never creates its own storage.
...
**Don't fight auto-memory â€” orchestrate it.**
