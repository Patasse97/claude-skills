...
- **One problem per skill** â€” don't create omnibus guides
- **Show, don't tell** â€” code examples over prose
- **Include the error** â€” people search by error message
- **Be portable** â€” no `npm` vs `pnpm` assumptions
- **Keep it short** â€” under 200 lines for SKILL.md
- **No unnecessary files** â€” only SKILL.md is required. Add reference/ only if the topic is complex enough to warrant it
