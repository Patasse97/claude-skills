#!/bin/bash
# Self-Improving Agent â€” Error Capture Hook
# Fires on PostToolUse (Bash) to detect command failures.
# Zero output on success â€” only captures when errors are detected.
#
...
# Error patterns â€” ordered by specificity
ERROR_PATTERNS=(
    "error:"
    "Error:"
    "ERROR:"
...
# False positive exclusions â€” don't trigger on these
EXCLUSIONS=(
...
# Output a concise reminder â€” ~40 tokens
cat << EOF
<error-detected>
