...
### 1. CLAUDE.md Files (You â†’ Claude)
...
### 3. Session Memory (Claude â†’ Claude)
...
### 4. Rules Directory (You â†’ Claude, scoped)
...
1. CLAUDE.md (highest â€” explicit instructions)
...
```
Auto-memory captures â†’ This plugin curates â†’ CLAUDE.md enforces
...
2. **Keep CLAUDE.md under 200 lines** â€” split into rules/ if growing
3. **Don't duplicate** â€” if it's in CLAUDE.md, remove it from MEMORY.md
