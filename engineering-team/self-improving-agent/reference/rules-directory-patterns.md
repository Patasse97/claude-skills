...
```
.claude/
â”œâ”€â”€ CLAUDE.md              # Main project instructions (always loaded)
â””â”€â”€ rules/
    â”œâ”€â”€ code-style.md      # No paths â†’ loads always (like CLAUDE.md)
...
3. **Keep unscoped rules minimal** â€” they load every session like CLAUDE.md
