...
Storage:      1KB/request Ã— 100M = 100GB/day
              = 36TB/year
...
Peak RPS:    3,600
CPU cores:   3,600 Ã— 0.05 = 180 cores

With headroom (70% target utilization):
             180 / 0.7 = 257 cores
             = 32 servers Ã— 8 cores
```
...
Peak RPS:           3,600
Outbound:           3,600 Ã— 10KB = 36MB/s = 288 Mbps

With headroom (50%): 432 Mbps â‰ˆ 500 Mbps connection
```
...
**Relationship types:**
```
User â”€â”€1:Nâ”€â”€â–¶ Order       (one user, many orders)
Order â”€â”€1:Nâ”€â”€â–¶ OrderItem  (one order, many items)
Product â”€â”€1:Nâ”€â”€â–¶ OrderItem (one product, many order items)
```
...
â–¡ Verify backup restoration works
â–¡ Deploy new infrastructure
â–¡ Run smoke tests on new system
â–¡ Migrate small percentage (1%)
â–¡ Monitor for 24 hours
â–¡ Increase to 10%
â–¡ Monitor for 24 hours
â–¡ Increase to 50%
â–¡ Monitor for 24 hours
â–¡ Complete migration (100%)
