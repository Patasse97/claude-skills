...
Start
  â”‚
  â”œâ”€ Need ACID transactions? â”€â”€Yesâ”€â”€â–º PostgreSQL/MySQL
  â”‚
  â”œâ”€ Flexible schema needed? â”€â”€Yesâ”€â”€â–º MongoDB
  â”‚
  â”œâ”€ Write-heavy (>50K/sec)? â”€â”€Yesâ”€â”€â–º Cassandra/ScyllaDB
  â”‚
  â”œâ”€ Key-value access only? â”€â”€Yesâ”€â”€â–º Redis/DynamoDB
  â”‚
  â”œâ”€ Time-series data? â”€â”€Yesâ”€â”€â–º TimescaleDB/InfluxDB
  â”‚
  â”œâ”€ Full-text search? â”€â”€Yesâ”€â”€â–º Elasticsearch
  â”‚
  â””â”€ Default â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â–º PostgreSQL
```
...
|----------|----------------|------------------|
| Database | PostgreSQL | Scale/flexibility â†’ MongoDB, DynamoDB |
| Cache | Redis | Simple needs â†’ Memcached |
| Queue | SQS (AWS) / RabbitMQ | Event streaming â†’ Kafka |
| Auth | JWT + Refresh | Traditional web â†’ Sessions |
| Frontend | React + Next.js | Simplicity â†’ Vue, Performance â†’ Svelte |
| Cloud | AWS | Microsoft shop â†’ Azure, ML-first â†’ GCP |
| API | REST | Mobile flexibility â†’ GraphQL, Internal â†’ gRPC |
