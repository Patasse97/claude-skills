...
â”œâ”€â”€ molecules/       # SearchInput, FormField
â”œâ”€â”€ organisms/       # Header, Footer, Sidebar
â”œâ”€â”€ templates/       # PageLayout, DashboardLayout
â””â”€â”€ pages/           # Home, Profile, Settings
```
...
â”‚   â”œâ”€â”€ entities/        # User, Order, Product
â”‚   â””â”€â”€ interfaces/      # Repository interfaces
â”œâ”€â”€ application/         # Use cases, application logic
â”‚   â”œâ”€â”€ use-cases/       # CreateOrder, UpdateUser
â”‚   â””â”€â”€ services/        # OrderService, AuthService
...
```
1. User logs in â†’ Server returns access token (15min) + refresh token (7d)
2. Client stores tokens (httpOnly cookie for refresh, memory for access)
3. Access token expires â†’ Client uses refresh token to get new pair
