...
class Settings(BaseSettings):
    ...
    SECRET_KEY: str = "change-me-in-production"  # âš ï¸ SCAFFOLDING PLACEHOLDER â€” replace before deployment
...
SECRET_KEY="your-secret-here"  # âš ï¸ SCAFFOLDING PLACEHOLDER â€” replace before deployment
''',
