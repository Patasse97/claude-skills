...
def generate_ascii_diagram(config: AgentConfig) -> str:
    ...
    lines.append("â”‚" + config.name.center(width) + "â”‚")
    lines.append("â”‚" + f"({config.pattern.value} Pattern)".center(width) + "â”‚")
    lines.append("â””" + "â”€" * (width // 2 - 1) + "â”¬" + "â”€" * (width // 2) + "â”˜")
    lines.append(" " * (width // 2) + "â”‚")

    # User Query
    lines.append(" " * (width // 2 - 8) + "â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”")
    lines.append(" " * (width // 2 - 8) + "â”‚  User Query   â”‚")
    lines.append(" " * (width // 2 - 8) + "â””â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”˜")
    lines.append(" " * (width // 2) + "â”‚")

    if config.pattern == AgentPattern.REACT:
        # ReAct loop
        lines.append(" " * (width // 2 - 8) + "â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”")
        lines.append(" " * (width // 2 - 8) + "â”‚    Think      â”‚â—„â”€â”€â”€â”€â”€â”€â”")
        lines.append(" " * (width // 2 - 8) + "â””â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”˜       â”‚")
        lines.append(" " * (width // 2) + "â”‚               â”‚")
        lines.append(" " * (width // 2 - 8) + "â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”       â”‚")
        lines.append(" " * (width // 2 - 8) + "â”‚  Select Tool  â”‚       â”‚")
        lines.append(" " * (width // 2 - 8) + "â””â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”˜       â”‚")
        lines.append(" " * (width // 2) + "â”‚               â”‚")
        ...
        lines.append(" " * (width // 2 - 8) + "â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”       â”‚")
        lines.append(" " * (width // 2 - 8) + "â”‚   Observe     â”‚â”€â”€â”€â”€â”€â”€â”€â”˜")
        lines.append(" " * (width // 2 - 8) + "â””â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”˜")

    elif config.pattern == AgentPattern.PLAN_EXECUTE:
        # Plan phase
        lines.append(" " * (width // 2 - 8) + "â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”")
        lines.append(" " * (width // 2 - 8) + "â”‚  Create Plan  â”‚")
        lines.append(" " * (width // 2 - 8) + "â””â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”˜")
        lines.append(" " * (width // 2) + "â”‚")

        # Execute loop
        lines.append(" " * (width // 2 - 8) + "â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”")
        lines.append(" " * (width // 2 - 8) + "â”‚ Execute Step  â”‚â—„â”€â”€â”€â”€â”€â”€â”")
        lines.append(" " * (width // 2 - 8) + "â””â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”˜       â”‚")
        lines.append(" " * (width // 2) + "â”‚               â”‚")
        ...
        lines.append(" " * (width // 2 - 8) + "â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”       â”‚")
        lines.append(" " * (width // 2 - 8) + "â”‚  Check Done?  â”‚â”€â”€â”€â”€â”€â”€â”€â”˜")
        lines.append(" " * (width // 2 - 8) + "â””â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”˜")

    else:
        # Generic tool use
        lines.append(" " * (width // 2 - 8) + "â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”")
        lines.append(" " * (width // 2 - 8) + "â”‚ Process Query â”‚")
        lines.append(" " * (width // 2 - 8) + "â””â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”˜")
        lines.append(" " * (width // 2) + "â”‚")

        if config.tools:
            for tool in config.tools[:6]:
                lines.append(" " * (width // 2 - 8) + f"â”œâ”€â”€â–¶ [{tool.name}]")
            if len(config.tools) > 6:
                lines.append(" " * (width // 2 - 8) + "â”œâ”€â”€â–¶ [...]")

    # Final answer
    lines.append(" " * (width // 2) + "â”‚")
    lines.append(" " * (width // 2 - 8) + "â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”")
    lines.append(" " * (width // 2 - 8) + "â”‚ Final Answer  â”‚")
    lines.append(" " * (width // 2 - 8) + "â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜")
...
def format_validation_report(config: AgentConfig, result: ValidationResult) -> str:
    ...
    lines.append(f"ðŸ“‹ AGENT INFO")
    lines.append(f"  Name:    {config.name}")
    lines.append(f"  Pattern: {config.pattern.value}")
    lines.append(f"  Model:   {config.model}")
    lines.append("")

    lines.append(f"ðŸ”§ TOOLS ({len(config.tools)} registered)")
    for tool in config.tools:
        status = result.tool_status.get(tool.name, "Unknown")
        emoji = "âœ…" if status.startswith("OK") else "âš ï¸"
        lines.append(f"  {emoji} {tool.name} - {status}")
    lines.append("")

    lines.append("ðŸ“Š FLOW ANALYSIS")
    ...
    lines.append(f"  Potential loop:      {'âš ï¸ Yes' if result.potential_infinite_loop else 'âœ… No'}")
    lines.append("")

    if result.errors:
        lines.append(f"âŒ ERRORS ({len(result.errors)})")
        for error in result.errors:
            lines.append(f"  â€¢ {error}")
        lines.append("")

    if result.warnings:
        lines.append(f"âš ï¸ WARNINGS ({len(result.warnings)})")
    ...
    if result.is_valid:
        ...
        lines.append("âŒ VALIDATION FAILED")
  ...
  - name: calculator
    ...
    if args.estimate_cost:
        ...
        if args.json:
            ...
            output_parts.append("")
            output_parts.append("ðŸ’° COST ESTIMATION")
