...
def format_report(analysis: PromptAnalysis) -> str:
    ...
    report.append(f"  Examples:      {analysis.example_count} {'âœ…' if analysis.has_examples else 'âŒ'}")
    report.append(f"  Output format: {'âœ… Specified' if analysis.has_output_format else 'âŒ Missing'}")
    report.append("")
