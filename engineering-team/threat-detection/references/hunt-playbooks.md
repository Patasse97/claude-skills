...
**MITRE Technique:** T1047 â€” Windows Management Instrumentation
...
- SCCM/Configuration Manager uses WMI heavily for inventory â€” whitelist SCCM service accounts
- Monitoring agents (SolarWinds, Nagios) use WMI for performance data â€” whitelist monitoring identities
...
**MITRE Technique:** T1218 â€” System Binary Proxy Execution
...
|----------|-----------|-------|
| Regular connection interval | Â±10% jitter from mean | Calculate standard deviation of inter-connection times |
...
**MITRE Technique:** T1550.002 â€” Use Alternate Authentication Material: Pass the Hash

**Data Sources Required:**
- Windows Security Event Logs (Event ID 4624 â€” Logon)
...
2. Group by account name â€” flag accounts with authentication events from multiple source IPs within a 1-hour window
...
- Account's normal authentication pattern is Kerberos â€” NTLM is anomalous for this identity
