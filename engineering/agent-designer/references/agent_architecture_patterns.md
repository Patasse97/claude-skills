...
**Structure:** User â†’ Agent â† Tools
**Complexity:** Low
...
**Structure:** User â†’ Supervisor â†’ Specialists
**Complexity:** Medium
...
**Structure:** Agent â†” Agent â†” Agent (interconnected)
**Complexity:** High
...
**Structure:** Executive â†’ Managers â†’ Workers (tree structure)
...
**Structure:** Input â†’ Stage1 â†’ Stage2 â†’ Stage3 â†’ Output
**Complexity:** Medium
