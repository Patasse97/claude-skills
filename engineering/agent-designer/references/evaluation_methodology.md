...
trend_analysis:
  performance_trends:
    success_rate: "â†— +2.3% vs last month"
    response_time: "â†˜ -15% vs last month"
    error_rate: "â†’ stable vs last month"
  
  cost_trends:
    total_cost: "â†— +8% vs last month"
    cost_per_task: "â†˜ -5% vs last month"
    efficiency: "â†— +12% vs last month"
```
