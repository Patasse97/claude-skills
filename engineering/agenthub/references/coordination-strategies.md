...
```
         â”Œâ”€ Agent 1 â”€â”
Task â”€â”€> â”œâ”€ Agent 2 â”€â”¤ â”€â”€> Evaluate â”€â”€> Merge Winner
         â””â”€ Agent 3 â”€â”˜
```
...
```
Round 1:  A1, A2, A3, A4  â†’  Eval  â†’  A2, A4 advance
Round 2:  A2, A4           â†’  Eval  â†’  A2 wins
```
...
Agent 2: solves API routes       â”€â”€> Cherry-pick all â”€â”€> Combined result
...
Agents work sequentially â€” each builds on the previous agent's output. Like a relay race.

```
Agent 1 (design) â†’ Agent 2 (implement) â†’ Agent 3 (test) â†’ Agent 4 (optimize)
```

**When to use**: Tasks with natural phases (design â†’ implement â†’ test). Each phase needs different expertise.
...
1. **Correctness** â€” Does it solve the stated task?
2. **Completeness** â€” Does it handle edge cases?
3. **Simplicity** â€” Fewer lines changed = less risk
4. **Quality** â€” Clean execution, good structure, no anti-patterns
5. **Performance** â€” Efficient algorithms and data structures
...
Action:
  ...
  2. Archive session (state â†’ archived)
...
- **Confidence**: {High/Medium/Low} â€” {reason}
