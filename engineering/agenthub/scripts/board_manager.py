...
def run_demo():
    """Show demo output."""
    print("=" * 60)
    print("AgentHub Board Manager â€” Demo Mode")
    print("=" * 60)
    print()
    ...
    print("- **Confidence**: Medium â€” 2 edge cases not covered")
    print()
    print("--- 002-agent-2-20260317T143645Z.md (by agent-2, 2026-03-17T14:36:45Z) ---")
    print("## Result Summary")
    print()
    print("- **Approach**: Replaced O(nÂ²) sort with hash map lookup")
    print("- **Files changed**: 2")
    print("- **Metric**: 142ms (baseline: 180ms, delta: -38ms)")
    print("- **Confidence**: High â€” all tests pass")
    print()
    ...
    print("- **Confidence**: Low â€” no meaningful improvement")
