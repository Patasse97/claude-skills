...
def run_demo():
    ...
    print("=" * 60)
    print("AgentHub Init â€” Demo Mode")
    print("=" * 60)
    print()
    ...
    print("  â”‚   â””â”€â”€ 20260317-143022/")
    print("  â”‚       â”œâ”€â”€ config.yaml")
    print("  â”‚       â””â”€â”€ state.json")
    print("  â””â”€â”€ board/")
    print("      â”œâ”€â”€ _index.json")
    print("      â”œâ”€â”€ dispatch/")
    print("      â”œâ”€â”€ progress/")
    print("      â””â”€â”€ results/")
    print()
    print("config.yaml:")
