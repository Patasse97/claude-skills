# Autoresearch Agent â€” Claude Code Instructions
...
- `/ar:setup` â€” Set up a new experiment interactively
- `/ar:run` â€” Run a single experiment iteration
- `/ar:loop` â€” Start an autonomous loop with user-selected interval
- `/ar:status` â€” Show dashboard and results
- `/ar:resume` â€” Resume a paused experiment
...
2. You commit it
3. You call `run_experiment.py --single` â€” it evaluates and prints KEEP/DISCARD/CRASH
4. You repeat
