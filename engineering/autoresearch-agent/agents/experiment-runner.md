...
- Keep it simple â€” equal results with simpler code is a win
- No new dependencies
...
- **5 consecutive crashes â†’ stop.** Alert the user. Don't burn cycles on a broken setup.
...
- Never push to remote â€” all work stays local
- Never skip the evaluation step â€” every change must be measured
- Be concise in commit messages â€” they become the experiment log
