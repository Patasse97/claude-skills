...
# The judge prompt is FIXED â€” the agent cannot change how it's evaluated
JUDGE_PROMPT = """You are a content quality evaluator. Score the following content strictly.

Criteria (each scored 1-10):

1. CURIOSITY GAP â€” Does this make you want to click? Is there an information gap
   that can only be resolved by reading? Generic titles score 1-3. Specific,
   intriguing titles score 7-10.

2. SPECIFICITY â€” Are there concrete numbers, tools, or details? "How I improved
   performance" = 2. "How I reduced API latency from 800ms to 185ms" = 9.

3. EMOTIONAL PULL â€” Does it trigger curiosity, surprise, fear of missing out,
   or recognition? Flat titles score 1-3. Emotionally charged score 7-10.

4. SCROLL-STOP POWER â€” Would this stop someone scrolling through a feed or
   search results? Would they pause on this headline? Rate honestly.

5. SEO KEYWORD PRESENCE â€” Are searchable, high-intent terms present naturally?
...
# Parse output â€” look for ctr_score line
