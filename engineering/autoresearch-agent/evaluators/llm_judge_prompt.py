...
1. ACCURACY â€” Does it match the expected output's intent and facts?
2. COMPLETENESS â€” Does it cover all required elements?
3. CLARITY â€” Is it well-structured and easy to understand?
4. INSTRUCTION_FOLLOWING â€” Does it follow the system prompt's guidelines?
...
quality = avg * 10  # 1-10 scores â†’ 10-100 range
