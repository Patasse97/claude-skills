...
GITIGNORE_CONTENT = """# autoresearch â€” experiment logs are local state
**/results.tsv
**/run.log
**/run.*.log
config.yaml
...
- Dependencies â€” do not add new packages or imports that aren't already available.
...
2. Profile/analyze the current state â€” understand why the metric is what it is.
