...
This reference covers techniques to make Playwright automation less detectable by anti-bot services. These are defense-in-depth measures â€” no single technique is sufficient, but combining them significantly reduces detection risk.
...
1. **navigator.webdriver** â€” Set to `true` by all automation frameworks
2. **User-Agent string** â€” Default headless UA contains "HeadlessChrome"
3. **WebGL renderer** â€” Headless Chrome reports "SwiftShader" or "Google SwiftShader"

### Tier 2: Common Detection (Most Anti-Bot Services)
4. **Viewport/screen dimensions** â€” Unusual sizes flag automation
5. **Plugins array** â€” Empty in headless mode, populated in real browsers
6. **Languages** â€” Missing or mismatched locale
7. **Request timing** â€” Machine-speed interactions
8. **Mouse movement** â€” No mouse events between clicks

### Tier 3: Advanced Detection (Cloudflare, DataDome, PerimeterX)
9. **Canvas fingerprint** â€” Headless renders differently
10. **WebGL fingerprint** â€” GPU-specific rendering variations
11. **Audio fingerprint** â€” AudioContext processing differences
12. **Font enumeration** â€” Different available fonts in headless
13. **Behavioral analysis** â€” Scroll patterns, click patterns, reading time
...
Do NOT pass these flags â€” they are headless-detection signals:
...
- `https://bot.sannysoft.com/` â€” Comprehensive bot detection test
- `https://abrahamjuliot.github.io/creepjs/` â€” Advanced fingerprint analysis
- `https://browserleaks.com/webgl` â€” WebGL fingerprint details
- `https://browserleaks.com/canvas` â€” Canvas fingerprint details
...
1. **WebDriver flag removal** â€” Critical, takes 2 lines
2. **Custom user agent** â€” Critical, takes 1 line
3. **Viewport configuration** â€” High priority, takes 1 line
4. **Request delays** â€” High priority, add random.uniform() calls
5. **Navigator properties** â€” Medium priority, init script block
6. **Chrome channel** â€” Medium priority, one launch option
7. **WebGL override** â€” Low priority unless hitting advanced anti-bot
8. **Canvas noise** â€” Low priority unless hitting advanced anti-bot
9. **Proxy rotation** â€” Only for high-volume or repeated scraping
10. **Behavioral simulation** â€” Only for sites with behavioral analysis
