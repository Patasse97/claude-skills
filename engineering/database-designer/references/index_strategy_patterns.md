...
-- âœ“ Uses index: WHERE last_name = 'Smith'
-- âœ“ Uses index: WHERE last_name = 'Smith' AND first_name = 'John'  
-- âœ“ Uses index: WHERE last_name = 'Smith' AND first_name = 'John' AND email = 'john@...'
-- âœ— Cannot use index: WHERE first_name = 'John'
-- âœ— Cannot use index: WHERE email = 'john@...'
```
