...
|----------------|-----|------------|-------|----------|----------|---------|---------|---------|----------|
| **MIT**        | âœ…   | âœ…          | âœ…     | âš ï¸        | âš ï¸        | âš ï¸       | âŒ       | âŒ       | âŒ        |
| **Apache-2.0** | âœ…   | âœ…          | âœ…     | âŒ        | âš ï¸        | âœ…       | âŒ       | âš ï¸       | âš ï¸        |
| **BSD-3**      | âœ…   | âœ…          | âœ…     | âš ï¸        | âš ï¸        | âš ï¸       | âŒ       | âŒ       | âŒ        |
| **LGPL-2.1**   | âœ…   | âŒ          | âœ…     | âœ…        | âŒ        | âŒ       | âœ…       | âŒ       | âŒ        |
| **LGPL-3.0**   | âœ…   | âœ…          | âœ…     | âŒ        | âœ…        | âœ…       | âŒ       | âœ…       | âœ…        |
| **MPL-2.0**    | âœ…   | âœ…          | âœ…     | âŒ        | âœ…        | âœ…       | âŒ       | âœ…       | âœ…        |
| **GPL-2.0**    | âœ…   | âŒ          | âœ…     | âœ…        | âŒ        | âŒ       | âœ…       | âŒ       | âŒ        |
| **GPL-3.0**    | âœ…   | âœ…          | âœ…     | âŒ        | âœ…        | âœ…       | âŒ       | âœ…       | âœ…        |
| **AGPL-3.0**   | âœ…   | âœ…          | âœ…     | âŒ        | âœ…        | âœ…       | âŒ       | âœ…       | âœ…        |

**Legend:**
- âœ… Generally Compatible
- âš ï¸ Compatible with conditions/restrictions
- âŒ Incompatible
...
â”œâ”€ YES â†’ Is your project commercial/proprietary?
â”‚   â”œâ”€ YES â†’ âŒ Incompatible (find alternative)
â”‚   â””â”€ NO â†’ âœ… Compatible (if same GPL version)
â””â”€ NO â†’ Is it permissive (MIT/Apache/BSD)?
    â”œâ”€ YES â†’ âœ… Generally compatible
    â””â”€ NO â†’ Check specific compatibility matrix
```
