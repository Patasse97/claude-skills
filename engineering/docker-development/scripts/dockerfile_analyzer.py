...
ANTI_PATTERNS = [
    {
        ...
        "message": "Using :latest tag â€” pin to a specific version for reproducibility",
    ...
    },
    {
        ...
        "message": "No tag specified on base image â€” defaults to :latest",
    ...
    },
    {
        ...
        "message": "apt-get install without cleanup in same layer â€” bloats image",
    ...
    },
    {
        ...
        "message": "apk add without --no-cache â€” retains package index",
    ...
    },
    {
        ...
        "message": "Using ADD for local files â€” COPY is more explicit and predictable",
    ...
    },
    {
        ...
        "message": "Multiple CMD instructions â€” only the last one takes effect",
    ...
    },
    {
        ...
        "message": "Secrets in ENV/ARG â€” baked into image layers and visible in history",
    ...
    },
    {
        ...
        "severity": "medium",
        "pattern": r"^COPY\s+\.\s+\.",
        "message": "COPY . . copies everything â€” may include secrets, git history, node_modules",
    ...
    },
    {
        ...
        "severity": "critical",
        "pattern": None,  # Custom check
        "message": "No USER instruction â€” container runs as root",
    ...
    },
    {
        ...
        "message": "pip install without --no-cache-dir â€” retains pip cache in layer",
    ...
    },
    {
        ...
        "message": "npm install includes devDependencies â€” use npm ci --omit=dev for production",
    ...
    },
    {
        ...
        "message": "Exposing many ports â€” only expose what the application actually needs",
    ...
    },
    {
        ...
        "message": "Download without cleanup â€” downloaded archives may remain in layer",
    ...
    },
    {
        ...
        "severity": "medium",
        "pattern": None,  # Custom check
        "message": "No HEALTHCHECK instruction â€” orchestrators can't determine container health",
    ...
    },
    {
        ...
        "message": "Using shell form for CMD/ENTRYPOINT â€” exec form is preferred for signal handling",
