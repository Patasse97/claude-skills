...
â”œâ”€â”€ Chart.yaml
â”œâ”€â”€ values.yaml
â”œâ”€â”€ values.schema.json      # JSON Schema validation
â”œâ”€â”€ .helmignore
â”œâ”€â”€ templates/
...
â””â”€â”€ charts/                  # Managed by helm dependency update
```

---

## _helpers.tpl â€” Standard Helpers
...
- **Name truncation** â€” Kubernetes names max at 63 characters. Always trunc.
- **Selector labels separate from common labels** â€” selectors are immutable after creation. Adding `app.kubernetes.io/version` to selectors breaks upgrades.
- **nameOverride vs fullnameOverride** â€” `nameOverride` replaces the chart name portion, `fullnameOverride` replaces everything.
...
```yaml
# values.yaml â€” subchart values go under the dependency name
postgresql:
  enabled: true
  auth:
    database: myapp
...
| Upgrade fails on selector change | Selector labels changed between versions | Never change selectorLabels â€” they're immutable |
