...
REQUIRED_FILES = [
    {"path": "Chart.yaml", "severity": "critical", "message": "Missing Chart.yaml â€” not a valid Helm chart"},
    {"path": "values.yaml", "severity": "high", "message": "Missing values.yaml â€” chart has no configurable defaults"},
    {"path": "templates/_helpers.tpl", "severity": "high", "message": "Missing _helpers.tpl â€” no shared label/name helpers"},
    {"path": "templates/NOTES.txt", "severity": "medium", "message": "Missing NOTES.txt â€” no post-install instructions for users"},
    {"path": ".helmignore", "severity": "low", "message": "Missing .helmignore â€” CI files, .git, tests may be packaged"},
]
...
CHART_YAML_CHECKS = [
    ...
    {"field": "appVersion", "severity": "medium", "message": "Missing appVersion in Chart.yaml â€” operators won't know what app version is deployed"},
    {"field": "type", "severity": "low", "message": "Missing type in Chart.yaml â€” defaults to 'application'"},
]
...
TEMPLATE_ANTI_PATTERNS = [
    {
        ...
        "message": "Hardcoded image tag in template â€” must use .Values.image.repository and .Values.image.tag",
    ...
    },
    {
        ...
        "message": "Hardcoded replica count â€” must be configurable via values",
    ...
    },
    {
        ...
        "message": "Hardcoded port number â€” should be configurable via values",
    ...
    },
    {
        ...
        "message": "Hardcoded name/namespace â€” should use template helpers",
    ...
    },
    {
        ...
        "message": "Hardcoded nodePort â€” should be configurable or avoided",
...
SECURITY_CHECKS = [
    {
        ...
        "message": "No securityContext found in any template â€” pods run as root with full capabilities",
    ...
    },
    {
        ...
        "message": "Privileged container detected â€” full host access",
    ...
    },
    {
        ...
        "message": "No runAsNonRoot: true â€” container may run as root",
    ...
    },
    {
        ...
        "message": "No readOnlyRootFilesystem â€” container filesystem is writable",
    ...
    },
    {
        ...
        "message": "No NetworkPolicy template â€” all pod-to-pod traffic allowed",
    ...
    },
    {
        ...
        "message": "automountServiceAccountToken not set to false â€” pod can access K8s API",
    ...
    },
    {
        ...
        "severity": "high",
        "check": "host_network",
        "message": "hostNetwork: true â€” pod shares host network namespace",
    ...
    },
    {
        ...
        "severity": "critical",
        "check": "host_pid_ipc",
        "message": "hostPID or hostIPC enabled â€” pod can see host processes/IPC",
        "fix": "Remove hostPID and hostIPC â€” never needed in application charts",
    },
]
...
def check_chart_yaml(chart_dir):
    ...
    if parsed.get("apiVersion") == "v1":
        findings.append({
            "id": "CY007",
            "severity": "medium",
            "message": "apiVersion: v1 is Helm 2 format â€” use v2 for Helm 3",
...
def check_templates(chart_dir):
    ...
    if "resources:" not in all_content and template_files:
        findings.append({
            "id": "TP006",
            "severity": "critical",
            "message": "No resource requests/limits in any template â€” pods can consume unlimited node resources",
    ...
    if "livenessProbe" not in all_content and "readinessProbe" not in all_content and template_files:
        ...
        if has_deployment:
            findings.append({
                "id": "TP007",
                "severity": "high",
                "message": "No liveness/readiness probes â€” Kubernetes cannot detect unhealthy pods",
