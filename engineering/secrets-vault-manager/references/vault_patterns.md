...
â”‚  â”‚  (active)  â”‚  â”‚ (forward) â”‚  â”‚ (forward) â”‚   â”‚
â”‚  â””â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”˜  â””â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”˜  â””â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”˜   â”‚
â”‚        â”‚               â”‚               â”‚         â”‚
â”‚  â”Œâ”€â”€â”€â”€â”€â”´â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”´â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”´â”€â”€â”€â”€â”€â”   â”‚
â”‚  â”‚            Raft Storage Backend            â”‚   â”‚
â”‚  â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜   â”‚
â”‚                                                   â”‚
â”‚  â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”  â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”  â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”   â”‚
â”‚  â”‚ Auth     â”‚  â”‚ Secret   â”‚  â”‚ Audit        â”‚   â”‚
â”‚  â”‚ Methods  â”‚  â”‚ Engines  â”‚  â”‚ Devices      â”‚   â”‚
...
|---------|-----------|----------------------|----------------|
| Integrated Raft | Yes | Low | **Default choice** â€” no external dependencies |
| Consul | Yes | Medium | Legacy â€” use Raft unless already running Consul |
| S3/GCS/Azure Blob | No | Low | Dev/test only â€” no HA |
| PostgreSQL/MySQL | No | Medium | Not recommended â€” no HA, added dependency |
...
- KMS key should have restricted access â€” only Vault nodes
...
1. **Global deny** â€” Explicit deny on `sys/*`, `auth/token/create-orphan`
2. **Environment base** â€” Read access to environment-specific paths
3. **Service-specific** â€” Scoped to exact paths the service needs
4. **Admin override** â€” Requires MFA, time-limited, audit-heavy
...
Wrap sensitive responses in a single-use token â€” the recipient unwraps exactly once:
...
# Status codes:
# 200 â€” initialized, unsealed, active
# 429 â€” unsealed, standby
# 472 â€” disaster recovery secondary
# 473 â€” performance standby
# 501 â€” not initialized
# 503 â€” sealed
```
