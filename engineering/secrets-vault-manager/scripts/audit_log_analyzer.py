...
Fields are optional â€” the analyzer works with whatever is available.
"""
...
def analyze(entries, threshold):
    ...
    # 1. Volume spikes â€” identities accessing secrets more than threshold * average
    ...
    # 2. Multi-IP access â€” single identity from many IPs
    ...
    # 5. Broad path access â€” single identity touching many paths
...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=5,
        help="Anomaly sensitivity threshold â€” lower = more sensitive (default: 5)",
    )
