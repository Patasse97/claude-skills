#!/usr/bin/env python3
"""
Skill Security Auditor â€” Scan AI agent skills for security risks before installation.
...
CODE_PATTERNS = [
    ...
    },
    {
        ...
        "fix": "Remove exec() â€” rewrite logic to avoid dynamic code execution",
    },
    {
        ...
        "fix": "Remove compile() with exec mode â€” use explicit logic instead",
    },
    {
        "regex": r"\b__import__\s*\(",
        "category": "CODE-EXEC",
        "severity": Severity.CRITICAL,
        "risk": "Dynamic module import â€” can load arbitrary code",
    ...
    # Obfuscation â€” CRITICAL
    {
        "regex": r"\bbase64\.b64decode\s*\(",
        "category": "OBFUSCATION",
        "severity": Severity.CRITICAL,
        "risk": "Base64 decoding â€” may hide malicious payloads",
    ...
    },
    {
        ...
        "category": "OBFUSCATION",
        "severity": Severity.CRITICAL,
        "risk": "Codec decoding â€” may hide obfuscated payloads",
    ...
    },
    {
        ...
        "category": "OBFUSCATION",
        "severity": Severity.CRITICAL,
        "risk": "Long hex-encoded string â€” likely obfuscated payload",
    ...
    },
    {
        ...
        "category": "OBFUSCATION",
        "severity": Severity.CRITICAL,
        "risk": "Character-by-character string construction â€” obfuscation technique",
    ...
    },
    {
        ...
        "category": "OBFUSCATION",
        "severity": Severity.HIGH,
        "risk": "Hex byte decoding â€” may hide payloads",
        "fix": "Review the hex content and replace with readable code",
    },
    # Network exfiltration â€” CRITICAL
    {
        "regex": r"\brequests\.(?:post|put|patch)\s*\(",
        "category": "NET-EXFIL",
        "severity": Severity.CRITICAL,
        "risk": "Outbound HTTP write request â€” potential data exfiltration",
    ...
    },
    {
        ...
        "category": "NET-EXFIL",
        "severity": Severity.CRITICAL,
        "risk": "Raw socket connection â€” potential C2 or exfiltration channel",
    ...
    },
    {
        ...
        "category": "NET-EXFIL",
        "severity": Severity.CRITICAL,
        "risk": "Async HTTP client â€” potential exfiltration",
    ...
    },
    {
        ...
        "category": "NET-READ",
        "severity": Severity.HIGH,
        "risk": "Outbound HTTP GET request â€” may download malicious payloads",
        "fix": "Verify the URL is trusted and necessary for skill functionality",
    },
    # Credential harvesting â€” CRITICAL
    {
    ...
    },
    {
        ...
        "fix": "Remove keyring access â€” skills should not access system credential stores",
    },
    # File system abuse â€” HIGH
    {
    ...
    },
    {
        ...
        "category": "FS-ABUSE",
        "severity": Severity.CRITICAL,
        "risk": "Modifies shell configuration â€” potential persistence mechanism",
    ...
    },
    {
        ...
        "category": "FS-ABUSE",
        "severity": Severity.HIGH,
        "risk": "Creates symbolic links â€” potential directory traversal attack",
    ...
    },
    {
        ...
        "category": "FS-ABUSE",
        "severity": Severity.HIGH,
        "risk": "Recursive directory deletion â€” destructive operation",
    ...
    },
    {
        ...
        "category": "FS-ABUSE",
        "severity": Severity.HIGH,
        "risk": "File deletion â€” verify target is within skill scope",
    ...
    # Privilege escalation â€” CRITICAL
    {
        ...
        "category": "PRIV-ESC",
        "severity": Severity.CRITICAL,
        "risk": "Sudo invocation â€” privilege escalation attempt",
    ...
    },
    {
        ...
        "category": "PRIV-ESC",
        "severity": Severity.CRITICAL,
        "risk": "UID manipulation â€” privilege escalation",
    ...
    },
    {
        ...
        "category": "PRIV-ESC",
        "severity": Severity.CRITICAL,
        "risk": "Cron job manipulation â€” persistence mechanism",
        "fix": "Remove cron manipulation. Skills should not modify scheduled tasks",
    },
    # Unsafe deserialization â€” HIGH
    {
        "regex": r"\bpickle\.loads?\s*\(",
        "category": "DESERIAL",
        "severity": Severity.HIGH,
        "risk": "Pickle deserialization â€” can execute arbitrary code",
    ...
    },
    {
        ...
        "category": "DESERIAL",
        "severity": Severity.HIGH,
        "risk": "Unsafe YAML loading â€” can execute arbitrary code",
    ...
    },
    {
        ...
        "category": "DESERIAL",
        "severity": Severity.HIGH,
        "risk": "Marshal deserialization â€” can execute arbitrary code",
        "fix": "Use json.loads() or other safe serialization formats",
    },
    {
        ...
        "category": "DESERIAL",
        "severity": Severity.HIGH,
        "risk": "Shelve uses pickle internally â€” can execute arbitrary code",
...
PROMPT_INJECTION_PATTERNS = [
    ...
    },
    {
        ...
        "category": "PROMPT-OVERRIDE",
        "severity": Severity.CRITICAL,
        "risk": "Role hijacking â€” attempts to redefine the AI's identity",
    ...
    # Hidden instructions â€” HIGH
    {
        "regex": r"[\u200b\u200c\u200d\ufeff\u00ad]",
        "category": "HIDDEN-INSTR",
        "severity": Severity.HIGH,
        "risk": "Zero-width or invisible characters â€” may hide instructions",
    ...
    },
    {
        ...
        "category": "EXCESS-PERM",
        "severity": Severity.HIGH,
        "risk": "Blanket approval directive â€” bypasses human oversight",
...
# Known typosquatting targets (popular package â†’ common misspellings)
TYPOSQUAT_TARGETS = {
...
SHELL_PATTERNS = [
    # Bash-specific patterns
    {
        ...
        "category": "CMD-INJECT",
        "severity": Severity.CRITICAL,
        "risk": "Pipe-to-shell pattern â€” downloads and executes arbitrary code",
    ...
    },
    {
        ...
        "category": "FS-ABUSE",
        "severity": Severity.CRITICAL,
        "risk": "Recursive deletion from root â€” catastrophic data loss",
    ...
    },
    {
        ...
        "category": "PRIV-ESC",
        "severity": Severity.CRITICAL,
        "risk": "Setting SUID bit â€” privilege escalation",
    ...
    },
    {
        ...
        "category": "FS-ABUSE",
        "severity": Severity.CRITICAL,
        "risk": "Direct write to block device â€” data destruction",
    ...
    },
    {
        ...
        "category": "NET-EXFIL",
        "severity": Severity.CRITICAL,
        "risk": "Netcat listener/connection â€” potential reverse shell or exfiltration",
...
JS_PATTERNS = [
    {
        ...
        "category": "CMD-INJECT",
        "severity": Severity.CRITICAL,
        "risk": "Node.js child_process â€” command execution",
    ...
    },
    {
        ...
        "category": "CODE-EXEC",
        "severity": Severity.CRITICAL,
        "risk": "Dynamic Function constructor â€” equivalent to eval()",
            ...
            if pkg_name in all_typosquats:
                report.findings.append(
                    Finding(
                        ...
                        line=i,
                        pattern=line,
                        risk=f"Possible typosquatting â€” did you mean '{all_typosquats[pkg_name]}'?",
            ...
            if pkg_name and "==" not in line and pkg_name not in (".", "-e", "-r"):
                report.findings.append(
                    Finding(
                        ...
                        line=i,
                        pattern=line,
                        risk="Unpinned dependency â€” may pull vulnerable versions",
            ...
            if re.search(r"\bpip\s+install\b", line):
                report.findings.append(
                    Finding(
                        ...
                        line=i,
                        pattern=line.strip()[:120],
                        risk="Runtime package installation â€” may install untrusted code",
        ...
        if item.name.startswith(".") and item.name not in (
            ...
            report.findings.append(
                Finding(
                    ...
                    line=0,
                    pattern=item.name,
                    risk=f"Hidden file '{item.name}' â€” may contain secrets or hidden config",
        ...
        if item.is_file() and item.suffix.lower() in (
            ...
            report.findings.append(
                Finding(
                    ...
                    line=0,
                    pattern=item.name,
                    risk="Binary executable in skill â€” high risk of malicious payload",
                ...
                if size > 1_000_000:
                    report.findings.append(
                        Finding(
                            ...
                            risk="Large file â€” may hide payloads or bloat installation",
                ...
                if not str(target).startswith(str(skill_path.resolve())):
                    report.findings.append(
                        Finding(
                            ...
                            line=0,
                            pattern=f"â†’ {target}",
                            risk="Symlink points outside skill directory â€” directory traversal risk",
                ...
                if mode & (stat.S_ISUID | stat.S_ISGID):
                    report.findings.append(
                        Finding(
                            ...
                            risk="SUID/SGID bit set â€” privilege escalation risk",
    ...
    if not skill_md.exists():
        report.findings.append(
            Finding(
                ...
                risk="Missing SKILL.md â€” not a valid skill directory",
...
def print_report(report: AuditReport):
    ...
    verdict_symbols = {"PASS": "âœ…", "WARN": "âš ï¸", "FAIL": "âŒ"}
    v = report.verdict
    sym = verdict_symbols[v]

    print()
    print("â•”" + "â•" * 54 + "â•—")
    print(f"â•‘  SKILL SECURITY AUDIT REPORT{' ' * 25}â•‘")
    print(f"â•‘  Skill: {report.skill_name:<44} â•‘")
    print(f"â•‘  Verdict: {sym} {v:<42}â•‘")
    print("â• " + "â•" * 54 + "â•£")
    print(
        f"â•‘  ðŸ”´ CRITICAL: {report.critical_count:<3} "
        f"ðŸŸ¡ HIGH: {report.high_count:<3} "
        f"âšª INFO: {report.info_count:<3}{' ' * 10}â•‘"
    )
    print(
        f"â•‘  Files: {report.files_scanned}  "
        f"Scripts: {report.scripts_scanned}  "
        f"Markdown: {report.md_files_scanned}{' ' * (17 - len(str(report.files_scanned)) - len(str(report.scripts_scanned)) - len(str(report.md_files_scanned)))}â•‘"
    )
    print("â•š" + "â•" * 54 + "â•")
...
def main():
    parser = argparse.ArgumentParser(
        description="Skill Security Auditor â€” Scan skills for security risks before installation"
    )
    parser.add_argument(
        "path",
    ...
    parser.add_argument(
        "--strict",
        action="store_true",
        help="Strict mode â€” any WARN becomes FAIL",
    )
    parser.add_argument(
        "--json",
        action="store_true",
