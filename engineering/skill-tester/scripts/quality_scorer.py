...
Changelog:
  v2.0.0 - Added Security dimension (opt-in via --include-security flag)
           Default: 4 dimensions Ã— 25% (backward compatible)
           With --include-security: 5 dimensions Ã— 20%
...
Quality Dimensions (default: 4 dimensions Ã— 25%):
...
Letter Grades: A+ (95+), A (90+), A- (85+), B+ (80+), B (75+), B- (70+), C+ (65+), C (60+), C- (55+), D (50+), F (<50)
    ...
    parser.add_argument("--include-security",
                       action="store_true",
                       help="Include Security dimension (switches to 5 dimensions Ã— 20%% each)")
