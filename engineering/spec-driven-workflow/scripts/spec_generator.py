...
- OS-1: [Feature/capability] â€” [reason for exclusion or link to future spec].
- OS-2: [Feature/capability] â€” [reason for exclusion].
- OS-3: [Feature/capability] â€” deferred to [version/sprint].
...
- [ ] Q1: [Question] â€” Owner: [name], Due: [date]
- [ ] Q2: [Question] â€” Owner: [name], Due: [date]
"""
