...
### TypeORM â€” relations / query builder
```typescript
// FindOptions
...
### SQLAlchemy â€” joinedload / selectinload
```python
...
1. **Always use migrations** â€” never modify production schemas by hand
2. **Eager load relations** â€” prevent N+1 in every list/collection query
3. **Use transactions** â€” group related writes to maintain consistency
4. **Parameterize raw SQL** â€” never concatenate user input into queries
5. **Connection pooling** â€” configure pool size matching your workload
6. **Index foreign keys** â€” ORMs often skip this; add manually if needed
7. **Review generated SQL** â€” enable query logging in development to catch inefficiencies
8. **Type-safe queries** â€” leverage TypeScript/Python typing for compile-time checks
9. **Separate read/write models** â€” use views or read replicas for heavy reporting queries
10. **Test migrations both ways** â€” always verify that down migrations actually reverse up migrations
