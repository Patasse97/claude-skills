...
def format_dashboard_report(dashboard_data: Dict[str, Any]) -> str:
    ...
    output.append(f"  â€¢ Total Debt Items: {exec_summary['total_debt_items']}")
    output.append(f"  â€¢ High Priority Items: {exec_summary['high_priority_items']}")
    output.append(f"  â€¢ Estimated Effort: {exec_summary['estimated_effort_hours']:.1f} hours")
    output.append(f"  â€¢ Velocity Impact: {exec_summary['velocity_impact_percent']:.1f}%")
    output.append("")
