...
IAM_PATTERNS = [
    {
        ...
        "message": "IAM policy with wildcard Action = \"*\" â€” grants all permissions",
    ...
    },
    {
        ...
        "message": "IAM policy with wildcard Resource = \"*\" â€” applies to all resources",
    ...
    },
    {
        ...
        "message": "IAM policy with Action=* AND Resource=* â€” effectively admin access",
        ...
        if any(s in name_lower for s in secret_names):
            ...
            if default_match and len(default_match.group(1)) > 0:
                findings.append({
                    ...
                    "fix": "Remove the default value â€” require it to be passed at runtime via tfvars or env",
