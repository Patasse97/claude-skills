# Automated Invoice Processing â€” MVP User Stories
...
**Primary Persona:** Accounts Payable Clerk â€” processes 50-200 invoices/month, needs speed and accuracy, uses QuickBooks/Xero/NetSuite.
...
1. **Given** a PDF invoice is uploaded and queued, **When** extraction completes, **Then** the system populates: vendor name, invoice number, invoice date, due date, subtotal, tax amount, total amount, and currency â€” each with a confidence score (0-100%).
...
5. **Given** the user wants to skip review, **When** all fields have confidence â‰¥95%, **Then** the invoice is auto-marked "Verified" and available for immediate export.
