...
```
Week 1: startup-cto + engineering skills â†’ Build the thing
Week 2: growth-marketer + marketing skills â†’ Prepare the launch
Week 3: solo-founder + business skills â†’ Ship and iterate
```
...
```
1. content-strategy/SKILL.md â†’ Identify topics and angles
2. copywriting/SKILL.md â†’ Write the content
3. seo-audit/SKILL.md â†’ Optimize for search
4. analytics-tracking/SKILL.md â†’ Set up measurement
```
...
Persona: startup-cto
Skills:
  - aws-solution-architect â†’ Infrastructure
  - senior-frontend â†’ UI implementation
...
Persona: growth-marketer
Skills:
  - launch-strategy â†’ Launch plan and timeline
  - copywriting â†’ Landing page, emails
  - content-strategy â†’ Blog posts, social content
  - seo-audit â†’ Technical SEO for landing page
...
Persona: solo-founder
Skills:
  - email-sequence â†’ Drip campaign
  - analytics-tracking â†’ Conversion tracking
  - ab-test-setup â†’ Landing page variants
...
Persona: solo-founder
Skills:
  - form-cro â†’ Optimize signup flow
  - copy-editing â†’ Refine messaging based on feedback
...
### Available Skills
See the [skill catalog](../README.md) â€” 177 skills across 12 domains.
