...
```
Sprint Capacity = (Team Members Ã— Sprint Days Ã— Hours/Day Ã— Focus Factor)
                  Ã· Hours per Story Point
...
Story Selection:
[H] US-001: User dashboard (5 pts) â† Committed
[H] US-002: Export feature (3 pts) â† Committed
[H] US-003: Search filter (5 pts) â† Committed
[M] US-004: Settings page (5 pts) â† Committed
[M] US-005: Help tooltips (3 pts) â† Committed
[L] US-006: Theme options (2 pts) â† Committed
------------------------
Committed Total: 23 points

[L] US-007: Sort options (2 pts) â† Stretch
[L] US-008: Print view (2 pts) â† Stretch
------------------------
...
Example:
Feature A: CoD = 13, Duration = 5 â†’ WSJF = 2.6
Feature B: CoD = 8, Duration = 2 â†’ WSJF = 4.0 â† Higher priority
```
