...
| **S**mall | Can this be completed in one sprint? | â‰¤8 story points typically |
...
| Technique | Example |
|-----------|---------|
| By workflow step | "Create order" â†’ "Add items" + "Apply discount" + "Submit order" |
| By persona | "User dashboard" â†’ "Admin dashboard" + "Member dashboard" |
| By data type | "Import data" â†’ "Import CSV" + "Import Excel" |
| By operation | "Manage users" â†’ "Add user" + "Edit user" + "Delete user" |
| By platform | "Mobile support" â†’ "iOS support" + "Android support" |
| Happy path first | "Full feature" â†’ "Basic feature" + "Error handling" + "Edge cases" |
