...
|-------|------|----------|---------|---------|-------|
| Keyword | Text input | No | â€” | â€” | Searches name and email |
...
| Delete | ADMIN only | Confirmation dialog â†’ soft delete |
...
| Delete user | DELETE | /api/users/:id | Confirm delete | â€” |
