# My App â€” Product Requirements Document
...
|---|-----------|-------|--------|----------|
| 1 | Home | / | â€” | [â†’](./pages/01-home.md) |
| 2 | Dashboard | /dashboard | Dashboard | [â†’](./pages/02-dashboard.md) |
| 3 | User List | /users | User Mgmt | [â†’](./pages/03-user-list.md) |
| 4 | User Detail | /users/:id | User Mgmt | [â†’](./pages/04-user-detail.md) |
| 5 | Settings | /settings | Settings | [â†’](./pages/05-settings.md) |
