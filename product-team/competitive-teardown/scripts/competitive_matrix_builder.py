#!/usr/bin/env python3
"""Competitive Matrix Builder â€” Analyze and score competitors across feature dimensions.
...
def format_text(result: Dict[str, Any]) -> str:
    ...
    for i, c in enumerate(result["scored_competitors"], 1):
        marker = " â† YOU" if c.get("is_you") else ""
    ...
    if result.get("gap_analysis"):
        ...
        if ga["biggest_opportunities"]:
            ...
            for opp in ga["biggest_opportunities"]:
                lines.append(f"  â€¢ {opp['dimension']}: You={opp['your_score']}, "
        ...
        if ga["competitive_advantages"]:
            ...
            for adv in ga["competitive_advantages"]:
                lines.append(f"  â€¢ {adv['dimension']}: You={adv['your_score']}, "
