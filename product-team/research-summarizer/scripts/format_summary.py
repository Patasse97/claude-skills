...
TEMPLATES = {
    ...
    "report": {
        ...
        "sections": [
            ...
            ("Methodology", "[How data was collected â€” survey, analysis, case study]"),
            ...
            ("Relevance", "[Why this matters for our context â€” specific applicability]"),
            ("Quality Assessment", "Credibility: [High/Med/Low] | Evidence: [High/Med/Low] | Recency: [High/Med/Low] | Objectivity: [High/Med/Low]"),
        ],
    },
    "executive": {
        ...
        "sections": [
            ...
            ("Confidence", "[High/Medium/Low] â€” based on source quality and evidence strength"),
        ],
    },
    "comparison": {
        ...
        "sections": [
            ...
            ("Sources Compared", "1. [Source A â€” Author, Year]\n2. [Source B â€” Author, Year]\n3. [Source C â€” Author, Year]"),
            ...
            ("Contested Points", "[Where sources disagree â€” with strongest evidence for each side]"),
    ...
    "literature": {
        ...
        "sections": [
            ...
            ("Synthesis", "[Overall state of knowledge â€” what we know, what we don't, where to go next]"),
        ],
    },
}
