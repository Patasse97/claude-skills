#!/usr/bin/env python3
"""Project Bootstrapper â€” Generate SaaS project scaffolding from config.
...
```
{name}/
â”œâ”€â”€ {'src/' if stack in ('nextjs', 'express') else 'app/'}
â”œâ”€â”€ tests/
...
def main():
    ...
    if args.format == "json":
        ...
        for f in result["files_created"]:
            prefix = "ðŸ“" if f["type"] == "directory" else "ðŸ“„"
