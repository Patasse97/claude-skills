...
1. **Explicit statements** â€” "Use PostgreSQL", "Build with Next.js" â€” non-negotiable
2. **Strong signals** â€” "users can sign up" implies auth + user model + database
3. **Contextual inference** â€” "dashboard" implies web app; "track expenses" implies CRUD + database
4. **Defaults** â€” When nothing is specified, pick the most common choice for the domain
...
| No data persistence mentioned | No database â€” don't add one |

### Auth Not Specified

| Signal | Default |
|---|---|
| "Users", "accounts", "login" | Yes â€” session-based or JWT |
| "Admin panel", "roles" | Yes â€” with role-based access |
| API with "API keys" | Yes â€” API key middleware |
| No user-facing features | No auth â€” don't add one |
...
- Minimal inference needed â€” generate exactly what's asked
...
- Ignore personas, market analysis, timelines â€” they don't affect code generation
...
**Never ask:**
- "What folder structure do you want?" â€” use the stack convention
- "Do you want TypeScript?" â€” yes, always for JS projects
- "Should I add error handling?" â€” yes, always
- "Do you want tests?" â€” yes, always
