...
npx ai-agent-skills install Patasse97/claude-skills/project-management

# Install to Claude Code only
npx ai-agent-skills install Patasse97/claude-skills/project-management --agent claude

# Install to Cursor only
npx ai-agent-skills install Patasse97/claude-skills/project-management --agent cursor
```
...
npx ai-agent-skills install Patasse97/claude-skills/project-management/senior-pm

# Scrum Master Expert
npx ai-agent-skills install Patasse97/claude-skills/project-management/scrum-master

# Atlassian Jira Expert
npx ai-agent-skills install Patasse97/claude-skills/project-management/jira-expert

# Atlassian Confluence Expert
npx ai-agent-skills install Patasse97/claude-skills/project-management/confluence-expert

# Atlassian Administrator
npx ai-agent-skills install Patasse97/claude-skills/project-management/atlassian-admin

# Atlassian Template Creator
npx ai-agent-skills install Patasse97/claude-skills/project-management/atlassian-templates
```
