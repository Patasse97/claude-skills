...
Operational framework for managing template lifecycle â€” creation, updates, deprecation, and quality enforcement with concrete thresholds and decision criteria.
...
- Collects and triages feedback â€” tags Jira tickets with `template-change` and links to template page
...
### Reporting
- **Monthly:** Top 10 templates by usage â†’ auto-generated Confluence table
- **Quarterly:** Flag templates below thresholds â†’ owner action required within 14 days
- **Annually:** Full catalog review â€” archive anything with 0 uses in 6 months
...
- [ ] Placeholder text uses `{placeholder}` syntax or ac:placeholder macro â€” visually distinct from real content

### Maintenance Triggers
- Template not reviewed in 90+ days â†’ owner gets Jira ticket auto-created via automation
- 3+ unresolved feedback items â†’ escalate to committee
- Broken macro detected â†’ owner notified same day via Slack/email automation
...
### Annual Review (Leadership â€” 60 min meeting)

**Agenda:**
1. (10 min) Catalog stats: total templates, usage trend YoY, templates added/deprecated
2. (15 min) Top 5 templates by adoption â€” what makes them work
3. (15 min) Bottom 5 templates â€” deprecate, rework, or retrain?
4. (10 min) Gaps identified by teams â€” templates requested but not yet built
5. (10 min) Governance process retro â€” is the framework itself working? Adjust thresholds, roles, or cadence as needed
