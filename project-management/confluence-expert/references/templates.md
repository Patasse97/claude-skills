...
| Field | Value |
|-------|-------|
| **Status** | ðŸŸ¢ Accepted / ðŸŸ¡ Proposed / ðŸ”´ Deprecated |
| **Date** | [YYYY-MM-DD] |
...
### Risks
- ðŸ”´ [Risk 1] - Mitigation: [How we'll handle it]
- ðŸŸ¡ [Risk 2] - Mitigation: [How we'll handle it]
...
| Field | Value |
|-------|-------|
| **Status** | ðŸŸ¡ Draft / ðŸŸ¢ Approved / ðŸ”´ Archived |
| **Author** | @[Name] |
...
**Tips:**
- ðŸ’¡ [Helpful tip]
- âš ï¸ [Warning about common mistake]
...
| Field | Value |
|-------|-------|
| **Status** | ðŸŸ¡ Draft / ðŸŸ¢ Approved / ðŸ”µ In Progress / âœ… Complete |
| **Product Owner** | @[Name] |
...
|------------|-------|--------|-------------------|
| [Dep 1] | @[Name] | ðŸŸ¢ Ready | [Impact] |
| [Dep 2] | @[Name] | ðŸŸ¡ In Progress | [Impact] |
...
- [âœ… / âŒ] [Action item 1] - @[Owner]
  - Status: [Done / In Progress / Not Done]
  - Notes: [Update]
- [âœ… / âŒ] [Action item 2] - @[Owner]
  - Status: [Done / In Progress / Not Done]
  - Notes: [Update]
...
|--------|--------|---------|
| **Scope** | ðŸŸ¢ / ðŸŸ¡ / ðŸ”´ | [Comment] |
| **Schedule** | ðŸŸ¢ / ðŸŸ¡ / ðŸ”´ | [Comment] |
| **Budget** | ðŸŸ¢ / ðŸŸ¡ / ðŸ”´ | [Comment] |
| **Quality** | ðŸŸ¢ / ðŸŸ¡ / ðŸ”´ | [Comment] |
| **Team Morale** | ðŸŸ¢ / ðŸŸ¡ / ðŸ”´ | [Comment] |
...
|-----------|-------------|--------|-----------------|-------|
| [Milestone 1] | [Date] | âœ… Complete | [Date] | [Notes] |
| [Milestone 2] | [Date] | ðŸ”„ In Progress | On track | [Notes] |
| [Milestone 3] | [Date] | â³ Not Started | [Forecast] | [Notes] |
...
|--------|-------------|-------------|-------|--------|
| [Metric 1] | [Value] | [Value] | â†—ï¸ / â†˜ï¸ / â†’ | [Target] |
| [Metric 2] | [Value] | [Value] | â†—ï¸ / â†˜ï¸ / â†’ | [Target] |
