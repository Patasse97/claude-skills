...
- **Mean (Î¼)**: Average historical velocity
- **Standard Deviation (Ïƒ)**: Velocity variability measure
...
```
Confidence Interval = Î¼ Â± (Z-score Ã— Ïƒ)

Where:
- Î¼ = historical mean velocity
- Ïƒ = standard deviation of velocity
- Z-score = confidence level multiplier
```

**Multi-Sprint Forecast:**
```
Total Points = Î£(sampled_velocity_i) for i = 1 to n sprints
...
```
P(Completion â‰¤ Target) = (# simulations â‰¤ target) / total_simulations
```
...
**Results:**
- Initial forecast: 20 Â± 8 points per sprint
- Final 3 sprints: 22 Â± 3 points per sprint
