...
HEALTH_DIMENSIONS = {
    ...
    "scope_stability": {
        "weight": 0.20,
        "excellent_threshold": 0.05,  # â‰¤5% scope change
        "good_threshold": 0.15,       # â‰¤15% scope change
        "poor_threshold": 0.30,       # >30% scope change is poor
    },
    "blocker_resolution": {
        "weight": 0.15,
        "excellent_threshold": 1.0,   # â‰¤1 day average resolution
        "good_threshold": 3.0,        # â‰¤3 days average resolution
    ...
    "velocity_predictability": {
        "weight": 0.10,
        "excellent_threshold": 0.10,  # â‰¤10% CV
        "good_threshold": 0.20,       # â‰¤20% CV
