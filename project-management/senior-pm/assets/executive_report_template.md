...
- **Overall Portfolio Health:** ðŸŸ¢ **GREEN** | ðŸŸ¡ **AMBER** | ðŸ”´ **RED**
...
|--------------------|----------|------------|--------------------------|
| [Priority 1] | [%] Complete | ðŸŸ¢ðŸŸ¡ðŸ”´ | $[Value]M / [Key Metric] |
| [Priority 2] | [%] Complete | ðŸŸ¢ðŸŸ¡ðŸ”´ | $[Value]M / [Key Metric] |
| [Priority 3] | [%] Complete | ðŸŸ¢ðŸŸ¡ðŸ”´ | $[Value]M / [Key Metric] |
...
|--------------|----------|---------|---------------|----------|------------|----------------|
| [Project 1] | Critical | ðŸŸ¢ | ðŸ“Š $[X]M / $[Y]M | [X]% | ðŸŸ¢ðŸŸ¡ðŸ”´ | $[Value]M |
| [Project 2] | High | ðŸŸ¡ | ðŸ“Š $[X]M / $[Y]M | [X]% | ðŸŸ¢ðŸŸ¡ðŸ”´ | $[Value]M |
| [Project 3] | Medium | ðŸ”´ | ðŸ“Š $[X]M / $[Y]M | [X]% | ðŸŸ¢ðŸŸ¡ðŸ”´ | $[Value]M |

### RAG Status Definitions
- ðŸŸ¢ **GREEN:** On-track for all success criteria (scope, time, budget, quality)
- ðŸŸ¡ **AMBER:** Minor deviations, manageable with standard mitigation actions
- ðŸ”´ **RED:** Significant issues requiring immediate executive intervention

### Portfolio Trends (Last 6 Months)
```
ðŸŸ¢ Green Projects:  â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–‘â–‘ 75% â†’ 80% (â†—ï¸ +5%)
ðŸŸ¡ Amber Projects:  â–ˆâ–ˆâ–ˆâ–ˆâ–‘â–‘â–‘â–‘â–‘â–‘ 20% â†’ 15% (â†˜ï¸ -5%)
ðŸ”´ Red Projects:    â–ˆâ–‘â–‘â–‘â–‘â–‘â–‘â–‘â–‘â–‘  5% â†’  5% (â†’ No Change)
```
...
|--------|--------------|-----|----------|----------|
| **Total Portfolio Budget** | $[X]M | $[X]M | $[X]M ([Â±]%) | $[X]M |
| **Actual Spend** | $[X]M | $[X]M | $[X]M ([Â±]%) | $[X]M |
| **Committed/Forecast** | $[X]M | $[X]M | - | $[X]M |
| **Available/Reserve** | $[X]M | $[X]M | - | $[X]M |

### Investment by Strategic Category
```
Digital Transformation:  â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–‘ 60% ($[X]M)
Operational Excellence:  â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–‘â–‘â–‘â–‘â–‘ 25% ($[X]M)
Market Expansion:        â–ˆâ–ˆâ–ˆâ–ˆâ–‘â–‘â–‘â–‘â–‘â–‘â–‘â–‘â–‘ 15% ($[X]M)
```
...
### ðŸ”´ RED ALERT - Immediate Action Required
...
### ðŸŸ¡ AMBER - Strategic Decisions Required
...
|------|-------------|-----------------|-------------------|-------|-----------------|
| [Risk 1] | [H/M/L] | $[X]M / [Strategic Impact] | ðŸŸ¢ðŸŸ¡ðŸ”´ | [Owner] | [Action by Date] |
| [Risk 2] | [H/M/L] | $[X]M / [Strategic Impact] | ðŸŸ¢ðŸŸ¡ðŸ”´ | [Owner] | [Action by Date] |
...
|------------|-------------|-------------------|-----------------|
| Engineering | [X]% | [Number] at >95% | ðŸŸ¢ðŸŸ¡ðŸ”´ |
| Product | [X]% | [Number] at >95% | ðŸŸ¢ðŸŸ¡ðŸ”´ |
| Design | [X]% | [Number] at >95% | ðŸŸ¢ðŸŸ¡ðŸ”´ |
...
|-----|-------------|-----------------|-----|---------|-------|
| **On-Time Delivery %** | [X]% | [X]% | [X]% | [X]% | â†—ï¸â†˜ï¸â†’ |
| **Budget Variance %** | [Â±X]% | [Â±X]% | [Â±X]% | <[X]% | â†—ï¸â†˜ï¸â†’ |
| **Quality Score** | [X]/10 | [X]/10 | [X]/10 | >[X] | â†—ï¸â†˜ï¸â†’ |
| **Stakeholder Satisfaction** | [X]/10 | [X]/10 | [X]/10 | >[X] | â†—ï¸â†˜ï¸â†’ |
| **ROI Achievement** | [X]% | [X]% | [X]% | [X]% | â†—ï¸â†˜ï¸â†’ |
