...
â”œâ”€â”€ Maximize Business Value & ROI
â”‚   â”œâ”€â”€ Clear quantitative metrics available? â†’ RICE Model
â”‚   â””â”€â”€ Mix of quantitative/qualitative factors? â†’ Weighted Scoring Matrix
â”‚
â”œâ”€â”€ Optimize Resource Utilization  
â”‚   â”œâ”€â”€ Agile/SAFe environment? â†’ WSJF (Weighted Shortest Job First)
â”‚   â””â”€â”€ Traditional PM environment? â†’ Resource-Constraint Optimization
â”‚
â”œâ”€â”€ Stakeholder Alignment & Buy-in
â”‚   â”œâ”€â”€ Multiple stakeholder groups? â†’ MoSCoW Method
â”‚   â””â”€â”€ Customer-focused prioritization? â†’ Kano Analysis
â”‚
â”œâ”€â”€ Speed of Decision Making
â”‚   â”œâ”€â”€ Need rapid decisions? â†’ ICE Scoring
â”‚   â””â”€â”€ Complex trade-offs acceptable? â†’ Multi-Criteria Decision Analysis
â”‚
â””â”€â”€ Strategic Portfolio Balance
    â”œâ”€â”€ Innovation vs. Operations balance? â†’ Three Horizons Model
    â””â”€â”€ Risk vs. Return optimization? â†’ Efficient Frontier Analysis
```
...
**Formula:** `WSJF Score = (User/Business Value + Time Criticality + Risk Reduction) Ã· Job Size`
...
**Formula:** `RICE Score = (Reach Ã— Impact Ã— Confidence) Ã· Effort`
...
RICE = (50,000 Ã— 1.0 Ã— 0.8) Ã· 18 = 2,222
...
**Formula:** `ICE Score = (Impact + Confidence + Ease) Ã· 3`
...
```
Project Score = Î£(Criterion Score Ã— Criterion Weight)

Example:
Project Alpha:
- Strategic Alignment: 4 Ã— 0.15 = 0.60
- Market Opportunity: 5 Ã— 0.10 = 0.50
- Competitive Advantage: 3 Ã— 0.15 = 0.45
- ROI/NPV: 4 Ã— 0.20 = 0.80
- Payback Period: 3 Ã— 0.10 = 0.30
- Cost Efficiency: 5 Ã— 0.05 = 0.25
- Technical Risk: 2 Ã— 0.10 = 0.20
- Resource Availability: 4 Ã— 0.10 = 0.40
- Timeline Feasibility: 4 Ã— 0.05 = 0.20
Total Score: 3.70
```
...
â”œâ”€â”€ Yes: Use WSJF (maximize value per unit effort)
â””â”€â”€ No: Use RICE or Weighted Scoring (optimize for maximum impact)

Time Pressure for Decisions?
â”œâ”€â”€ High: Use ICE Scoring (rapid evaluation)
â””â”€â”€ Low: Use MCDA (thorough analysis)

Stakeholder Alignment Issues?
â”œâ”€â”€ Yes: Use MoSCoW (consensus building)
â””â”€â”€ No: Proceed with quantitative method
```

#### Scenario 2: Innovation vs. Operations Balance
```
Portfolio Currently Imbalanced?
â”œâ”€â”€ Too Operational: Apply Three Horizons Model (increase H2/H3)
â”œâ”€â”€ Too Innovative: Focus on H1 projects (stabilize revenue)
â””â”€â”€ Balanced: Use efficient frontier analysis (optimize mix)

Strategic Direction Clear?
â”œâ”€â”€ Yes: Use strategic alignment scoring
â””â”€â”€ No: Use broad stakeholder input (MoSCoW or Kano)
```

#### Scenario 3: Customer vs. Business Value Tension
```
Primary Value Driver?
â”œâ”€â”€ Customer Satisfaction: Use Kano Analysis
â”œâ”€â”€ Business ROI: Use RICE or financial scoring
â””â”€â”€ Both Equally Important: Use balanced scorecard approach

Data Availability?
â”œâ”€â”€ Rich Customer Data: Kano â†’ RICE combination
â”œâ”€â”€ Limited Data: ICE scoring â†’ MoSCoW validation
â””â”€â”€ Financial Data Only: WSJF or NPV ranking
```
...
```
Combined Score = (WSJF Score Ã— 0.4) + (Strategic Score Ã— 0.3) + (Risk Score Ã— 0.3)
