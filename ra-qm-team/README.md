...
npx ai-agent-skills install Patasse97/claude-skills/ra-qm-team

# Install to Claude Code only
npx ai-agent-skills install Patasse97/claude-skills/ra-qm-team --agent claude

# Install to Cursor only
npx ai-agent-skills install Patasse97/claude-skills/ra-qm-team --agent cursor
```
...
npx ai-agent-skills install Patasse97/claude-skills/ra-qm-team/regulatory-affairs-head
npx ai-agent-skills install Patasse97/claude-skills/ra-qm-team/quality-manager-qmr

# Quality Systems
npx ai-agent-skills install Patasse97/claude-skills/ra-qm-team/quality-manager-qms-iso13485
npx ai-agent-skills install Patasse97/claude-skills/ra-qm-team/capa-officer
npx ai-agent-skills install Patasse97/claude-skills/ra-qm-team/quality-documentation-manager

# Risk & Security
npx ai-agent-skills install Patasse97/claude-skills/ra-qm-team/risk-management-specialist
npx ai-agent-skills install Patasse97/claude-skills/ra-qm-team/information-security-manager-iso27001

# Regulatory Specialists
npx ai-agent-skills install Patasse97/claude-skills/ra-qm-team/mdr-745-specialist
npx ai-agent-skills install Patasse97/claude-skills/ra-qm-team/fda-consultant-specialist

# Audit & Compliance
npx ai-agent-skills install Patasse97/claude-skills/ra-qm-team/qms-audit-expert
npx ai-agent-skills install Patasse97/claude-skills/ra-qm-team/isms-audit-expert
npx ai-agent-skills install Patasse97/claude-skills/ra-qm-team/gdpr-dsgvo-expert
```
...
**Key Benefits:**
- ðŸš€ **Accelerated Market Access** - Optimized regulatory pathways and submission efficiency
- ðŸ›¡ï¸ **Reduced Compliance Risk** - Systematic compliance across all jurisdictions
- â­ **Quality Excellence** - World-class QMS and continuous improvement capabilities
- ðŸ’° **Cost Optimization** - Automated processes and efficient resource utilization
...
â†’ Start with: Regulatory Affairs Head + QMR + QMS ISO 13485 Specialist

**Preparing for EU Market?**
â†’ Focus on: MDR 2017/745 Specialist + Risk Management Specialist + QMS ISO 13485

**Preparing for US Market?**
â†’ Focus on: FDA Consultant + QMS ISO 13485 + Risk Management Specialist

**Implementing Quality Systems?**
â†’ Start with: QMR + QMS ISO 13485 + CAPA Officer + Quality Documentation Manager

**Security & Privacy Focus?**
â†’ Focus on: Information Security Manager + GDPR Expert + ISMS Audit Expert
...
**Quality Core:**
3. **QMS ISO 13485 Specialist** (Ã—1-2)
4. **CAPA Officer** (Ã—1-2)
5. **Quality Documentation Manager** (Ã—1-2)

**Risk & Security:**
6. **Risk Management Specialist** (Ã—1-2)
...
## ðŸŒ Regulatory Frameworks Covered

### European Union
- âœ… **MDR 2017/745** - Medical Device Regulation (complete compliance)
- âœ… **ISO 13485** - Medical device quality management systems
- âœ… **ISO 14971** - Risk management for medical devices
- âœ… **ISO 27001/27002** - Information security management
- âœ… **GDPR** - General Data Protection Regulation
- âœ… **DSGVO** - German data protection law

### United States
- âœ… **FDA 21 CFR Part 820** - Quality System Regulation
- âœ… **FDA 510(k)** - Premarket notification pathway
- âœ… **FDA PMA** - Premarket approval
- âœ… **FDA De Novo** - Novel device classification
- âœ… **HIPAA** - Healthcare data privacy
- âœ… **FDA Cybersecurity** - Medical device cybersecurity requirements

### International Standards
- âœ… **ISO 13485:2016** - Medical device QMS
- âœ… **ISO 14971:2019** - Risk management
- âœ… **ISO 27001:2022** - Information security
- âœ… **IEC 62443** - Industrial cybersecurity
...
**Audit Programs â†” All Teams:**
- Internal audit findings
- Certification audit preparation
- Compliance verification

**Documentation â†” All Teams:**
...
â”œâ”€â”€ scripts/                    # 3 Python automation tools
â”‚   â”œâ”€â”€ [primary]_manager.py
â”‚   â”œâ”€â”€ [secondary]_analyzer.py
â”‚   â””â”€â”€ [tertiary]_generator.py
â””â”€â”€ references/                 # 3 reference guides
    â”œâ”€â”€ [topic]_guide.md
    â”œâ”€â”€ [standard]_compliance.md
    â””â”€â”€ [process]_procedures.md
```

---

## ðŸ¤ Cross-Skill Communication Protocols

### Weekly Coordination
- **Regulatory Affairs â†” Quality Management:** Submission readiness, change control
- **Risk Management â†” All Teams:** Risk assessments, risk-benefit analysis
- **CAPA â†” All Teams:** Non-conformance investigations, corrective actions
- **Audit Teams â†” Process Owners:** Audit schedules, finding management
...
## ðŸ† Quality & Compliance Excellence

This complete skills collection enables:

### Systematic Compliance
- âœ… All major regulatory frameworks covered
- âœ… Automated compliance checking and tracking
- âœ… Proactive regulatory intelligence
- âœ… Multi-jurisdictional coordination

### Quality Excellence
- âœ… World-class QMS implementation
- âœ… Robust CAPA and improvement systems
- âœ… Comprehensive risk management
- âœ… Excellence in audit performance

### Security & Privacy
- âœ… Complete ISMS implementation
- âœ… Medical device cybersecurity compliance
- âœ… GDPR/DSGVO privacy compliance
- âœ… Security incident response capabilities

### Continuous Improvement
- âœ… Data-driven decision making
- âœ… Systematic problem solving
- âœ… Performance monitoring and optimization
- âœ… Innovation enablement framework
...
**Your complete Regulatory Affairs & Quality Management team is ready to ensure compliance, quality excellence, and successful market access! ðŸŽŠ**
