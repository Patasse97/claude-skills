...
**Example Criteria:**
- Defect rate reduced by â‰¥50% from baseline
- Zero recurrence of specific failure mode
- Process capability (Cpk) improved to â‰¥1.33
...
| Process deviation | Compliance rate | â‰¥95% compliance |
| Complaint | Complaint trend | â‰¥50% reduction |
| Calibration | Overdue rate | <2% overdue |
| Training | Competency pass rate | 100% pass |
| Documentation | Completeness rate | 100% complete |
| Supplier | Incoming reject rate | â‰¤1% reject rate |
...
â”œâ”€â”€ Yes â†’ CAPA INEFFECTIVE (escalate per ineffective process)
â””â”€â”€ No â†’ Were all effectiveness criteria met?
    â”œâ”€â”€ Yes â†’ Were any related issues identified?
    â”‚   â”œâ”€â”€ Yes â†’ Open new CAPA if needed, close original
    â”‚   â””â”€â”€ No â†’ CAPA EFFECTIVE - proceed to closure
    â””â”€â”€ No â†’ How many criteria missed?
        â”œâ”€â”€ Minor gap (1 criterion, marginal miss) â†’
        â”‚   Extend verification period OR accept with justification
        â””â”€â”€ Significant gap â†’ CAPA INEFFECTIVE
...
|-----------|--------|--------|--------|
| [Criterion 1] | [Target] | [Result] | â˜‘ Met / â˜ Not Met |
| [Criterion 2] | [Target] | [Result] | â˜‘ Met / â˜ Not Met |
| [Criterion 3] | [Target] | [Result] | â˜‘ Met / â˜ Not Met |
...
INEFFECTIVE CAPA DETECTED
    â”‚
    â”œâ”€â”€ 1. Immediate Actions
    â”‚   â”œâ”€â”€ Reopen CAPA (do not close as effective)
    â”‚   â”œâ”€â”€ Implement containment for recurrence
    â”‚   â””â”€â”€ Notify CAPA owner and management
    â”‚
    â”œâ”€â”€ 2. Root Cause Re-evaluation
    â”‚   â”œâ”€â”€ Was original root cause correct?
    â”‚   â”‚   â”œâ”€â”€ No â†’ Conduct new root cause analysis
    â”‚   â”‚   â””â”€â”€ Yes â†’ Was corrective action appropriate?
    â”‚   â”‚       â”œâ”€â”€ No â†’ Develop new corrective action
    â”‚   â”‚       â””â”€â”€ Yes â†’ Was implementation adequate?
    â”‚   â”‚           â”œâ”€â”€ No â†’ Re-implement with improvements
    â”‚   â”‚           â””â”€â”€ Yes â†’ Escalate (systemic issue)
    â”‚
    â”œâ”€â”€ 3. Escalation Criteria
    â”‚   â”œâ”€â”€ Second ineffective attempt â†’ Management review required
    â”‚   â”œâ”€â”€ Safety-related recurrence â†’ Immediate escalation
    â”‚   â””â”€â”€ Pattern across multiple CAPAs â†’ Systemic CAPA
    â”‚
    â””â”€â”€ 4. Documentation
        â”œâ”€â”€ Document ineffective status with evidence
        â”œâ”€â”€ Record re-investigation results
        â”œâ”€â”€ Update CAPA metrics/trending
        â””â”€â”€ Include in management review
```
