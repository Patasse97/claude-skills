...
```
Device â†’ Local Network â†’ Internet â†’ Cloud â†’ EHR
  â”‚           â”‚            â”‚         â”‚       â”‚
  â””â”€ ePHI at rest    ePHI in transit    ePHI at rest
...
â”œâ”€â”€ Identify systems with ePHI
â”œâ”€â”€ Document data flows
â””â”€â”€ Identify business associates

Step 2: Threat Identification
â”œâ”€â”€ Natural threats (fire, flood)
â”œâ”€â”€ Human threats (hackers, insiders)
â”œâ”€â”€ Environmental threats (power, HVAC)
â””â”€â”€ Technical threats (malware, system failure)

Step 3: Vulnerability Assessment
â”œâ”€â”€ Administrative controls
â”œâ”€â”€ Physical controls
â”œâ”€â”€ Technical controls
â””â”€â”€ Gap analysis

Step 4: Risk Analysis
â”œâ”€â”€ Likelihood assessment
...
|-----------|---------------|------|--------|----------|
| Â§164.308(a)(1)(ii)(A) | Risk analysis | R | â˜ | |
| Â§164.308(a)(1)(ii)(B) | Risk management | R | â˜ | |
| Â§164.308(a)(3)(ii)(A) | Authorization/supervision | A | â˜ | |
| Â§164.308(a)(5)(ii)(A) | Security reminders | A | â˜ | |
| Â§164.310(a)(2)(i) | Contingency operations | A | â˜ | |
| Â§164.310(d)(2)(i) | Disposal | R | â˜ | |
| Â§164.312(a)(2)(i) | Unique user ID | R | â˜ | |
| Â§164.312(a)(2)(ii) | Emergency access | R | â˜ | |
| Â§164.312(a)(2)(iv) | Encryption (at rest) | A | â˜ | |
| Â§164.312(e)(2)(ii) | Encryption (transit) | A | â˜ | |
...
a) Administrative safeguards per Â§164.308
b) Physical safeguards per Â§164.310
c) Technical safeguards per Â§164.312
