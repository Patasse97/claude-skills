...
|-------|--------------|---------------------|
| DPO appointment threshold | Â§ 38 | Art. 37(4) |
| Employment data | Â§ 26 | Art. 88 |
| Video surveillance | Â§ 4 | Art. 6(1)(f) |
| Credit scoring | Â§ 31 | Art. 22(2)(b) |
| Consumer credit | Â§ 31 | Art. 22(2)(b) |
| Research processing | Â§Â§ 27-28 | Art. 89 |
| Special categories | Â§ 22 | Art. 9(2)(g) |

### BDSG Structure

- **Part 1 (Â§Â§ 1-21)**: Common provisions
- **Part 2 (Â§Â§ 22-44)**: Implementation of GDPR
- **Part 3 (Â§Â§ 45-84)**: Implementation of Law Enforcement Directive
- **Part 4 (Â§Â§ 85-91)**: Special provisions

---

## DPO Requirements

### Mandatory DPO Appointment (Â§ 38 BDSG)
...
- Certification (e.g., TÃœV, DEKRA, GDD)
- Legal or IT background
- Understanding of business processes

### DPO Independence (Â§ 38(2) BDSG)
...
### Â§ 26 BDSG - Processing of Employee Data
...
- Co-determination on technical monitoring systems (Â§ 87(1) No. 6)
...
### Â§ 4 BDSG - Video Surveillance of Public Areas
...
|-------|-----|----------------------|
| Baden-WÃ¼rttemberg | LDSG BW | LfDI BW |
...
| Sachsen | SÃ¤chsDSG | SÃ¤chsDSB |
| Sachsen-Anhalt | DSG LSA | LfD LSA |
| Schleswig-Holstein | LDSG SH | ULD |
| ThÃ¼ringen | ThÃ¼rDSG | TLfDI |

### Public vs Private Sector

**Public sector (LÃ¤nder laws apply):**
...
**BfDI - Bundesbeauftragte fÃ¼r den Datenschutz und die Informationsfreiheit**
...
**BDSG fine provisions (Â§ 41):**
- Up to â‚¬50,000 for certain violations (supplement to GDPR)
- GDPR fines up to â‚¬20 million / 4% turnover apply
...
- [ ] Employee data processing documented under Â§ 26
...
| Employment data | Art. 88 opening clause | Detailed Â§ 26 requirements |
| Video surveillance | Legitimate interests | Specific Â§ 4 rules |
| Credit scoring | Art. 22 | Detailed Â§ 31 requirements |
| Works council | Not addressed | Co-determination rights |
| Fines | Art. 83 | Additional Â§ 41 fines |
