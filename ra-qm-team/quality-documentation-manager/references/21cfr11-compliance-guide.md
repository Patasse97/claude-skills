...
### General Requirements (Â§11.50, 11.100)
...
Organizations must submit certification to FDA (Â§11.100(c)):
...
| Requirement | Â§11 Reference | Current State | Gap | Remediation | Priority |
|-------------|---------------|---------------|-----|-------------|----------|
