...
"""
        ...
        print(f"âœ… Created document {doc.doc_id} v{doc.version}")
        ...
        print(f"ðŸ“ Would revise document {args.revise} - reason: {args.reason}")
        ...
        print(f"{'âœ… Approved' if success else 'âŒ Failed'} document {args.approve}")
    elif args.withdraw and args.withdraw_reason:
        success = dvc.withdraw_document(args.withdraw, args.withdraw_reason, "QMS Manager")
        print(f"{'âœ… Withdrawn' if success else 'âŒ Failed'} document {args.withdraw}")
    elif args.matrix:
        ...
        # Demo
        print("ðŸ“ Document Version Control System Demo")
