...
|-----|------------|--------|-------------|
| First Pass Yield | % units passing without rework | >95% | (Units passed first time / Total units) Ã— 100 |
| Process Capability (Cpk) | Process performance vs. spec | >1.33 | min((USL-Î¼)/(3Ïƒ), (Î¼-LSL)/(3Ïƒ)) |
| Nonconformance Rate | NC events per production volume | <1% | (NC count / Total units) Ã— 100 |
| Right First Time | % activities completed correctly first time | >98% | (Correct completions / Total attempts) Ã— 100 |

### CAPA Effectiveness

| KPI | Definition | Target | Calculation |
|-----|------------|--------|-------------|
| CAPA Closure Rate | % CAPAs closed on time | >90% | (On-time closures / Due closures) Ã— 100 |
| CAPA Effectiveness Rate | % CAPAs effective at verification | >85% | (Effective CAPAs / Verified CAPAs) Ã— 100 |
| Average CAPA Age | Mean days from open to close | <60 days | Sum(Close date - Open date) / Count |
| Overdue CAPA Rate | % CAPAs past due date | <10% | (Overdue CAPAs / Open CAPAs) Ã— 100 |
| Recurrence Rate | % issues recurring after CAPA | <5% | (Recurred issues / Closed CAPAs) Ã— 100 |

### Audit Performance

| KPI | Definition | Target | Calculation |
|-----|------------|--------|-------------|
| Audit Schedule Compliance | % audits completed per schedule | >95% | (Audits completed / Audits scheduled) Ã— 100 |
| Finding Closure Rate | % findings closed on time | >90% | (On-time closures / Due closures) Ã— 100 |
| Repeat Finding Rate | % findings recurring from prior audits | <10% | (Repeat findings / Total findings) Ã— 100 |
...
| KPI | Definition | Target | Calculation |
|-----|------------|--------|-------------|
| Document Review Compliance | % documents reviewed on schedule | >95% | (On-time reviews / Due reviews) Ã— 100 |
...
| KPI | Definition | Target | Calculation |
|-----|------------|--------|-------------|
| Complaint Rate | Complaints per units sold | <0.1% | (Complaints / Units sold) Ã— 100 |
...
| Complaint Closure Rate | % complaints closed on time | >90% | (On-time closures / Due closures) Ã— 100 |
...
| Return Rate | % units returned by customers | <1% | (Units returned / Units sold) Ã— 100 |
| Warranty Claim Rate | Warranty claims per units sold | <0.5% | (Claims / Units under warranty) Ã— 100 |

### Field Quality

| KPI | Definition | Target | Calculation |
|-----|------------|--------|-------------|
| Field Failure Rate | Failures in customer use | <0.1% | (Field failures / Units in field) Ã— 100 |
| Mean Time Between Failures | Average operating time before failure | Varies | Total operating hours / Number of failures |
| Service Call Rate | Service calls per installed base | <5%/year | (Service calls / Installed units) Ã— 100 |
...
| KPI | Definition | Target | Calculation |
|-----|------------|--------|-------------|
| Regulatory Submission Success | % submissions accepted first time | >90% | (Accepted submissions / Total submissions) Ã— 100 |
| Inspection Readiness Score | Self-assessment compliance score | >90% | (Compliant items / Total items) Ã— 100 |
| Reportable Event Timeliness | % events reported within required time | 100% | (On-time reports / Required reports) Ã— 100 |
| Registration Currency | % registrations current | 100% | (Current registrations / Required registrations) Ã— 100 |

### Certification Status

| KPI | Definition | Target | Calculation |
|-----|------------|--------|-------------|
| Certification Maintenance | Active certifications vs. required | 100% | (Active certs / Required certs) Ã— 100 |
| Surveillance Audit Outcomes | Pass rate on surveillance audits | 100% | (Passed audits / Conducted audits) Ã— 100 |
...
| KPI | Definition | Target | Calculation |
|-----|------------|--------|-------------|
| Training Completion Rate | % required training completed | >95% | (Completed / Required) Ã— 100 |
| Training Currency | % employees with current training | >98% | (Current / Total requiring) Ã— 100 |
| Training Effectiveness | % passing competency assessments | >90% | (Passed / Assessed) Ã— 100 |
...
â”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¼â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¼â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¼â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¤
â”‚ Customer Sat    â”‚ >4.0    â”‚ [X.X]   â”‚ [â†‘/â†“/â†’] â”‚
â”‚ Complaint Rate  â”‚ <0.1%   â”‚ [X.XX%] â”‚ [â†‘/â†“/â†’] â”‚
â”‚ First Pass Yieldâ”‚ >95%    â”‚ [XX%]   â”‚ [â†‘/â†“/â†’] â”‚
â”‚ CAPA Closure    â”‚ >90%    â”‚ [XX%]   â”‚ [â†‘/â†“/â†’] â”‚
â”‚ Audit Findings  â”‚ <3/auditâ”‚ [X.X]   â”‚ [â†‘/â†“/â†’] â”‚
â”‚ Quality Cost    â”‚ <5%     â”‚ [X.X%]  â”‚ [â†‘/â†“/â†’] â”‚
...
PRODUCTION QUALITY:
â”œâ”€â”€ First Pass Yield: [XX%] (Target: 95%)
â”œâ”€â”€ Rework Rate: [X.X%] (Target: <2%)
â”œâ”€â”€ Scrap Rate: [X.X%] (Target: <1%)
â””â”€â”€ NC Count: [XX] (Prior: [XX])

CAPA STATUS:
â”œâ”€â”€ Open CAPAs: [XX]
â”‚   â”œâ”€â”€ Critical: [X]
â”‚   â”œâ”€â”€ Major: [XX]
â”‚   â””â”€â”€ Minor: [XX]
â”œâ”€â”€ Overdue: [X] [!ALERT if >0]
â”œâ”€â”€ Avg Age: [XX] days
â””â”€â”€ Closed This Period: [XX]

AUDIT STATUS:
â”œâ”€â”€ Audits Completed: [X] of [X] scheduled
â”œâ”€â”€ Open Findings: [XX]
â”‚   â”œâ”€â”€ Major: [X]
â”‚   â””â”€â”€ Minor: [XX]
â””â”€â”€ Overdue Actions: [X]

COMPLAINTS:
â”œâ”€â”€ Received: [XX]
â”œâ”€â”€ Open: [XX]
â”œâ”€â”€ Avg Response Time: [X.X] days
â””â”€â”€ Top Category: [Category]
```
