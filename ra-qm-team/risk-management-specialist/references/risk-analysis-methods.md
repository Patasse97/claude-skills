...
What is the analysis focus?
        â”‚
        â”œâ”€â”€ Component failures â†’ FMEA
        â”‚
        â”œâ”€â”€ System-level failure â†’ FTA
        â”‚
        â”œâ”€â”€ Process deviations â†’ HAZOP
        â”‚
        â”œâ”€â”€ User interaction â†’ Use Error Analysis
        â”‚
        â””â”€â”€ Software behavior â†’ Software FMEA/STPA
```
...
|----|---------------|--------------|----------------|--------------|---|-------|---|----------|---|-----|--------|
| FM-001 | [Item] | [Mode] | [Local Effect] | [End Effect] | [1-10] | [Cause] | [1-10] | [Detection] | [1-10] | [SÃ—OÃ—D] | [Action] |
