...
|--------|-------------|----------------|
| RTO | Recovery Time Objective â€” max acceptable downtime | 1-4 hours |
| RPO | Recovery Point Objective â€” max acceptable data loss | 1-24 hours |
| SLA | Service Level Agreement â€” uptime commitment | 99.9%-99.99% |
| MTTR | Mean Time to Recovery â€” average recovery duration | < 1 hour |

---

## 3. Confidentiality (C1) â€” Optional
...
## 4. Processing Integrity (PI1) â€” Optional
...
| Criterion | Objective | Typical Controls | Evidence |
|-----------|-----------|-----------------|----------|
| P1.1 | Notice â€” inform data subjects about data practices | Privacy policy, collection notices, purpose statements | Published privacy policy, collection banners, purpose documentation |
| P2.1 | Choice and consent â€” provide opt-in/opt-out mechanisms | Consent management, preference centers, granular consent | Consent records, preference logs, opt-out mechanisms |
| P3.1 | Collection â€” collect only necessary personal information | Data minimization, lawful basis documentation, purpose specification | Collection audits, lawful basis records, data flow diagrams |
| P4.1 | Use, retention, and disposal â€” limit use and enforce retention | Purpose limitation, retention schedules, automated deletion | Use restriction controls, retention policies, deletion logs |
| P4.2 | Disposal â€” secure disposal when no longer needed | Secure deletion, media sanitization | Disposal certificates, sanitization records |
| P5.1 | Access â€” provide data subjects access to their data | DSAR processing, data portability, access portals | DSAR logs, response timelines, export capabilities |
| P5.2 | Correction â€” allow data subjects to correct their data | Correction request processing, data update mechanisms | Correction logs, update records |
| P6.1 | Disclosure â€” control third-party data sharing | Data sharing agreements, third-party inventory, DPAs | DPAs, sharing agreements, third-party register |
| P6.2 | Notification â€” notify of breaches affecting personal data | Breach notification procedures, regulatory reporting | Breach response plan, notification records, reporting logs |
| P7.1 | Quality â€” maintain accurate personal information | Data quality checks, accuracy verification, correction mechanisms | Quality reports, accuracy audits, correction records |
| P8.1 | Monitoring â€” monitor privacy program effectiveness | Privacy audits, compliance reviews, complaint tracking | Audit reports, compliance dashboards, complaint logs |
...
|---------------|-------------|-----------|
| P1 (Notice) | Art. 13-14 | Direct â€” transparency requirements |
| P2 (Consent) | Art. 6-7 | Direct â€” lawful basis and consent |
| P3 (Collection) | Art. 5(1)(b-c) | Direct â€” purpose limitation, minimization |
| P4 (Retention) | Art. 5(1)(e) | Direct â€” storage limitation |
| P5 (Access) | Art. 15-16 | Direct â€” data subject rights |
| P6 (Disclosure) | Art. 33-34 | Direct â€” breach notification |
| P7 (Quality) | Art. 5(1)(d) | Direct â€” accuracy principle |
| P8 (Monitoring) | Art. 5(2) | Direct â€” accountability principle |
